...
namespace XingAPINet
{
	public partial class XQt1475InBlock : XingBlock
	{
		...
		/// t1475InBlock
		/// </summary>
		static readonly string _blockName = "t1475InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 상승하락
		/// </summary>
		[XAQueryFieldAttribute("상승하락")]
		public char vptype;
		/// <summary>
		/// 데이터개수
		/// </summary>
		[XAQueryFieldAttribute("데이터개수")]
		public long datacnt;
		/// <summary>
		/// 기준일자
		/// </summary>
		[XAQueryFieldAttribute("기준일자")]
		public long date;
		/// <summary>
		/// 기준시간
		/// </summary>
		[XAQueryFieldAttribute("기준시간")]
		public long time;
		/// <summary>
		/// 랭크카운터
		/// </summary>
		[XAQueryFieldAttribute("랭크카운터")]
		public long rankcnt;
		/// <summary>
		/// 조회구분
		/// </summary>
	...
	public partial class XQt1475OutBlock : XingBlock
	{
		...
		/// t1475OutBlock
		/// </summary>
		static readonly string _blockName = "t1475OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt1475OutBlock1 : XingBlock
	{
		...
		/// t1475OutBlock1
		/// </summary>
		static readonly string _blockName = "t1475OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 당일VP
		/// </summary>
		[XAQueryFieldAttribute("당일VP")]
		public float todayvp;
		/// <summary>
		/// 5일MAVP
		/// </summary>
		[XAQueryFieldAttribute("5일MAVP")]
		public float ma5vp;
		/// <summary>
		/// 20일MAVP
		/// </summary>
		[XAQueryFieldAttribute("20일MAVP")]
		public float ma20vp;
		/// <summary>
		/// 60일MAVP
		/// </summary>
		[XAQueryFieldAttribute("60일MAVP")]
		public float ma60vp;
	...
	public partial class XQt1475 : XingQuery
	{
		...
		/// t1475
		/// </summary>
		static readonly string _typeName = "t1475";
		/// <summary>
		/// 체결강도추이(t1475)
		/// </summary>
		static readonly string _typeDesc = "체결강도추이(t1475)";
		/// <summary>
		/// 
		/// </summary>
