...
{
	public partial class XQt2805InBlock : XingBlock
	{
		/// <summary>
		/// t2805InBlock
		/// </summary>
		public const string _blockName = "t2805InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt2805OutBlock : XingBlock
	{
		...
		/// t2805OutBlock
		/// </summary>
		public const string _blockName = "t2805OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public static XQt2805OutBlock FromQuery(XQt2805 query)
		{
			XQt2805OutBlock block = new XQt2805OutBlock();
	...
	public partial class XQt2805OutBlock1 : XingBlock
	{
		/// <summary>
		/// t2805OutBlock1
		/// </summary>
		public const string _blockName = "t2805OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		public static XQt2805OutBlock1[] ListFromQuery(XQt2805 query)
		{
			int count = query.GetBlockCount(XQt2805OutBlock1.BlockName);
			List<XQt2805OutBlock1> list = new List<XQt2805OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt2805OutBlock1 block = new XQt2805OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
	...
	public partial class XQt2805 : XingQuery
	{
		...
		/// t2805
		/// </summary>
		public const string _typeName = "t2805";
		/// <summary>
		/// CME야간선물기간별주가(t2805)
		/// </summary>
		public const string _typeDesc = "CME야간선물기간별주가(t2805)";
		/// <summary>
		/// 
		/// </summary>
		...
		{
			public XQt2805OutBlock OutBlock { get; internal set; }
			public XQt2805OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt2805 instance = new XQt2805())
			{
				instance.SetFieldData(XQt2805InBlock.BlockName, XQt2805InBlock.F.shcode, 0, shcode); // char 8
				instance.SetFieldData(XQt2805InBlock.BlockName, XQt2805InBlock.F.futcheck, 0, futcheck.ToString()); // char 1
				instance.SetFieldData(XQt2805InBlock.BlockName, XQt2805InBlock.F.date, 0, date); // char 8
				instance.SetFieldData(XQt2805InBlock.BlockName, XQt2805InBlock.F.cts_code, 0, cts_code); // char 8
				instance.SetFieldData(XQt2805InBlock.BlockName, XQt2805InBlock.F.lastdate, 0, lastdate); // char 8
				instance.SetFieldData(XQt2805InBlock.BlockName, XQt2805InBlock.F.cnt, 0, cnt.ToString("d3")); // int 3
		...
		public static XQAllOutBlocks ReadFromDB(/* string shcode = default,char futcheck = default,string date = default,string cts_code = default,string lastdate = default,int cnt = default */)
		{
			using (XQt2805 instance = new XQt2805())
			{
				...
				QueryOption qo = new QueryOption("XQt2805OutBlock");
				results.OutBlock = instance.Select<XQt2805OutBlock>(qo);

				qo = new QueryOption("XQt2805OutBlock1");
				results.OutBlock1 = instance.SelectMany<XQt2805OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt2805InBlock block)
		{
		...
		public XQt2805OutBlock GetBlock()
		{
			XQt2805OutBlock instance = XQt2805OutBlock.FromQuery(this);
			return instance;

		}

		public XQt2805OutBlock1[] GetBlock1s()
		{
			XQt2805OutBlock1[] instance = XQt2805OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt2805OutBlock),
			typeof(XQt2805OutBlock1),
