...
namespace XingAPINet
{
	public partial class XQt1105InBlock : XingBlock
	{
		...
		/// t1105InBlock
		/// </summary>
		static readonly string _blockName = "t1105InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt1105OutBlock : XingBlock
	{
		...
		/// t1105OutBlock
		/// </summary>
		static readonly string _blockName = "t1105OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		/// 피봇
		/// </summary>
		[XAQueryFieldAttribute("피봇")]
		public long pbot;
		/// <summary>
		/// 1차저항
		/// </summary>
		[XAQueryFieldAttribute("1차저항")]
		public long offer1;
		/// <summary>
		/// 1차지지
		/// </summary>
		[XAQueryFieldAttribute("1차지지")]
		public long supp1;
		/// <summary>
		/// 2차저항
		/// </summary>
		[XAQueryFieldAttribute("2차저항")]
		public long offer2;
		/// <summary>
		/// 2차지지
		/// </summary>
		[XAQueryFieldAttribute("2차지지")]
		public long supp2;
		/// <summary>
		/// 기준가격
		/// </summary>
		[XAQueryFieldAttribute("기준가격")]
		public long stdprc;
		/// <summary>
		/// D저항
		/// </summary>
		[XAQueryFieldAttribute("D저항")]
		public long offerd;
		/// <summary>
		/// D지지
		/// </summary>
		[XAQueryFieldAttribute("D지지")]
		public long suppd;
	...
	public partial class XQt1105 : XingQuery
	{
		...
		/// t1105
		/// </summary>
		static readonly string _typeName = "t1105";
		/// <summary>
		/// 주식피못/디마크조회(t1105)
		/// </summary>
		static readonly string _typeDesc = "주식피못/디마크조회(t1105)";
		/// <summary>
		/// 
		/// </summary>
