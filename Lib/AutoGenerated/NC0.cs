...
{
	public partial class XRNC0InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRNC0OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		/// 체결시간(24시간)
		/// </summary>
		[XAQueryFieldAttribute("체결시간(24시간)", "6")]
		public string chetime;
		/// <summary>
		/// 체결시간(36시간)
		/// </summary>
		[XAQueryFieldAttribute("체결시간(36시간)", "6")]
		...
		/// 미결제약정수량
		/// </summary>
		[XAQueryFieldAttribute("미결제약정수량", "8")]
		public long openyak;
		/// <summary>
		/// KOSPI200지수
		/// </summary>
		...
		/// 미결제약정증감
		/// </summary>
		[XAQueryFieldAttribute("미결제약정증감", "8")]
		public long openyakcha;
		/// <summary>
		/// 장운영정보
		/// </summary>
		[XAQueryFieldAttribute("장운영정보", "2")]
		public string jgubun;
		/// <summary>
		/// 미사용filler
		/// </summary>
		[XAQueryFieldAttribute("미사용filler", "12")]
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["jnilvolume"] = new XAQueryFieldInfo("long", jnilvolume, jnilvolume.ToString("d12"), "미사용filler", (decimal)12);
			dict["futcode"] = new XAQueryFieldInfo("char", futcode, futcode, "단축코드", (decimal)8);
		...
		public static XRNC0OutBlock FromQuery(XRNC0 query)
		{
			XRNC0OutBlock block = new XRNC0OutBlock();
	...
	public partial class XRNC0 : XingReal
	{
		...
		/// NC0
		/// </summary>
		public const string _typeName = "NC0";
		/// <summary>
		/// CME연계KP200지수선물체결(NC0)
		/// </summary>
		public const string _typeDesc = "CME연계KP200지수선물체결(NC0)";
		/// <summary>
		/// false
		/// </summary>
		...
		public bool SetBlock(XRNC0InBlock block)
		{
		...
		public XRNC0OutBlock GetBlock()
		{
			XRNC0OutBlock instance = XRNC0OutBlock.FromQuery(this);
			return instance;
