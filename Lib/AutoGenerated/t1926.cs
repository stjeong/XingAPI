...
namespace XingAPINet
{
	...
	public partial class XQt1926 : XingQuery
	{
		...
		public static XQt1926OutBlock Get(string shcode = default)
		{
			using (XQt1926 instance = new XQt1926())
			{
				instance.SetFieldData(XQt1926InBlock.BlockName, XQt1926InBlock.F.shcode, 0, shcode); // char 6
		...
		public static XQt1926OutBlock ReadFromDB(string tableNamePostfix = null /*, string shcode = default */)
		{
			using (XQt1926 instance = new XQt1926())
			{

				string tableName = (tableNamePostfix == null) ? "XQt1926OutBlock" : $"XQt1926OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (shcode != default) qo.Add("shcode", shcode);


				var outBlock = instance.Select<XQt1926OutBlock>(qo);
				return outBlock;
			}
		}

		public bool SetBlock(XQt1926InBlock block)
		{
