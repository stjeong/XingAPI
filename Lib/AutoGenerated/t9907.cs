...
namespace XingAPINet
{
	...
	public partial class XQt9907OutBlock1 : XingBlock
	{
		...
		/// 만기월
		/// </summary>
		[XAQueryFieldAttribute("lastym", "만기월", "char", "6")]
		public string lastym;
		/// <summary>
		/// 만기월명
		/// </summary>
		[XAQueryFieldAttribute("lastnm", "만기월명", "char", "10")]
	...
	public partial class XQt9907 : XingQuery
	{
		...
		public static XQt9907OutBlock1[] ReadFromDB(string tableNamePostfix = null /*, char dummy = default */)
		{
			using (XQt9907 instance = new XQt9907())
			{

				string tableName = (tableNamePostfix == null) ? "XQt9907OutBlock1" : $"XQt9907OutBlock1_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (dummy != default) qo.Add("dummy", dummy);


				var outBlock = instance.SelectMany<XQt9907OutBlock1>(qo);
				return outBlock;
			}
		}
