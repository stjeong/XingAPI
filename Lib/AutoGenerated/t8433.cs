...
namespace XingAPINet
{
	public partial class XQt8433InBlock : XingBlock
	{
		...
		public void CopyTo(XQt8433InBlock block)
		{
	...
	public partial class XQt8433OutBlock : XingBlock
	{
		...
		/// 상한가
		/// </summary>
		[XAQueryFieldAttribute("hprice", "상한가", "float", "6.2")]
		public float hprice;
		/// <summary>
		/// 하한가
		/// </summary>
		[XAQueryFieldAttribute("lprice", "하한가", "float", "6.2")]
		public float lprice;
		/// <summary>
		/// 전일종가
		/// </summary>
		...
		public void CopyTo(XQt8433OutBlock block)
		{
			block.hname = this.hname;
			block.shcode = this.shcode;
			block.expcode = this.expcode;
			block.hprice = this.hprice;
			block.lprice = this.lprice;
	...
	public partial class XQt8433 : XingQuery
	{
		...
		public static XQt8433OutBlock[] ReadFromDB(string tableNamePostfix = null /*, char dummy = default */)
		{
			using (XQt8433 instance = new XQt8433())
			{

				string tableName = (tableNamePostfix == null) ? "XQt8433OutBlock" : $"XQt8433OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (dummy != default) qo.Add("dummy", dummy);


				var outBlock = instance.SelectMany<XQt8433OutBlock>(qo);
				return outBlock;
			}
		}
