...
{
	public partial class XQt1104InBlock : XingBlock
	{
		/// <summary>
		/// t1104InBlock
		/// </summary>
		public const string _blockName = "t1104InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 종목코드
		/// </summary>
		[XAQueryFieldAttribute("code", "종목코드", "char", "6")]
		public string code;
		/// <summary>
		/// 건수
		/// </summary>
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["code"] = new XAQueryFieldInfo("char", code, code, "종목코드", (decimal)6);
		...
		{
			if (code?.Length > 6) return false; // char 6
			if (nrec?.Length > 2) return false; // char 2

			return true;
		}

		public void CopyTo(XQt1104InBlock block)
		{
	...
	public partial class XQt1104InBlock1 : XingBlock
	{
		/// <summary>
		/// t1104InBlock1
		/// </summary>
		public const string _blockName = "t1104InBlock1";
		/// <summary>
		/// 기본입력1
		/// </summary>
		...
		public void CopyTo(XQt1104InBlock1 block)
		{
	...
	public partial class XQt1104OutBlock : XingBlock
	{
		/// <summary>
		/// t1104OutBlock
		/// </summary>
		public const string _blockName = "t1104OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public static XQt1104OutBlock FromQuery(XQt1104 query)
		{
			XQt1104OutBlock block = new XQt1104OutBlock();
		...
		public void CopyTo(XQt1104OutBlock block)
		{
			block.nrec = this.nrec;
	...
	public partial class XQt1104OutBlock1 : XingBlock
	{
		/// <summary>
		/// t1104OutBlock1
		/// </summary>
		public const string _blockName = "t1104OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		public static XQt1104OutBlock1[] ListFromQuery(XQt1104 query)
		{
			int count = query.GetBlockCount(XQt1104OutBlock1.BlockName);
			List<XQt1104OutBlock1> list = new List<XQt1104OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt1104OutBlock1 block = new XQt1104OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
		...
		public void CopyTo(XQt1104OutBlock1 block)
		{
			block.indx = this.indx;
			block.gubn = this.gubn;
	...
	public partial class XQt1104 : XingQuery
	{
		...
		/// t1104
		/// </summary>
		public const string _typeName = "t1104";
		/// <summary>
		/// 주식현재가시세메모(t1104)
		/// </summary>
		public const string _typeDesc = "주식현재가시세메모(t1104)";
		/// <summary>
		/// 
		/// </summary>
		...
		public bool SetBlock(XQt1104InBlock block)
		{
			...
			_xaQuery.SetFieldData(block.GetBlockName(), "code", 0, block.code); // char 6
		...
		public XQt1104OutBlock GetBlock()
		{
			XQt1104OutBlock instance = XQt1104OutBlock.FromQuery(this);
			return instance;

		}

		public XQt1104OutBlock1[] GetBlock1s()
		{
			XQt1104OutBlock1[] instance = XQt1104OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt1104OutBlock),
			typeof(XQt1104OutBlock1),
