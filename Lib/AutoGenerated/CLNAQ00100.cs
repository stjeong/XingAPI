...
namespace XingAPINet
{
	public partial class XQCLNAQ00100InBlock1 : XingBlock
	{
		...
		/// 유가증권구분
		/// </summary>
		[XAQueryFieldAttribute("유가증권구분")]
		public char SecTpCode;
		/// <summary>
		/// 대출이자등급코드
		/// </summary>
		[XAQueryFieldAttribute("대출이자등급코드")]
		public string LoanIntrstGrdCode;
		/// <summary>
		/// 대출구분
		/// </summary>
		[XAQueryFieldAttribute("대출구분")]
		public char LoanTp;
	...
	public partial class XQCLNAQ00100OutBlock2 : XingBlock
	{
		...
		/// 등록구분
		/// </summary>
		[XAQueryFieldAttribute("등록구분")]
		public string RegTpNm;
		/// <summary>
		/// 현물증거금징수분류명
		/// </summary>
		[XAQueryFieldAttribute("현물증거금징수분류명")]
		public string SpotMgnLevyClssNm;
		/// <summary>
		/// 거래정지사유
		/// </summary>
		[XAQueryFieldAttribute("거래정지사유")]
		public string FnoTrdStopRsnCnts;
		/// <summary>
		/// 요주의유형명
		/// </summary>
		[XAQueryFieldAttribute("요주의유형명")]
		public string DgrsPtnNm;
		/// <summary>
		/// 사고유형
		/// </summary>
		[XAQueryFieldAttribute("사고유형")]
		...
		/// 한도값
		/// </summary>
		[XAQueryFieldAttribute("한도값")]
		public long LmtVal;
		/// <summary>
		/// 계좌한도값
		/// </summary>
		[XAQueryFieldAttribute("계좌한도값")]
		public long AcntLmtVal;
		/// <summary>
		/// 대출등급코드
		/// </summary>
		[XAQueryFieldAttribute("대출등급코드")]
		...
		/// 대출가능율
		/// </summary>
		[XAQueryFieldAttribute("대출가능율")]
		public double LoanAbleRat;
		/// <summary>
		/// 대출이율1
		/// </summary>
		[XAQueryFieldAttribute("대출이율1")]
		public double LoanIntrat1;
		/// <summary>
		/// 등록자ID
		/// </summary>
		[XAQueryFieldAttribute("등록자ID")]
