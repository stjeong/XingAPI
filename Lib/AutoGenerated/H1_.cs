...
{
	public partial class XRH1_InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRH1_OutBlock : XingBlock
	{
		...
		public static XRH1_OutBlock FromQuery(XRH1_ query)
		{
			XRH1_OutBlock block = new XRH1_OutBlock();
	...
	public partial class XRH1_ : XingReal
	{
		...
		/// H1_
		/// </summary>
		public const string _typeName = "H1_";
		/// <summary>
		/// KOSPI호가잔량(H1)
		/// </summary>
		public const string _typeDesc = "KOSPI호가잔량(H1)";
		/// <summary>
		/// false
		/// </summary>
		...
		public bool SetFields(XRH1_InBlock block)
		{
		...
		public XRH1_OutBlock GetBlock()
		{
			XRH1_OutBlock instance = XRH1_OutBlock.FromQuery(this);
			return instance;
