...
namespace XingAPINet
{
	public partial class XRs3_InBlock : XingBlock
	{
		...
		public void CopyTo(XRs3_InBlock block)
		{
	...
	public partial class XRs3_OutBlock : XingBlock
	{
		...
		/// ATM구분
		/// </summary>
		[XAQueryFieldAttribute("moneyness", "ATM구분", "char", "1")]
		...
		/// LP보유수량
		/// </summary>
		[XAQueryFieldAttribute("lpvolume", "LP보유수량", "long", "15")]
		public long lpvolume;
		...
		public static class F
		{
			...
			/// LP보유수량
			/// </summary>
			public const string lpvolume = "lpvolume";
		}
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["moneyness"] = new XAQueryFieldInfo("char", moneyness, moneyness.ToString(), "ATM구분", (decimal)1);
			dict["shcode"] = new XAQueryFieldInfo("char", shcode, shcode, "단축코드", (decimal)6);
			dict["lpvolume"] = new XAQueryFieldInfo("long", lpvolume, lpvolume.ToString("d15"), "LP보유수량", (decimal)15);
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "lpvolume":
					this.lpvolume = fieldInfo.FieldValue.ParseLong("lpvolume");
				break;
		...
		public bool VerifyData()
		{
			...
			// moneyness char 1
			if (shcode?.Length > 6) return false; // char 6
			if (lpvolume.ToString().Length > 15) return false; // long 15

			return true;
		}

		public void CopyTo(XRs3_OutBlock block)
		{
	...
	public partial class XRs3_ : XingReal
	{
		...
		/// ELW체결(s3)
		/// </summary>
		public const string _typeDesc = "ELW체결(s3)";
		/// <summary>
		/// false
		/// </summary>
