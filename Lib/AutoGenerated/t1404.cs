...
namespace XingAPINet
{
	public partial class XQt1404InBlock : XingBlock
	{
		...
		public void CopyTo(XQt1404InBlock block)
		{
	...
	public partial class XQt1404OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1404OutBlock block)
		{
			block.cts_shcode = this.cts_shcode;
	...
	public partial class XQt1404OutBlock1 : XingBlock
	{
		...
		/// 지정일주가
		/// </summary>
		[XAQueryFieldAttribute("tprice", "지정일주가", "long", "8")]
		public long tprice;
		/// <summary>
		/// 지정일대비
		/// </summary>
		[XAQueryFieldAttribute("tchange", "지정일대비", "long", "8")]
		public long tchange;
		/// <summary>
		/// 대비율
		/// </summary>
		[XAQueryFieldAttribute("tdiff", "대비율", "float", "6.2")]
		public float tdiff;
		/// <summary>
		/// 사유
		/// </summary>
		[XAQueryFieldAttribute("reason", "사유", "char", "4")]
		...
		public void CopyTo(XQt1404OutBlock1 block)
		{
			...
			block.tprice = this.tprice;
			block.tchange = this.tchange;
			block.tdiff = this.tdiff;
	...
	public partial class XQt1404 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,char jongchk = default,string cts_shcode = default */)
		{
			using (XQt1404 instance = new XQt1404())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1404OutBlock" : $"XQt1404OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1404OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1404OutBlock1" : $"XQt1404OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1404OutBlock1>(qo);
				return results;
			}
		}
