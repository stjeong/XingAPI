...
namespace XingAPINet
{
	public partial class XQt1637InBlock : XingBlock
	{
		...
		/// 수량금액구분(0:수량1:금액)
		/// </summary>
		[XAQueryFieldAttribute("수량금액구분(0:수량1:금액)", "1")]
		public char gubun1;
		/// <summary>
		/// 시간일별구분(0:시간1:일자)
		/// </summary>
		[XAQueryFieldAttribute("시간일별구분(0:시간1:일자)", "1")]
		public char gubun2;
		/// <summary>
		/// 종목코드
		/// </summary>
		...
		/// IDXCTS(9999:차트)
		/// </summary>
		[XAQueryFieldAttribute("IDXCTS(9999:차트)", "4")]
		public long cts_idx;
	...
	public partial class XQt1637OutBlock1 : XingBlock
	{
		...
		/// 순매수금액
		/// </summary>
		[XAQueryFieldAttribute("순매수금액", "15")]
		public long svalue;
		/// <summary>
		/// 매도금액
		/// </summary>
		[XAQueryFieldAttribute("매도금액", "15")]
		public long offervalue;
		/// <summary>
		/// 매수금액
		/// </summary>
		[XAQueryFieldAttribute("매수금액", "15")]
