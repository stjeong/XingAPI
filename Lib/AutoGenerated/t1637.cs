...
namespace XingAPINet
{
	public partial class XQt1637InBlock : XingBlock
	{
		...
		/// 수량금액구분(0:수량1:금액)
		/// </summary>
		[XAQueryFieldAttribute("gubun1", "수량금액구분(0:수량1:금액)", "char", "1")]
		public char gubun1;
		/// <summary>
		/// 시간일별구분(0:시간1:일자)
		/// </summary>
		[XAQueryFieldAttribute("gubun2", "시간일별구분(0:시간1:일자)", "char", "1")]
		public char gubun2;
		/// <summary>
		/// 종목코드
		/// </summary>
		...
		/// IDXCTS(9999:차트)
		/// </summary>
		[XAQueryFieldAttribute("cts_idx", "IDXCTS(9999:차트)", "long", "4")]
		public long cts_idx;
		...
		public void CopyTo(XQt1637InBlock block)
		{
	...
	public partial class XQt1637OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1637OutBlock block)
		{
			block.cts_idx = this.cts_idx;
	...
	public partial class XQt1637OutBlock1 : XingBlock
	{
		...
		/// 순매수금액
		/// </summary>
		[XAQueryFieldAttribute("svalue", "순매수금액", "long", "15")]
		public long svalue;
		/// <summary>
		/// 매도금액
		/// </summary>
		[XAQueryFieldAttribute("offervalue", "매도금액", "long", "15")]
		public long offervalue;
		/// <summary>
		/// 매수금액
		/// </summary>
		[XAQueryFieldAttribute("stksvalue", "매수금액", "long", "15")]
		...
		public void CopyTo(XQt1637OutBlock1 block)
		{
			block.date = this.date;
			block.time = this.time;
	...
	public partial class XQt1637 : XingQuery
	{
		...
		{
			typeof(XQt1637OutBlock),
			typeof(XQt1637OutBlock1),
