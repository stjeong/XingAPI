...
namespace XingAPINet
{
	public partial class XQt2101InBlock : XingBlock
	{
		...
		/// t2101InBlock
		/// </summary>
		static readonly string _blockName = "t2101InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt2101OutBlock : XingBlock
	{
		...
		/// t2101OutBlock
		/// </summary>
		static readonly string _blockName = "t2101OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt2101 : XingQuery
	{
		...
		/// t2101
		/// </summary>
		static readonly string _typeName = "t2101";
		/// <summary>
		/// 선물/옵션현재가(시세)조회(t2101)
		/// </summary>
		static readonly string _typeDesc = "선물/옵션현재가(시세)조회(t2101)";
		/// <summary>
		/// 
		/// </summary>
