...
namespace XingAPINet
{
	public partial class XQt1101InBlock : XingBlock
	{
		...
		public void CopyTo(XQt1101InBlock block)
		{
	...
	public partial class XQt1101OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1101OutBlock block)
		{
	...
	public partial class XQt1101 : XingQuery
	{
		...
		public static XQt1101OutBlock Get(string shcode = default)
		{
			using (XQt1101 instance = new XQt1101())
			{
				instance.SetFieldData(XQt1101InBlock.BlockName, XQt1101InBlock.F.shcode, 0, shcode); // char 6
		...
		public static XQt1101OutBlock ReadFromDB(string tableNamePostfix = null /*, string shcode = default */)
		{
			using (XQt1101 instance = new XQt1101())
			{

				string tableName = (tableNamePostfix == null) ? "XQt1101OutBlock" : $"XQt1101OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (shcode != default) qo.Add("shcode", shcode);


				var outBlock = instance.Select<XQt1101OutBlock>(qo);
				return outBlock;
			}
		}

		public bool SetBlock(XQt1101InBlock block)
		{
