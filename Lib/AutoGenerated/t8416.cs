...
namespace XingAPINet
{
	public partial class XQt8416InBlock : XingBlock
	{
		...
		/// t8416InBlock
		/// </summary>
		public const string _blockName = "t8416InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 주기구분(2:일3:주4:월)
		/// </summary>
		[XAQueryFieldAttribute("gubun", "주기구분(2:일3:주4:월)", "char", "1")]
		public char gubun;
		/// <summary>
	...
	public partial class XQt8416OutBlock : XingBlock
	{
		...
		/// t8416OutBlock
		/// </summary>
		public const string _blockName = "t8416OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt8416OutBlock1 : XingBlock
	{
		...
		/// t8416OutBlock1
		/// </summary>
		public const string _blockName = "t8416OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
	...
	public partial class XQt8416 : XingQuery
	{
		...
		/// t8416
		/// </summary>
		public const string _typeName = "t8416";
		/// <summary>
		/// 선물/옵션챠트(일주월)(t8416)
		/// </summary>
		public const string _typeDesc = "선물/옵션챠트(일주월)(t8416)";
		/// <summary>
		/// 
		/// </summary>
		...
		{
			public XQt8416OutBlock OutBlock { get; internal set; }
			public XQt8416OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		public static XQAllOutBlocks ReadFromDB(/* string shcode = default,char gubun = default,long qrycnt = default,string sdate = default,string edate = default,string cts_date = default,char comp_yn = default */)
		{
			using (XQt8416 instance = new XQt8416())
			{
				...
				QueryOption qo = new QueryOption("XQt8416OutBlock");
				results.OutBlock = instance.Select<XQt8416OutBlock>(qo);

				qo = new QueryOption("XQt8416OutBlock1");
				results.OutBlock1 = instance.SelectMany<XQt8416OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt8416OutBlock),
			typeof(XQt8416OutBlock1),
