...
namespace XingAPINet
{
	public partial class XQt8418InBlock : XingBlock
	{
		...
		/// t8418InBlock
		/// </summary>
		public const string _blockName = "t8418InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8418OutBlock : XingBlock
	{
		...
		/// t8418OutBlock
		/// </summary>
		public const string _blockName = "t8418OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		/// 업종시작시간(HHMMSS)
		/// </summary>
		[XAQueryFieldAttribute("s_time", "업종시작시간(HHMMSS)", "char", "6")]
		public string s_time;
		/// <summary>
		/// 업종종료시간(HHMMSS)
		/// </summary>
		[XAQueryFieldAttribute("e_time", "업종종료시간(HHMMSS)", "char", "6")]
	...
	public partial class XQt8418OutBlock1 : XingBlock
	{
		...
		/// t8418OutBlock1
		/// </summary>
		public const string _blockName = "t8418OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
	...
	public partial class XQt8418 : XingQuery
	{
		...
		/// t8418
		/// </summary>
		public const string _typeName = "t8418";
		/// <summary>
		/// 업종챠트(N분)(t8418)
		/// </summary>
		public const string _typeDesc = "업종챠트(N분)(t8418)";
		/// <summary>
		/// 
		/// </summary>
		...
		{
			public XQt8418OutBlock OutBlock { get; internal set; }
			public XQt8418OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt8418 instance = new XQt8418())
			{
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.shcode, 0, shcode); // char 3
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.ncnt, 0, ncnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.qrycnt, 0, qrycnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.nday, 0, nday.ToString()); // char 1
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.sdate, 0, sdate); // char 8
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.stime, 0, stime); // char 6
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.edate, 0, edate); // char 8
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.etime, 0, etime); // char 6
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.cts_date, 0, cts_date); // char 8
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.cts_time, 0, cts_time); // char 10
				instance.SetFieldData(XQt8418InBlock.BlockName, XQt8418InBlock.F.comp_yn, 0, comp_yn.ToString()); // char 1
		...
		public static XQAllOutBlocks ReadFromDB(/* string shcode = default,long ncnt = default,long qrycnt = default,char nday = default,string sdate = default,string stime = default,string edate = default,string etime = default,string cts_date = default,string cts_time = default,char comp_yn = default */)
		{
			using (XQt8418 instance = new XQt8418())
			{
				...
				QueryOption qo = new QueryOption("XQt8418OutBlock");
				results.OutBlock = instance.Select<XQt8418OutBlock>(qo);

				qo = new QueryOption("XQt8418OutBlock1");
				results.OutBlock1 = instance.SelectMany<XQt8418OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt8418InBlock block)
		{
		...
		{
			typeof(XQt8418OutBlock),
			typeof(XQt8418OutBlock1),
