...
namespace XingAPINet
{
	public partial class XQt8435InBlock : XingBlock
	{
		...
		/// t8435InBlock
		/// </summary>
		static readonly string _blockName = "t8435InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 구분(MF/MO)
		/// </summary>
		[XAQueryFieldAttribute("구분(MF/MO)")]
		public string gubun;
	...
	public partial class XQt8435OutBlock : XingBlock
	{
		...
		/// t8435OutBlock
		/// </summary>
		static readonly string _blockName = "t8435OutBlock";
		/// <summary>
		/// 파생종목마스터
		/// </summary>
		static readonly string _blockDesc = "파생종목마스터";
		/// <summary>
		/// output
		/// </summary>
	...
	public partial class XQt8435 : XingQuery
	{
		...
		/// t8435
		/// </summary>
		static readonly string _typeName = "t8435";
		/// <summary>
		/// 파생종목마스터조회API용(t8435)
		/// </summary>
		static readonly string _typeDesc = "파생종목마스터조회API용(t8435)";
		/// <summary>
		/// 
		/// </summary>
