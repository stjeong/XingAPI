...
{
	public partial class XRK3_InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRK3_OutBlock : XingBlock
	{
		...
		public static XRK3_OutBlock FromQuery(XRK3_ query)
		{
			XRK3_OutBlock block = new XRK3_OutBlock();
	...
	public partial class XRK3_ : XingReal
	{
		...
		/// K3_
		/// </summary>
		public const string _typeName = "K3_";
		/// <summary>
		/// KOSDAQ체결(K3)
		/// </summary>
		public const string _typeDesc = "KOSDAQ체결(K3)";
		/// <summary>
		/// false
		/// </summary>
		...
		public XRK3_OutBlock GetBlock()
		{
			XRK3_OutBlock instance = XRK3_OutBlock.FromQuery(this);
			return instance;
