...
namespace XingAPINet
{
	...
	public partial class XRKM_OutBlock : XingBlock
	{
		...
		/// KOSDAQ50 지수
		/// </summary>
		[XAQueryFieldAttribute("KOSDAQ50 지수", "6.2")]
		public float k50jisu;
		/// <summary>
		/// KOSDAQ50 전일대비구분
		/// </summary>
		[XAQueryFieldAttribute("KOSDAQ50 전일대비구분", "1")]
		public char k50sign;
		/// <summary>
		/// KOSDAQ50 전일대비
		/// </summary>
		[XAQueryFieldAttribute("KOSDAQ50 전일대비", "6.2")]
		public float change;
		/// <summary>
		/// KOSDAQ50 베이시스
		/// </summary>
		[XAQueryFieldAttribute("KOSDAQ50 베이시스", "4.2")]
