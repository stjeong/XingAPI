...
{
	public partial class XRKM_InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
		...
		public void CopyTo(XRKM_InBlock block)
		{
	...
	public partial class XRKM_OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		/// KOSDAQ50 지수
		/// </summary>
		[XAQueryFieldAttribute("k50jisu", "KOSDAQ50 지수", "float", "6.2")]
		public float k50jisu;
		/// <summary>
		/// KOSDAQ50 전일대비구분
		/// </summary>
		[XAQueryFieldAttribute("k50sign", "KOSDAQ50 전일대비구분", "char", "1")]
		public char k50sign;
		/// <summary>
		/// KOSDAQ50 전일대비
		/// </summary>
		[XAQueryFieldAttribute("change", "KOSDAQ50 전일대비", "float", "6.2")]
		public float change;
		/// <summary>
		/// KOSDAQ50 베이시스
		/// </summary>
		[XAQueryFieldAttribute("k50basis", "KOSDAQ50 베이시스", "float", "4.2")]
		public float k50basis;
		/// <summary>
		/// 차익매도체결수량합계
		/// </summary>
		...
		public static class F
		{
			...
			/// KOSDAQ50 지수
			/// </summary>
			public const string k50jisu = "k50jisu";
			/// <summary>
			/// KOSDAQ50 전일대비구분
			/// </summary>
			public const string k50sign = "k50sign";
			/// <summary>
			/// KOSDAQ50 전일대비
			/// </summary>
			...
			/// KOSDAQ50 베이시스
			/// </summary>
			public const string k50basis = "k50basis";
			/// <summary>
			/// 차익매도체결수량합계
			/// </summary>
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["k50jisu"] = new XAQueryFieldInfo("float", k50jisu, k50jisu.ToString("000000.00"), "KOSDAQ50 지수", (decimal)6.2);
			dict["k50sign"] = new XAQueryFieldInfo("char", k50sign, k50sign.ToString(), "KOSDAQ50 전일대비구분", (decimal)1);
			dict["change"] = new XAQueryFieldInfo("float", change, change.ToString("000000.00"), "KOSDAQ50 전일대비", (decimal)6.2);
			dict["k50basis"] = new XAQueryFieldInfo("float", k50basis, k50basis.ToString("0000.00"), "KOSDAQ50 베이시스", (decimal)4.2);
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "k50jisu":
					this.k50jisu = fieldInfo.FieldValue.ParseFloat("k50jisu");
				break;

				case "k50sign":
					this.k50sign = fieldInfo.FieldValue.FirstOrDefault();
				break;
				...
				case "k50basis":
					this.k50basis = fieldInfo.FieldValue.ParseFloat("k50basis");
				break;
		...
		public static XRKM_OutBlock FromQuery(XRKM_ query)
		{
			XRKM_OutBlock block = new XRKM_OutBlock();
			...
			try
			{
				...
				block.k50jisu = query.GetFieldData(block.GetBlockName(), "k50jisu").ParseFloat("k50jisu"); // float 6.2
				block.k50sign = query.GetFieldData(block.GetBlockName(), "k50sign").FirstOrDefault(); // char 1
				block.change = query.GetFieldData(block.GetBlockName(), "change").ParseFloat("change"); // float 6.2
				block.k50basis = query.GetFieldData(block.GetBlockName(), "k50basis").ParseFloat("k50basis"); // float 4.2
		...
		public void CopyTo(XRKM_OutBlock block)
		{
			...
			block.k50jisu = this.k50jisu;
			block.k50sign = this.k50sign;
			block.change = this.change;
			block.k50basis = this.k50basis;
	...
	public partial class XRKM_ : XingReal
	{
		...
		/// KM_
		/// </summary>
		public const string _typeName = "KM_";
		/// <summary>
		/// KOSDAQ프로그램매매전체집계(KM)
		/// </summary>
		public const string _typeDesc = "KOSDAQ프로그램매매전체집계(KM)";
		/// <summary>
		/// false
		/// </summary>
		...
		public XRKM_OutBlock GetBlock()
		{
			XRKM_OutBlock instance = XRKM_OutBlock.FromQuery(this);
			return instance;
