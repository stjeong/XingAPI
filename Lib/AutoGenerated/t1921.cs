...
namespace XingAPINet
{
	public partial class XQt1921InBlock : XingBlock
	{
		...
		/// 융자대주구분
		/// </summary>
		[XAQueryFieldAttribute("gubun", "융자대주구분", "char", "1")]
		public char gubun;
		/// <summary>
		/// 날짜
		/// </summary>
		...
		public void CopyTo(XQt1921InBlock block)
		{
	...
	public partial class XQt1921OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1921OutBlock block)
		{
			block.cnt = this.cnt;
			block.date = this.date;
			block.idx = this.idx;
	...
	public partial class XQt1921OutBlock1 : XingBlock
	{
		...
		/// 날짜
		/// </summary>
		[XAQueryFieldAttribute("mmdate", "날짜", "char", "8")]
		...
		/// 전일대비
		/// </summary>
		[XAQueryFieldAttribute("jchange", "전일대비", "long", "8")]
		public long jchange;
		/// <summary>
		/// 등락율
		/// </summary>
		...
		/// 신규
		/// </summary>
		[XAQueryFieldAttribute("nvolume", "신규", "long", "8")]
		public long nvolume;
		/// <summary>
		/// 상환
		/// </summary>
		[XAQueryFieldAttribute("svolume", "상환", "long", "8")]
		public long svolume;
		/// <summary>
		/// 잔고
		/// </summary>
		[XAQueryFieldAttribute("jvolume", "잔고", "long", "8")]
		public long jvolume;
		/// <summary>
		/// 금액
		/// </summary>
		[XAQueryFieldAttribute("price", "금액", "long", "8")]
		public long price;
		/// <summary>
		/// 대비
		/// </summary>
		...
		/// 공여율
		/// </summary>
		[XAQueryFieldAttribute("gyrate", "공여율", "float", "6.2")]
		public float gyrate;
		/// <summary>
		/// 잔고율
		/// </summary>
		[XAQueryFieldAttribute("jkrate", "잔고율", "float", "6.2")]
		public float jkrate;
		/// <summary>
		/// 종목코드
		/// </summary>
		...
		public void CopyTo(XQt1921OutBlock1 block)
		{
			block.mmdate = this.mmdate;
			block.close = this.close;
			block.sign = this.sign;
			block.jchange = this.jchange;
			block.diff = this.diff;
			block.nvolume = this.nvolume;
			block.svolume = this.svolume;
			block.jvolume = this.jvolume;
			block.price = this.price;
			block.change = this.change;
			block.gyrate = this.gyrate;
	...
	public partial class XQt1921 : XingQuery
	{
		...
		{
			public XQt1921OutBlock OutBlock { get; internal set; }
			public XQt1921OutBlock1[] OutBlock1 { get; internal set; }
		}

		public static XQAllOutBlocks Get(string shcode = default,char gubun = default,string date = default,long idx = default)
		{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,char gubun = default,string date = default,long idx = default */)
		{
			using (XQt1921 instance = new XQt1921())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1921OutBlock" : $"XQt1921OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1921OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1921OutBlock1" : $"XQt1921OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1921OutBlock1>(qo);
				return results;
			}
		}
