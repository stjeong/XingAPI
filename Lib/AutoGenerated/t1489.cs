...
namespace XingAPINet
{
	public partial class XQt1489InBlock : XingBlock
	{
		...
		public void CopyTo(XQt1489InBlock block)
		{
			block.gubun = this.gubun;
			block.jgubun = this.jgubun;
			block.jongchk = this.jongchk;
			block.idx = this.idx;
			block.yesprice = this.yesprice;
			block.yeeprice = this.yeeprice;
	...
	public partial class XQt1489OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1489OutBlock block)
		{
			block.idx = this.idx;
	...
	public partial class XQt1489OutBlock1 : XingBlock
	{
		...
		/// 예상거래량
		/// </summary>
		[XAQueryFieldAttribute("volume", "예상거래량", "long", "12")]
		public long volume;
		/// <summary>
		/// 매도호가
		/// </summary>
		...
		public void CopyTo(XQt1489OutBlock1 block)
		{
	...
	public partial class XQt1489 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,char jgubun = default,string jongchk = default,long idx = default,long yesprice = default,long yeeprice = default,long yevolume = default */)
		{
			using (XQt1489 instance = new XQt1489())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1489OutBlock" : $"XQt1489OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1489OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1489OutBlock1" : $"XQt1489OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1489OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1489OutBlock),
			typeof(XQt1489OutBlock1),
