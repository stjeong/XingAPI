...
namespace XingAPINet
{
	...
	public partial class XQt8417 : XingQuery
	{
		...
		public static XQt8417OutBlock1[] Get(string shcode = default,long ncnt = default,long qrycnt = default,char nday = default,string sdate = default,string stime = default,string edate = default,string etime = default,string cts_date = default,string cts_time = default,char comp_yn = default)
		{
