...
{
	public partial class XQt8417InBlock : XingBlock
	{
		/// <summary>
		/// t8417InBlock
		/// </summary>
		public const string _blockName = "t8417InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8417OutBlock : XingBlock
	{
		/// <summary>
		/// t8417OutBlock
		/// </summary>
		public const string _blockName = "t8417OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public static XQt8417OutBlock FromQuery(XQt8417 query)
		{
			XQt8417OutBlock block = new XQt8417OutBlock();
	...
	public partial class XQt8417OutBlock1 : XingBlock
	{
		/// <summary>
		/// t8417OutBlock1
		/// </summary>
		public const string _blockName = "t8417OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		public static XQt8417OutBlock1[] ListFromQuery(XQt8417 query)
		{
			int count = query.GetBlockCount(XQt8417OutBlock1.BlockName);
			List<XQt8417OutBlock1> list = new List<XQt8417OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt8417OutBlock1 block = new XQt8417OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
	...
	public partial class XQt8417 : XingQuery
	{
		...
		/// t8417
		/// </summary>
		public const string _typeName = "t8417";
		/// <summary>
		/// 업종차트(틱/n틱)(t8417)
		/// </summary>
		public const string _typeDesc = "업종차트(틱/n틱)(t8417)";
		/// <summary>
		/// 
		/// </summary>
		...
		{
			public XQt8417OutBlock OutBlock { get; internal set; }
			public XQt8417OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt8417 instance = new XQt8417())
			{
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.shcode, 0, shcode); // char 3
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.ncnt, 0, ncnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.qrycnt, 0, qrycnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.nday, 0, nday.ToString()); // char 1
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.sdate, 0, sdate); // char 8
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.stime, 0, stime); // char 6
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.edate, 0, edate); // char 8
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.etime, 0, etime); // char 6
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.cts_date, 0, cts_date); // char 8
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.cts_time, 0, cts_time); // char 10
				instance.SetFieldData(XQt8417InBlock.BlockName, XQt8417InBlock.F.comp_yn, 0, comp_yn.ToString()); // char 1
		...
		public static XQAllOutBlocks ReadFromDB(/* string shcode = default,long ncnt = default,long qrycnt = default,char nday = default,string sdate = default,string stime = default,string edate = default,string etime = default,string cts_date = default,string cts_time = default,char comp_yn = default */)
		{
			using (XQt8417 instance = new XQt8417())
			{
				...
				QueryOption qo = new QueryOption("XQt8417OutBlock");
				results.OutBlock = instance.Select<XQt8417OutBlock>(qo);

				qo = new QueryOption("XQt8417OutBlock1");
				results.OutBlock1 = instance.SelectMany<XQt8417OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt8417InBlock block)
		{
		...
		public XQt8417OutBlock GetBlock()
		{
			XQt8417OutBlock instance = XQt8417OutBlock.FromQuery(this);
			return instance;

		}

		public XQt8417OutBlock1[] GetBlock1s()
		{
			XQt8417OutBlock1[] instance = XQt8417OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt8417OutBlock),
			typeof(XQt8417OutBlock1),
