...
namespace XingAPINet
{
	...
	public partial class XQCEXAQ21200OutBlock2 : XingBlock
	{
		...
		/// 신규주문가능수량
		/// </summary>
		[XAQueryFieldAttribute("신규주문가능수량", "16")]
		public long NewOrdAbleQty;
		/// <summary>
		/// 청산주문가능수량
		/// </summary>
		[XAQueryFieldAttribute("청산주문가능수량", "16")]
		public long LqdtOrdAbleQty;
		/// <summary>
		/// 사용예정증거금액
		/// </summary>
		[XAQueryFieldAttribute("사용예정증거금액", "16")]
		public long UsePreargMgn;
		/// <summary>
		/// 사용예정현금증거금액
		/// </summary>
		[XAQueryFieldAttribute("사용예정현금증거금액", "16")]
	...
	public partial class XQCEXAQ21200 : XingQuery
	{
		...
		public bool SetBlock(XQCEXAQ21200InBlock1 block)
		{
		...
		{
			typeof(XQCEXAQ21200OutBlock1),
			typeof(XQCEXAQ21200OutBlock2),
