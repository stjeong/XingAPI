...
{
	public partial class XQt1966InBlock : XingBlock
	{
		/// <summary>
		/// t1966InBlock
		/// </summary>
		public const string _blockName = "t1966InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 당일전일(0:당일1:전일)
		/// </summary>
		[XAQueryFieldAttribute("gubun", "당일전일(0:당일1:전일)", "char", "1")]
		public char gubun;
		/// <summary>
		...
		public void CopyTo(XQt1966InBlock block)
		{
	...
	public partial class XQt1966OutBlock : XingBlock
	{
		/// <summary>
		/// t1966OutBlock
		/// </summary>
		public const string _blockName = "t1966OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public static XQt1966OutBlock FromQuery(XQt1966 query)
		{
			XQt1966OutBlock block = new XQt1966OutBlock();
		...
		public void CopyTo(XQt1966OutBlock block)
		{
			block.idx = this.idx;
	...
	public partial class XQt1966OutBlock1 : XingBlock
	{
		/// <summary>
		/// t1966OutBlock1
		/// </summary>
		public const string _blockName = "t1966OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 누적거래대금
		/// </summary>
		[XAQueryFieldAttribute("value", "누적거래대금", "double", "12.0")]
		public double value;
		/// <summary>
		/// 전일거래대금
		/// </summary>
		[XAQueryFieldAttribute("jnilvalue", "전일거래대금", "double", "12.0")]
		public double jnilvalue;
		/// <summary>
		/// 행사가
		/// </summary>
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["value"] = new XAQueryFieldInfo("double", value, value.ToString("000000000000."), "누적거래대금", (decimal)12.0);
			dict["jnilvalue"] = new XAQueryFieldInfo("double", jnilvalue, jnilvalue.ToString("000000000000."), "전일거래대금", (decimal)12.0);
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "jnilvalue":
					this.jnilvalue = fieldInfo.FieldValue.ParseDouble("jnilvalue");
				break;
		...
		public static XQt1966OutBlock1[] ListFromQuery(XQt1966 query)
		{
			int count = query.GetBlockCount(XQt1966OutBlock1.BlockName);
			List<XQt1966OutBlock1> list = new List<XQt1966OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt1966OutBlock1 block = new XQt1966OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
					...
					block.jnilvalue = query.GetFieldData(block.GetBlockName(), "jnilvalue", i).ParseDouble("jnilvalue"); // double 12.0
		...
		public void CopyTo(XQt1966OutBlock1 block)
		{
	...
	public partial class XQt1966 : XingQuery
	{
		...
		/// t1966
		/// </summary>
		public const string _typeName = "t1966";
		/// <summary>
		/// ELW거래대금상위(t1966)
		/// </summary>
		public const string _typeDesc = "ELW거래대금상위(t1966)";
		/// <summary>
		/// 
		/// </summary>
		...
		/// ELW거래대금상위(t1966)
		/// </summary>
		public XQt1966() : base("t1966") { }


		public class XQAllOutBlocks
		{
			public XQt1966OutBlock OutBlock { get; internal set; }
			public XQt1966OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt1966 instance = new XQt1966())
			{
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.gubun, 0, gubun.ToString()); // char 1
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.ggubun, 0, ggubun); // char 2
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.itemcode, 0, itemcode); // char 12
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.lastdate, 0, lastdate); // char 8
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.exgubun, 0, exgubun); // char 6
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.sprice, 0, sprice.ToString("d8")); // long 8
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.eprice, 0, eprice.ToString("d8")); // long 8
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.volume, 0, volume.ToString("d12")); // long 12
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.sjanday, 0, sjanday.ToString("d8")); // long 8
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.ejanday, 0, ejanday.ToString("d8")); // long 8
				instance.SetFieldData(XQt1966InBlock.BlockName, XQt1966InBlock.F.idx, 0, idx.ToString("d4")); // long 4
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,string ggubun = default,string itemcode = default,string lastdate = default,string exgubun = default,long sprice = default,long eprice = default,long volume = default,long sjanday = default,long ejanday = default,long idx = default */)
		{
			using (XQt1966 instance = new XQt1966())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1966OutBlock" : $"XQt1966OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1966OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1966OutBlock1" : $"XQt1966OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1966OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt1966InBlock block)
		{
		...
		public XQt1966OutBlock GetBlock()
		{
			XQt1966OutBlock instance = XQt1966OutBlock.FromQuery(this);
			return instance;

		}

		public XQt1966OutBlock1[] GetBlock1s()
		{
			XQt1966OutBlock1[] instance = XQt1966OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt1966OutBlock),
			typeof(XQt1966OutBlock1),
