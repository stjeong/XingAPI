...
namespace XingAPINet
{
	public partial class XQt2541InBlock : XingBlock
	{
		...
		/// 상품ID
		/// </summary>
		[XAQueryFieldAttribute("eitem", "상품ID", "char", "2")]
		public string eitem;
		/// <summary>
		/// 시장구분
		/// </summary>
		...
		public void CopyTo(XQt2541InBlock block)
		{
	...
	public partial class XQt2541OutBlock : XingBlock
	{
		...
		/// 시장구분
		/// </summary>
		[XAQueryFieldAttribute("sgubun", "시장구분", "char", "1")]
		public char sgubun;
		/// <summary>
		/// CTSTIME
		/// </summary>
		...
		public void CopyTo(XQt2541OutBlock block)
		{
			block.eitem = this.eitem;
	...
	public partial class XQt2541OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQt2541OutBlock1 block)
		{
	...
	public partial class XQt2541 : XingQuery
	{
		...
		{
			public XQt2541OutBlock OutBlock { get; internal set; }
			public XQt2541OutBlock1[] OutBlock1 { get; internal set; }
		}

		public static XQAllOutBlocks Get(string eitem = default,char market = default,string upcode = default,char gubun1 = default,char gubun2 = default,string cts_time = default,long cts_idx = default,int cnt = default)
		{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string eitem = default,char market = default,string upcode = default,char gubun1 = default,char gubun2 = default,string cts_time = default,long cts_idx = default,int cnt = default */)
		{
			using (XQt2541 instance = new XQt2541())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt2541OutBlock" : $"XQt2541OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt2541OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt2541OutBlock1" : $"XQt2541OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt2541OutBlock1>(qo);
				return results;
			}
		}
