...
{
	public partial class XQCCEAT00300InBlock1 : XingBlock
	{
		/// <summary>
		/// CCEAT00300InBlock1
		/// </summary>
		public const string _blockName = "CCEAT00300InBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		...
		public void CopyTo(XQCCEAT00300InBlock1 block)
		{
	...
	public partial class XQCCEAT00300OutBlock1 : XingBlock
	{
		/// <summary>
		/// CCEAT00300OutBlock1
		/// </summary>
		public const string _blockName = "CCEAT00300OutBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		public const string _blockDesc = "In(*EMPTY*)";
		...
		/// 취소수량
		/// </summary>
		[XAQueryFieldAttribute("CancQty", "취소수량", "long", "16")]
		public long CancQty;
		/// <summary>
		/// 통신매체코드
		/// </summary>
		...
		public static XQCCEAT00300OutBlock1 FromQuery(XQCCEAT00300 query)
		{
			XQCCEAT00300OutBlock1 block = new XQCCEAT00300OutBlock1();
		...
		public void CopyTo(XQCCEAT00300OutBlock1 block)
		{
	...
	public partial class XQCCEAT00300OutBlock2 : XingBlock
	{
		/// <summary>
		/// CCEAT00300OutBlock2
		/// </summary>
		public const string _blockName = "CCEAT00300OutBlock2";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
		...
		public static XQCCEAT00300OutBlock2 FromQuery(XQCCEAT00300 query)
		{
			XQCCEAT00300OutBlock2 block = new XQCCEAT00300OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
		...
		public void CopyTo(XQCCEAT00300OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
	...
	public partial class XQCCEAT00300 : XingQuery
	{
		...
		/// CCEAT00300
		/// </summary>
		public const string _typeName = "CCEAT00300";
		/// <summary>
		/// CME 취소주문
		/// </summary>
		public const string _typeDesc = "CME 취소주문";
		/// <summary>
		/// CCEAT00300
		/// </summary>
		public const string _service = "CCEAT00300";
		/// <summary>
		/// B
		/// </summary>
		...
		/// 2012/04/10 10:09:15
		/// </summary>
		public const string _createdDate = "2012/04/10 10:09:15";
		/// <summary>
		/// false
		/// </summary>
		...
		/// CME 취소주문
		/// </summary>
		public XQCCEAT00300() : base("CCEAT00300") { }
		...
		public XQCCEAT00300OutBlock1 GetBlock1()
		{
			XQCCEAT00300OutBlock1 instance = XQCCEAT00300OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCCEAT00300OutBlock2 GetBlock2()
		{
			XQCCEAT00300OutBlock2 instance = XQCCEAT00300OutBlock2.FromQuery(this);
			return instance;
		...
		{
			typeof(XQCCEAT00300OutBlock1),
			typeof(XQCCEAT00300OutBlock2),
