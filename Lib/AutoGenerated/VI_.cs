...
{
	public partial class XRVI_InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
		...
		/// 단축코드(KEY)
		/// </summary>
		[XAQueryFieldAttribute("단축코드(KEY)")]
	...
	public partial class XRVI_OutBlock : XingBlock
	{
		...
		/// </summary>
		[XAQueryFieldAttribute("구분(0:해제 1:정적발동 2:동적발동 3:정적&동적)")]
		public char vi_gubun;
		/// <summary>
		/// 정적VI발동기준가격
		/// </summary>
		[XAQueryFieldAttribute("정적VI발동기준가격")]
		public long svi_recprice;
		/// <summary>
		/// 동적VI발동기준가격
		/// </summary>
		[XAQueryFieldAttribute("동적VI발동기준가격")]
		public long dvi_recprice;
		/// <summary>
		/// VI발동가격
		/// </summary>
		[XAQueryFieldAttribute("VI발동가격")]
