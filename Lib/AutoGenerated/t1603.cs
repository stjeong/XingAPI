...
namespace XingAPINet
{
	public partial class XQt1603InBlock : XingBlock
	{
		...
		/// 투자자구분
		/// </summary>
		[XAQueryFieldAttribute("gubun1", "투자자구분", "char", "1")]
		public char gubun1;
		/// <summary>
		/// 전일분구분
		/// </summary>
		...
		public void CopyTo(XQt1603InBlock block)
		{
	...
	public partial class XQt1603OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1603OutBlock block)
		{
			block.cts_idx = this.cts_idx;
			block.cts_time = this.cts_time;
	...
	public partial class XQt1603OutBlock1 : XingBlock
	{
		...
		/// 투자자구분
		/// </summary>
		[XAQueryFieldAttribute("tjjcode", "투자자구분", "char", "4")]
		public string tjjcode;
		/// <summary>
		/// 매수수량
		/// </summary>
		[XAQueryFieldAttribute("msvolume", "매수수량", "long", "8")]
		public long msvolume;
		/// <summary>
		/// 매도수량
		/// </summary>
		[XAQueryFieldAttribute("mdvolume", "매도수량", "long", "8")]
		public long mdvolume;
		/// <summary>
		/// 매수금액
		/// </summary>
		[XAQueryFieldAttribute("msvalue", "매수금액", "long", "12")]
		public long msvalue;
		/// <summary>
		/// 매도금액
		/// </summary>
		[XAQueryFieldAttribute("mdvalue", "매도금액", "long", "12")]
		public long mdvalue;
		/// <summary>
		/// 순매수수량
		/// </summary>
		[XAQueryFieldAttribute("svolume", "순매수수량", "long", "8")]
		public long svolume;
		/// <summary>
		/// 순매수금액
		/// </summary>
		[XAQueryFieldAttribute("svalue", "순매수금액", "long", "12")]
		public long svalue;
		...
		public void CopyTo(XQt1603OutBlock1 block)
		{
	...
	public partial class XQt1603 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char market = default,char gubun1 = default,char gubun2 = default,string cts_time = default,long cts_idx = default,int cnt = default,string upcode = default */)
		{
			using (XQt1603 instance = new XQt1603())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1603OutBlock" : $"XQt1603OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1603OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1603OutBlock1" : $"XQt1603OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1603OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1603OutBlock),
			typeof(XQt1603OutBlock1),
