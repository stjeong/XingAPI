...
namespace XingAPINet
{
	...
	public partial class XREC0OutBlock : XingBlock
	{
		...
		/// 정규장종가대비구분
		/// </summary>
		[XAQueryFieldAttribute("정규장종가대비구분")]
		public char sign;
		/// <summary>
		/// 정규장종가대비
		/// </summary>
		[XAQueryFieldAttribute("정규장종가대비")]
		public float change;
		/// <summary>
		/// 정규장종가기준등락율
		/// </summary>
		[XAQueryFieldAttribute("정규장종가기준등락율")]
		public float drate;
		/// <summary>
		/// 현재가
		/// </summary>
		...
		/// 누적거래대금(미제공)
		/// </summary>
		[XAQueryFieldAttribute("누적거래대금(미제공)")]
		public long value;
		/// <summary>
		/// 매도누적체결량
		/// </summary>
		...
		/// 매도누적체결건수(미제공)
		/// </summary>
		[XAQueryFieldAttribute("매도누적체결건수(미제공)")]
		...
		/// 매수누적체결건수(미제공)
		/// </summary>
		[XAQueryFieldAttribute("매수누적체결건수(미제공)")]
	...
	public partial class XREC0 : XingReal
	{
		...
		/// EC0
		/// </summary>
		static readonly string _typeName = "EC0";
		/// <summary>
		/// false
		/// </summary>
