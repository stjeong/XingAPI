...
namespace XingAPINet
{
	public partial class XQt2421InBlock : XingBlock
	{
		...
		/// 당일연결구분
		/// </summary>
		[XAQueryFieldAttribute("당일연결구분", "1")]
		public char tcgubun;
		/// <summary>
		/// 조회건수
		/// </summary>
	...
	public partial class XQt2421OutBlock : XingBlock
	{
		...
		/// 누적거래량
		/// </summary>
		[XAQueryFieldAttribute("누적거래량", "15.0")]
		public double volume;
		/// <summary>
		/// 미결제수량
		/// </summary>
		[XAQueryFieldAttribute("미결제수량", "8")]
		public long openyak;
	...
	public partial class XQt2421OutBlock1 : XingBlock
	{
		...
		/// 미결제시량
		/// </summary>
		[XAQueryFieldAttribute("미결제시량", "8")]
		public long openopenyak;
		/// <summary>
		/// 미결제고량
		/// </summary>
		[XAQueryFieldAttribute("미결제고량", "8")]
		public long highopenyak;
		/// <summary>
		/// 미결제저량
		/// </summary>
		[XAQueryFieldAttribute("미결제저량", "8")]
		public long lowopenyak;
		/// <summary>
		/// 미결제종량
		/// </summary>
		[XAQueryFieldAttribute("미결제종량", "8")]
