...
namespace XingAPINet
{
	...
	public partial class XQt1537OutBlock : XingBlock
	{
		...
		/// 상승종목수
		/// </summary>
		[XAQueryFieldAttribute("upcnt", "상승종목수", "long", "4")]
		public long upcnt;
		/// <summary>
		/// 테마종목수
		/// </summary>
		[XAQueryFieldAttribute("tmcnt", "테마종목수", "long", "4")]
		public long tmcnt;
		/// <summary>
		/// 상승종목비율
		/// </summary>
		[XAQueryFieldAttribute("uprate", "상승종목비율", "long", "4")]
		public long uprate;
		/// <summary>
		/// 테마명
		/// </summary>
	...
	public partial class XQt1537OutBlock1 : XingBlock
	{
		...
		/// 전일동시간
		/// </summary>
		[XAQueryFieldAttribute("jniltime", "전일동시간", "float", "9.2")]
	...
	public partial class XQt1537 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string tmcode = default */)
		{
			using (XQt1537 instance = new XQt1537())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1537OutBlock" : $"XQt1537OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1537OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1537OutBlock1" : $"XQt1537OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1537OutBlock1>(qo);
				return results;
			}
		}
