...
namespace XingAPINet
{
	public partial class XQt9945InBlock : XingBlock
	{
		...
		public void CopyTo(XQt9945InBlock block)
		{
	...
	public partial class XQt9945OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt9945OutBlock block)
		{
			block.hname = this.hname;
			block.shcode = this.shcode;
			block.expcode = this.expcode;
			block.etfchk = this.etfchk;
	...
	public partial class XQt9945 : XingQuery
	{
		...
		public static XQt9945OutBlock[] ReadFromDB(string tableNamePostfix = null /*, char gubun = default */)
		{
			using (XQt9945 instance = new XQt9945())
			{

				string tableName = (tableNamePostfix == null) ? "XQt9945OutBlock" : $"XQt9945OutBlock_{tableNamePostfix}";
