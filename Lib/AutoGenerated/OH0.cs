...
{
	public partial class XROH0InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XROH0OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		public static XROH0OutBlock FromQuery(XROH0 query)
		{
			XROH0OutBlock block = new XROH0OutBlock();
	...
	public partial class XROH0 : XingReal
	{
		...
		/// OH0
		/// </summary>
		public const string _typeName = "OH0";
		/// <summary>
		/// KOSPI200옵션호가(H0)
		/// </summary>
		public const string _typeDesc = "KOSPI200옵션호가(H0)";
		/// <summary>
		/// false
		/// </summary>
		...
		public bool SetBlock(XROH0InBlock block)
		{
		...
		public XROH0OutBlock GetBlock()
		{
			XROH0OutBlock instance = XROH0OutBlock.FromQuery(this);
			return instance;
