...
{
	public partial class XRSC1InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRSC1OutBlock : XingBlock
	{
		...
		public static XRSC1OutBlock FromQuery(XRSC1 query)
		{
			XRSC1OutBlock block = new XRSC1OutBlock();
	...
	/// 주식주문체결
	/// </summary>
	public partial class XRSC1 : XingReal
	{
		/// <summary>
		/// SC1
		/// </summary>
		public const string _typeName = "SC1";
		/// <summary>
		/// 주식주문체결
		/// </summary>
		public const string _typeDesc = "주식주문체결";
		/// <summary>
		/// false
		/// </summary>
		...
		/// 주식주문체결
		/// </summary>
		public XRSC1() : base("SC1") { }


		public bool SetBlock(XRSC1InBlock block)
		{
		...
		public XRSC1OutBlock GetBlock()
		{
			XRSC1OutBlock instance = XRSC1OutBlock.FromQuery(this);
			return instance;
