	...
	public partial class XQt4203 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,char gubun = default,long ncnt = default,long qrycnt = default,char tdgb = default,string sdate = default,string edate = default,string cts_date = default,string cts_time = default,char cts_daygb = default */)
		{
			using (XQt4203 instance = new XQt4203())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt4203OutBlock" : $"XQt4203OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt4203OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt4203OutBlock1" : $"XQt4203OutBlock1_{tableNamePostfix}";
