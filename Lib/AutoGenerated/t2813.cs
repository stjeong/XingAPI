...
{
	public partial class XQt2813InBlock : XingBlock
	{
		/// <summary>
		/// t2813InBlock
		/// </summary>
		public const string _blockName = "t2813InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt2813OutBlock : XingBlock
	{
		...
		/// t2813OutBlock
		/// </summary>
		public const string _blockName = "t2813OutBlock";
		/// <summary>
		/// 기본출력
		/// </summary>
		...
		public static XQt2813OutBlock FromQuery(XQt2813 query)
		{
			XQt2813OutBlock block = new XQt2813OutBlock();
	...
	public partial class XQt2813OutBlock1 : XingBlock
	{
		...
		/// t2813OutBlock1
		/// </summary>
		public const string _blockName = "t2813OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		public static XQt2813OutBlock1[] ListFromQuery(XQt2813 query)
		{
			int count = query.GetBlockCount(XQt2813OutBlock1.BlockName);
			List<XQt2813OutBlock1> list = new List<XQt2813OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt2813OutBlock1 block = new XQt2813OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
	...
	public partial class XQt2813 : XingQuery
	{
		...
		/// t2813
		/// </summary>
		public const string _typeName = "t2813";
		/// <summary>
		/// CME야간선물시간대별투자자매매추이(t2813)
		/// </summary>
		public const string _typeDesc = "CME야간선물시간대별투자자매매추이(t2813)";
		/// <summary>
		/// 
		/// </summary>
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun1 = default,char gubun2 = default,string cts_time = default,long cts_idx = default,int cnt = default,char gubun3 = default */)
		{
			using (XQt2813 instance = new XQt2813())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt2813OutBlock" : $"XQt2813OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt2813OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt2813OutBlock1" : $"XQt2813OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt2813OutBlock1>(qo);
				return results;
			}
		}
		...
		public XQt2813OutBlock GetBlock()
		{
			XQt2813OutBlock instance = XQt2813OutBlock.FromQuery(this);
			return instance;

		}

		public XQt2813OutBlock1[] GetBlock1s()
		{
			XQt2813OutBlock1[] instance = XQt2813OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt2813OutBlock),
			typeof(XQt2813OutBlock1),
