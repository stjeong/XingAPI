...
namespace XingAPINet
{
	public partial class XQFOCCQ33700InBlock1 : XingBlock
	{
		...
		/// FOCCQ33700InBlock1
		/// </summary>
		static readonly string _blockName = "FOCCQ33700InBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		...
		/// 기준금액구분
		/// </summary>
		[XAQueryFieldAttribute("기준금액구분")]
		public char BaseAmtTp;
		/// <summary>
		/// 조회기간구분
		/// </summary>
		[XAQueryFieldAttribute("조회기간구분")]
		public char QryTermTp;
		/// <summary>
		/// 손익산출구분코드
		/// </summary>
		[XAQueryFieldAttribute("손익산출구분코드")]
	...
	public partial class XQFOCCQ33700OutBlock1 : XingBlock
	{
		...
		/// FOCCQ33700OutBlock1
		/// </summary>
		static readonly string _blockName = "FOCCQ33700OutBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		static readonly string _blockDesc = "In(*EMPTY*)";
	...
	public partial class XQFOCCQ33700OutBlock2 : XingBlock
	{
		...
		/// FOCCQ33700OutBlock2
		/// </summary>
		static readonly string _blockName = "FOCCQ33700OutBlock2";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
		...
		/// 선물옵션약정금액
		/// </summary>
		[XAQueryFieldAttribute("선물옵션약정금액")]
		public long FnoCtrctAmt;
		/// <summary>
		/// 투자원금평잔금액
		/// </summary>
		[XAQueryFieldAttribute("투자원금평잔금액")]
	...
	public partial class XQFOCCQ33700OutBlock3 : XingBlock
	{
		...
		/// FOCCQ33700OutBlock3
		/// </summary>
		static readonly string _blockName = "FOCCQ33700OutBlock3";
		/// <summary>
		/// OutList(*EMPTY*)
		/// </summary>
		static readonly string _blockDesc = "OutList(*EMPTY*)";
		/// <summary>
		/// output
		/// </summary>
		static readonly string _blockType = "output";
		...
		/// 거래일
		/// </summary>
		[XAQueryFieldAttribute("거래일")]
		public string TrdDt;
		/// <summary>
		/// 기초예탁자산금액
		/// </summary>
		[XAQueryFieldAttribute("기초예탁자산금액")]
		public long FdDpsastAmt;
		/// <summary>
		/// 기말예탁자산금액
		/// </summary>
		[XAQueryFieldAttribute("기말예탁자산금액")]
	...
	public partial class XQFOCCQ33700 : XingQuery
	{
		...
		/// FOCCQ33700
		/// </summary>
		static readonly string _typeName = "FOCCQ33700";
		/// <summary>
		/// 선물옵션 기간별 계좌 수익률 현황
		/// </summary>
		static readonly string _typeDesc = "선물옵션 기간별 계좌 수익률 현황";
		/// <summary>
		/// FOCCQ33700
		/// </summary>
		static readonly string _service = "FOCCQ33700";
		/// <summary>
		/// B
		/// </summary>
		...
		/// 이석희
		/// </summary>
		static readonly string _creator = "이석희";
		/// <summary>
		/// 2013/01/08 10:45:28
		/// </summary>
		static readonly string _createdDate = "2013/01/08 10:45:28";
		/// <summary>
		/// false
		/// </summary>
