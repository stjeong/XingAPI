...
{
	public partial class XQt1602InBlock : XingBlock
	{
		/// <summary>
		/// t1602InBlock
		/// </summary>
		...
		/// 수량구분
		/// </summary>
		[XAQueryFieldAttribute("gubun1", "수량구분", "char", "1")]
		public char gubun1;
		/// <summary>
		/// 전일분구분
		/// </summary>
		[XAQueryFieldAttribute("gubun2", "전일분구분", "char", "1")]
		public char gubun2;
		/// <summary>
		/// CTSTIME
		/// </summary>
		...
		/// 직전대비구분(C:직전대비)
		/// </summary>
		[XAQueryFieldAttribute("gubun3", "직전대비구분(C:직전대비)", "char", "1")]
		public char gubun3;
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["gubun3"] = new XAQueryFieldInfo("char", gubun3, gubun3.ToString(), "직전대비구분(C:직전대비)", (decimal)1);
		...
		public void CopyTo(XQt1602InBlock block)
		{
	...
	public partial class XQt1602OutBlock : XingBlock
	{
		/// <summary>
		/// t1602OutBlock
		/// </summary>
		...
		/// 국가투자자코드
		/// </summary>
		[XAQueryFieldAttribute("tjjcode_11", "국가투자자코드", "char", "4")]
		...
		/// 사모펀드코드
		/// </summary>
		[XAQueryFieldAttribute("tjjcode_00", "사모펀드코드", "char", "4")]
		...
		public static XQt1602OutBlock FromQuery(XQt1602 query)
		{
			XQt1602OutBlock block = new XQt1602OutBlock();
		...
		public void CopyTo(XQt1602OutBlock block)
		{
			block.cts_time = this.cts_time;
	...
	public partial class XQt1602OutBlock1 : XingBlock
	{
		/// <summary>
		/// t1602OutBlock1
		/// </summary>
		...
		/// 투신순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_03", "투신순매수", "long", "12")]
		public long sv_03;
		/// <summary>
		/// 은행순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_04", "은행순매수", "long", "12")]
		public long sv_04;
		/// <summary>
		/// 보험순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_02", "보험순매수", "long", "12")]
		public long sv_02;
		/// <summary>
		/// 종금순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_05", "종금순매수", "long", "12")]
		public long sv_05;
		/// <summary>
		/// 기금순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_06", "기금순매수", "long", "12")]
		public long sv_06;
		/// <summary>
		/// 기타순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_07", "기타순매수", "long", "12")]
		public long sv_07;
		/// <summary>
		/// 국가순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_11", "국가순매수", "long", "12")]
		public long sv_11;
		/// <summary>
		/// 사모펀드순매수
		/// </summary>
		[XAQueryFieldAttribute("sv_00", "사모펀드순매수", "long", "12")]
		public long sv_00;
		...
		public static XQt1602OutBlock1[] ListFromQuery(XQt1602 query)
		{
			int count = query.GetBlockCount(XQt1602OutBlock1.BlockName);
			List<XQt1602OutBlock1> list = new List<XQt1602OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt1602OutBlock1 block = new XQt1602OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
		...
		public void CopyTo(XQt1602OutBlock1 block)
		{
	...
	public partial class XQt1602 : XingQuery
	{
		...
		{
			public XQt1602OutBlock OutBlock { get; internal set; }
			public XQt1602OutBlock1[] OutBlock1 { get; internal set; }
		}

		public static XQAllOutBlocks Get(char market = default,string upcode = default,char gubun1 = default,char gubun2 = default,string cts_time = default,long cts_idx = default,int cnt = default,char gubun3 = default)
		{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char market = default,string upcode = default,char gubun1 = default,char gubun2 = default,string cts_time = default,long cts_idx = default,int cnt = default,char gubun3 = default */)
		{
			using (XQt1602 instance = new XQt1602())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1602OutBlock" : $"XQt1602OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1602OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1602OutBlock1" : $"XQt1602OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1602OutBlock1>(qo);
				return results;
			}
		}
		...
		public XQt1602OutBlock GetBlock()
		{
			XQt1602OutBlock instance = XQt1602OutBlock.FromQuery(this);
			return instance;

		}

		public XQt1602OutBlock1[] GetBlock1s()
		{
			XQt1602OutBlock1[] instance = XQt1602OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt1602OutBlock),
			typeof(XQt1602OutBlock1),
