...
namespace XingAPINet
{
	public partial class XQt1471InBlock : XingBlock
	{
		...
		public void CopyTo(XQt1471InBlock block)
		{
	...
	public partial class XQt1471OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1471OutBlock block)
		{
			block.time = this.time;
	...
	public partial class XQt1471OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQt1471OutBlock1 block)
		{
			block.time = this.time;
			...
			block.totsun = this.totsun;
			block.msrate = this.msrate;
	...
	public partial class XQt1471 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,string gubun = default,string time = default,string cnt = default */)
		{
			using (XQt1471 instance = new XQt1471())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1471OutBlock" : $"XQt1471OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1471OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1471OutBlock1" : $"XQt1471OutBlock1_{tableNamePostfix}";
