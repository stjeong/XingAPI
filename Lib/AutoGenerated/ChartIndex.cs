...
namespace XingAPINet
{
	public partial class XQChartIndexInBlock : XingBlock
	{
		...
		/// ChartIndexInBlock
		/// </summary>
		static readonly string _blockName = "ChartIndexInBlock";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		...
		/// 요청건수(최대 500개)
		/// </summary>
		[XAQueryFieldAttribute("요청건수(최대 500개)")]
		public long qrycnt;
		/// <summary>
		/// 단위(n틱/n분)
		/// </summary>
		[XAQueryFieldAttribute("단위(n틱/n분)")]
		public long ncnt;
		/// <summary>
		/// 시작일자
		/// </summary>
		...
		/// 수정주가 반영 여부
		/// </summary>
		[XAQueryFieldAttribute("수정주가 반영 여부")]
		public char Isamend;
		/// <summary>
		/// 갭보정 여부
		/// </summary>
		[XAQueryFieldAttribute("갭보정 여부")]
		public char Isgab;
		/// <summary>
		/// 실시간 데이터수신 자동등록 여부
		/// </summary>
	...
	public partial class XQChartIndexOutBlock : XingBlock
	{
		...
		/// ChartIndexOutBlock
		/// </summary>
		static readonly string _blockName = "ChartIndexOutBlock";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
	...
	public partial class XQChartIndexOutBlock1 : XingBlock
	{
		...
		/// ChartIndexOutBlock1
		/// </summary>
		static readonly string _blockName = "ChartIndexOutBlock1";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
		static readonly string _blockDesc = "Out(*EMPTY*)";
	...
	public partial class XQCHARTINDEX : XingQuery
	{
		...
		/// CHARTINDEX
		/// </summary>
		static readonly string _typeName = "CHARTINDEX";
		/// <summary>
		/// 챠트지표데이터조회
		/// </summary>
		static readonly string _typeDesc = "챠트지표데이터조회";
		/// <summary>
		/// 
		/// </summary>
