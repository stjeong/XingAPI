...
{
	public partial class XRYK3InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRYK3OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		/// 예상매도호가
		/// </summary>
		[XAQueryFieldAttribute("예상매도호가")]
		public long yofferho0;
		/// <summary>
		/// 예상매수호가
		/// </summary>
		[XAQueryFieldAttribute("예상매수호가")]
		public long ybidho0;
		/// <summary>
		/// 예상매도호가수량
		/// </summary>
		[XAQueryFieldAttribute("예상매도호가수량")]
		public long yofferrem0;
		/// <summary>
		/// 예상매수호가수량
		/// </summary>
		[XAQueryFieldAttribute("예상매수호가수량")]
		...
		public static XRYK3OutBlock FromQuery(XRYK3 query)
		{
			XRYK3OutBlock block = new XRYK3OutBlock();
	...
	public partial class XRYK3 : XingReal
	{
		...
		/// YK3
		/// </summary>
		public const string _typeName = "YK3";
		/// <summary>
		/// KOSDAQ예상체결(YK3)
		/// </summary>
		public const string _typeDesc = "KOSDAQ예상체결(YK3)";
		/// <summary>
		/// false
		/// </summary>
		...
		public XRYK3OutBlock GetBlock()
		{
			XRYK3OutBlock instance = XRYK3OutBlock.FromQuery(this);
			return instance;
