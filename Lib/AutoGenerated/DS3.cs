...
{
	public partial class XRDS3InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
		...
		public void CopyTo(XRDS3InBlock block)
		{
	...
	public partial class XRDS3OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		public static XRDS3OutBlock FromQuery(XRDS3 query)
		{
			XRDS3OutBlock block = new XRDS3OutBlock();
		...
		public void CopyTo(XRDS3OutBlock block)
		{
	...
	/// KOSPI시간외단일가체결(DS3)
	/// </summary>
	public partial class XRDS3 : XingReal
	{
		/// <summary>
		/// DS3
		/// </summary>
		public const string _typeName = "DS3";
		/// <summary>
		/// KOSPI시간외단일가체결(DS3)
		/// </summary>
		public const string _typeDesc = "KOSPI시간외단일가체결(DS3)";
		/// <summary>
		/// false
		/// </summary>
		...
		/// KOSPI시간외단일가체결(DS3)
		/// </summary>
		public XRDS3() : base("DS3") { }


		public bool SetBlock(XRDS3InBlock block)
		{
		...
		public XRDS3OutBlock GetBlock()
		{
			XRDS3OutBlock instance = XRDS3OutBlock.FromQuery(this);
			return instance;
