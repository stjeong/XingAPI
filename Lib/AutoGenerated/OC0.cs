...
{
	public partial class XROC0InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XROC0OutBlock : XingBlock
	{
		...
		/// KOSPI등가
		/// </summary>
		[XAQueryFieldAttribute("KOSPI등가", "7.2")]
		public float eqva;
		/// <summary>
		/// 이론가
		/// </summary>
		...
		public static XROC0OutBlock FromQuery(XROC0 query)
		{
			XROC0OutBlock block = new XROC0OutBlock();
	...
	public partial class XROC0 : XingReal
	{
		...
		/// OC0
		/// </summary>
		public const string _typeName = "OC0";
		/// <summary>
		/// KOSPI200옵션체결(C0)
		/// </summary>
		public const string _typeDesc = "KOSPI200옵션체결(C0)";
		/// <summary>
		/// false
		/// </summary>
		...
		public XROC0OutBlock GetBlock()
		{
			XROC0OutBlock instance = XROC0OutBlock.FromQuery(this);
			return instance;
