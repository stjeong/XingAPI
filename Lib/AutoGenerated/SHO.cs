...
namespace XingAPINet
{
	public partial class XRSHOInBlock : XingBlock
	{
		...
		/// 상/하한구분
		/// </summary>
		[XAQueryFieldAttribute("상/하한구분", "1")]
	...
	public partial class XRSHOOutBlock : XingBlock
	{
		...
		/// 거래소/코스닥구분
		/// </summary>
		[XAQueryFieldAttribute("거래소/코스닥구분", "1")]
		...
		/// 상/하한가
		/// </summary>
		[XAQueryFieldAttribute("상/하한가", "8")]
		public long updnlmtprice;
		/// <summary>
		/// 상/하한가대비
		/// </summary>
		[XAQueryFieldAttribute("상/하한가대비", "8")]
		public long updnlmtchange;
		/// <summary>
		/// 상/하한가대비율
		/// </summary>
		[XAQueryFieldAttribute("상/하한가대비율", "6.2")]
		...
		/// 관리구분
		/// </summary>
		[XAQueryFieldAttribute("관리구분", "1")]
		public char gwangubun;
		/// <summary>
		/// 이상급등구분
		/// </summary>
		[XAQueryFieldAttribute("이상급등구분", "1")]
		public char undergubun;
		/// <summary>
		/// 투자유의구분
		/// </summary>
		[XAQueryFieldAttribute("투자유의구분", "1")]
		public char tgubun;
		/// <summary>
		/// 우선주구분
		/// </summary>
		[XAQueryFieldAttribute("우선주구분", "1")]
		public char wgubun;
		/// <summary>
		/// 불성실구분
		/// </summary>
		[XAQueryFieldAttribute("불성실구분", "1")]
		public char dishonest;
		/// <summary>
		/// 증거금률
		/// </summary>
		[XAQueryFieldAttribute("증거금률", "1")]
		public char jkrate;
	...
	public partial class XRSHO : XingReal
	{
		...
		/// SHO
		/// </summary>
		public const string _typeName = "SHO";
		/// <summary>
		/// 상/하한가이탈(SHO)
		/// </summary>
		public const string _typeDesc = "상/하한가이탈(SHO)";
		/// <summary>
		/// false
		/// </summary>
