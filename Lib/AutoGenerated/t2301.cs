...
namespace XingAPINet
{
	public partial class XQt2301InBlock : XingBlock
	{
		...
		/// 월물
		/// </summary>
		[XAQueryFieldAttribute("월물", "6")]
		public string yyyymm;
		/// <summary>
		/// 미니구분(M:미니G:정규)
		/// </summary>
		[XAQueryFieldAttribute("미니구분(M:미니G:정규)", "1")]
		public char gubun;
	...
	public partial class XQt2301OutBlock : XingBlock
	{
		...
		/// 역사적변동성
		/// </summary>
		[XAQueryFieldAttribute("역사적변동성", "4")]
		public long histimpv;
		/// <summary>
		/// 옵션잔존일
		/// </summary>
		[XAQueryFieldAttribute("옵션잔존일", "4")]
		public long jandatecnt;
		/// <summary>
		/// 콜옵션대표IV
		/// </summary>
		[XAQueryFieldAttribute("콜옵션대표IV", "6.3")]
		public float cimpv;
		/// <summary>
		/// 풋옵션대표IV
		/// </summary>
		[XAQueryFieldAttribute("풋옵션대표IV", "6.3")]
		public float pimpv;
		/// <summary>
		/// 근월물현재가
		/// </summary>
		...
		/// 근월물거래량
		/// </summary>
		[XAQueryFieldAttribute("근월물거래량", "12")]
		public long gmvolume;
		/// <summary>
		/// 근월물선물코드
		/// </summary>
		[XAQueryFieldAttribute("근월물선물코드", "8")]
	...
	public partial class XQt2301OutBlock1 : XingBlock
	{
		...
		/// 미결제약정증감
		/// </summary>
		[XAQueryFieldAttribute("미결제약정증감", "12")]
		...
		/// 잔고수량
		/// </summary>
		[XAQueryFieldAttribute("잔고수량", "12")]
		public long jvolume;
		/// <summary>
		/// 평가손익
		/// </summary>
		[XAQueryFieldAttribute("평가손익", "12")]
		public long parpl;
		/// <summary>
		/// 청산가능수량
		/// </summary>
		[XAQueryFieldAttribute("청산가능수량", "6")]
		public long jngo;
		/// <summary>
		/// 매도잔량
		/// </summary>
		...
		/// ATM구분
		/// </summary>
		[XAQueryFieldAttribute("ATM구분", "1")]
		public char atmgubun;
		/// <summary>
		/// 지수환산
		/// </summary>
		[XAQueryFieldAttribute("지수환산", "6.2")]
