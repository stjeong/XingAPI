...
{
	public partial class XREH0InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
		...
		public void CopyTo(XREH0InBlock block)
		{
	...
	public partial class XREH0OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		/// 호가시간(24시간)
		/// </summary>
		[XAQueryFieldAttribute("hotime", "호가시간(24시간)", "char", "6")]
		public string hotime;
		/// <summary>
		/// 호가시간(36시간)
		/// </summary>
		[XAQueryFieldAttribute("hotime1", "호가시간(36시간)", "char", "6")]
		public string hotime1;
		/// <summary>
		/// 매도호가1
		/// </summary>
		...
		/// 매도호가건수1(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offercnt1", "매도호가건수1(미제공)", "long", "5")]
		public long offercnt1;
		/// <summary>
		/// 매수호가건수1(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidcnt1", "매수호가건수1(미제공)", "long", "5")]
		public long bidcnt1;
		/// <summary>
		/// 매도호가2
		/// </summary>
		...
		/// 매도호가건수2(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offercnt2", "매도호가건수2(미제공)", "long", "5")]
		public long offercnt2;
		/// <summary>
		/// 매수호가건수2(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidcnt2", "매수호가건수2(미제공)", "long", "5")]
		public long bidcnt2;
		/// <summary>
		/// 매도호가3
		/// </summary>
		...
		/// 매도호가건수3(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offercnt3", "매도호가건수3(미제공)", "long", "5")]
		public long offercnt3;
		/// <summary>
		/// 매수호가건수3(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidcnt3", "매수호가건수3(미제공)", "long", "5")]
		public long bidcnt3;
		/// <summary>
		/// 매도호가4(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offerho4", "매도호가4(미제공)", "double", "6.2")]
		public double offerho4;
		/// <summary>
		/// 매수호가4(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidho4", "매수호가4(미제공)", "double", "6.2")]
		public double bidho4;
		/// <summary>
		/// 매도호가수량4(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offerrem4", "매도호가수량4(미제공)", "long", "7")]
		public long offerrem4;
		/// <summary>
		/// 매수호가수량4(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidrem4", "매수호가수량4(미제공)", "long", "7")]
		public long bidrem4;
		/// <summary>
		/// 매도호가건수4(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offercnt4", "매도호가건수4(미제공)", "long", "5")]
		public long offercnt4;
		/// <summary>
		/// 매수호가건수4(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidcnt4", "매수호가건수4(미제공)", "long", "5")]
		public long bidcnt4;
		/// <summary>
		/// 매도호가5(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offerho5", "매도호가5(미제공)", "double", "6.2")]
		public double offerho5;
		/// <summary>
		/// 매수호가5(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidho5", "매수호가5(미제공)", "double", "6.2")]
		public double bidho5;
		/// <summary>
		/// 매도호가수량5(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offerrem5", "매도호가수량5(미제공)", "long", "7")]
		public long offerrem5;
		/// <summary>
		/// 매수호가수량5(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidrem5", "매수호가수량5(미제공)", "long", "7")]
		public long bidrem5;
		/// <summary>
		/// 매도호가건수5(미제공)
		/// </summary>
		[XAQueryFieldAttribute("offercnt5", "매도호가건수5(미제공)", "long", "5")]
		public long offercnt5;
		/// <summary>
		/// 매수호가건수5(미제공)
		/// </summary>
		[XAQueryFieldAttribute("bidcnt5", "매수호가건수5(미제공)", "long", "5")]
		public long bidcnt5;
		/// <summary>
		/// 매도호가총수량
		/// </summary>
		[XAQueryFieldAttribute("totofferrem", "매도호가총수량", "long", "7")]
		public long totofferrem;
		/// <summary>
		/// 매수호가총수량
		/// </summary>
		[XAQueryFieldAttribute("totbidrem", "매수호가총수량", "long", "7")]
		...
		public static class F
		{
			...
			/// 호가시간(36시간)
			/// </summary>
			public const string hotime1 = "hotime1";
			/// <summary>
			/// 매도호가1
			/// </summary>
		...
		{
			Dictionary<string, XAQueryFieldInfo> dict = new Dictionary<string, XAQueryFieldInfo>();
			dict["hotime"] = new XAQueryFieldInfo("char", hotime, hotime, "호가시간(24시간)", (decimal)6);
			dict["hotime1"] = new XAQueryFieldInfo("char", hotime1, hotime1, "호가시간(36시간)", (decimal)6);
			...
			dict["offercnt1"] = new XAQueryFieldInfo("long", offercnt1, offercnt1.ToString("d5"), "매도호가건수1(미제공)", (decimal)5);
			dict["bidcnt1"] = new XAQueryFieldInfo("long", bidcnt1, bidcnt1.ToString("d5"), "매수호가건수1(미제공)", (decimal)5);
			...
			dict["offercnt2"] = new XAQueryFieldInfo("long", offercnt2, offercnt2.ToString("d5"), "매도호가건수2(미제공)", (decimal)5);
			dict["bidcnt2"] = new XAQueryFieldInfo("long", bidcnt2, bidcnt2.ToString("d5"), "매수호가건수2(미제공)", (decimal)5);
			...
			dict["offercnt3"] = new XAQueryFieldInfo("long", offercnt3, offercnt3.ToString("d5"), "매도호가건수3(미제공)", (decimal)5);
			dict["bidcnt3"] = new XAQueryFieldInfo("long", bidcnt3, bidcnt3.ToString("d5"), "매수호가건수3(미제공)", (decimal)5);
			dict["offerho4"] = new XAQueryFieldInfo("double", offerho4, offerho4.ToString("000000.00"), "매도호가4(미제공)", (decimal)6.2);
			dict["bidho4"] = new XAQueryFieldInfo("double", bidho4, bidho4.ToString("000000.00"), "매수호가4(미제공)", (decimal)6.2);
			dict["offerrem4"] = new XAQueryFieldInfo("long", offerrem4, offerrem4.ToString("d7"), "매도호가수량4(미제공)", (decimal)7);
			dict["bidrem4"] = new XAQueryFieldInfo("long", bidrem4, bidrem4.ToString("d7"), "매수호가수량4(미제공)", (decimal)7);
			dict["offercnt4"] = new XAQueryFieldInfo("long", offercnt4, offercnt4.ToString("d5"), "매도호가건수4(미제공)", (decimal)5);
			dict["bidcnt4"] = new XAQueryFieldInfo("long", bidcnt4, bidcnt4.ToString("d5"), "매수호가건수4(미제공)", (decimal)5);
			dict["offerho5"] = new XAQueryFieldInfo("double", offerho5, offerho5.ToString("000000.00"), "매도호가5(미제공)", (decimal)6.2);
			dict["bidho5"] = new XAQueryFieldInfo("double", bidho5, bidho5.ToString("000000.00"), "매수호가5(미제공)", (decimal)6.2);
			dict["offerrem5"] = new XAQueryFieldInfo("long", offerrem5, offerrem5.ToString("d7"), "매도호가수량5(미제공)", (decimal)7);
			dict["bidrem5"] = new XAQueryFieldInfo("long", bidrem5, bidrem5.ToString("d7"), "매수호가수량5(미제공)", (decimal)7);
			dict["offercnt5"] = new XAQueryFieldInfo("long", offercnt5, offercnt5.ToString("d5"), "매도호가건수5(미제공)", (decimal)5);
			dict["bidcnt5"] = new XAQueryFieldInfo("long", bidcnt5, bidcnt5.ToString("d5"), "매수호가건수5(미제공)", (decimal)5);
			dict["totofferrem"] = new XAQueryFieldInfo("long", totofferrem, totofferrem.ToString("d7"), "매도호가총수량", (decimal)7);
			dict["totbidrem"] = new XAQueryFieldInfo("long", totbidrem, totbidrem.ToString("d7"), "매수호가총수량", (decimal)7);
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "hotime1":
					this.hotime1 = fieldInfo.FieldValue.TrimEnd('?');
				break;
		...
		public static XREH0OutBlock FromQuery(XREH0 query)
		{
			XREH0OutBlock block = new XREH0OutBlock();
			block.IsValidData = true;
			block.InvalidReason = "";
			try
			{
				block.hotime = query.GetFieldData(block.GetBlockName(), "hotime").TrimEnd('?'); // char 6
				block.hotime1 = query.GetFieldData(block.GetBlockName(), "hotime1").TrimEnd('?'); // char 6
				...
				block.totofferrem = query.GetFieldData(block.GetBlockName(), "totofferrem").ParseLong("totofferrem"); // long 7
				block.totbidrem = query.GetFieldData(block.GetBlockName(), "totbidrem").ParseLong("totbidrem"); // long 7
		...
		public bool VerifyData()
		{
			...
			if (hotime1?.Length > 6) return false; // char 6
			// offerho1 double 6.2
			// bidho1 double 6.2
			...
			if (totofferrem.ToString().Length > 7) return false; // long 7
			if (totbidrem.ToString().Length > 7) return false; // long 7
		...
		public void CopyTo(XREH0OutBlock block)
		{
	...
	public partial class XREH0 : XingReal
	{
		...
		/// EH0
		/// </summary>
		public const string _typeName = "EH0";
		/// <summary>
		/// EUREX연계KP200지수옵션선물호가(EH0)
		/// </summary>
		public const string _typeDesc = "EUREX연계KP200지수옵션선물호가(EH0)";
		/// <summary>
		/// false
		/// </summary>
		...
		public XREH0OutBlock GetBlock()
		{
			XREH0OutBlock instance = XREH0OutBlock.FromQuery(this);
			return instance;
