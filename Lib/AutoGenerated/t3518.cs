...
namespace XingAPINet
{
	public partial class XQt3518InBlock : XingBlock
	{
		...
		/// 입력건수
		/// </summary>
		[XAQueryFieldAttribute("cnt", "입력건수", "long", "4")]
		public long cnt;
		/// <summary>
		/// 조회구분
		/// </summary>
		[XAQueryFieldAttribute("jgbn", "조회구분", "char", "1")]
		public char jgbn;
		/// <summary>
		/// N분
		/// </summary>
		[XAQueryFieldAttribute("nmin", "N분", "long", "3")]
		public long nmin;
		/// <summary>
		/// CTS_DATE
		/// </summary>
		[XAQueryFieldAttribute("cts_date", "CTS_DATE", "char", "8")]
		public string cts_date;
		/// <summary>
		/// CTS_TIME
		/// </summary>
		[XAQueryFieldAttribute("cts_time", "CTS_TIME", "char", "6")]
	...
	public partial class XQt3518OutBlock1 : XingBlock
	{
		...
		/// 시가
		/// </summary>
		[XAQueryFieldAttribute("open", "시가", "double", "9.4")]
		public double open;
		/// <summary>
		/// 고가
		/// </summary>
		[XAQueryFieldAttribute("high", "고가", "double", "9.4")]
		public double high;
		/// <summary>
		/// 저가
		/// </summary>
		[XAQueryFieldAttribute("low", "저가", "double", "9.4")]
		public double low;
		/// <summary>
		/// 현재가
		/// </summary>
		[XAQueryFieldAttribute("price", "현재가", "double", "9.4")]
		public double price;
		/// <summary>
		/// 전일대비구분
		/// </summary>
		...
		/// 전일대비
		/// </summary>
		[XAQueryFieldAttribute("change", "전일대비", "double", "9.4")]
		public double change;
		/// <summary>
		/// 등락율
		/// </summary>
		[XAQueryFieldAttribute("uprate", "등락율", "double", "9.4")]
		...
		/// 매수호가
		/// </summary>
		[XAQueryFieldAttribute("bidho", "매수호가", "double", "9.4")]
		public double bidho;
		/// <summary>
		/// 매도호가
		/// </summary>
		[XAQueryFieldAttribute("offerho", "매도호가", "double", "9.4")]
		public double offerho;
		/// <summary>
		/// 매수잔량
		/// </summary>
		[XAQueryFieldAttribute("bidrem", "매수잔량", "double", "12.0")]
		public double bidrem;
		/// <summary>
		/// 매도잔량
		/// </summary>
		[XAQueryFieldAttribute("offerrem", "매도잔량", "double", "12.0")]
		...
		/// EXID
		/// </summary>
		[XAQueryFieldAttribute("exid", "EXID", "char", "4")]
		public string exid;
		/// <summary>
		/// 한국일자
		/// </summary>
		...
		/// 한국시간
		/// </summary>
		[XAQueryFieldAttribute("kotime", "한국시간", "char", "8")]
	...
	public partial class XQt3518 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char kind = default,string symbol = default,long cnt = default,char jgbn = default,long nmin = default,string cts_date = default,string cts_time = default */)
		{
			using (XQt3518 instance = new XQt3518())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt3518OutBlock" : $"XQt3518OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt3518OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt3518OutBlock1" : $"XQt3518OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt3518OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt3518OutBlock),
			typeof(XQt3518OutBlock1),
