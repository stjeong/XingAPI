...
namespace XingAPINet
{
	public partial class XQt8414InBlock : XingBlock
	{
		...
		public void CopyTo(XQt8414InBlock block)
		{
	...
	public partial class XQt8414OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt8414OutBlock block)
		{
			block.shcode = this.shcode;
	...
	public partial class XQt8414OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQt8414OutBlock1 block)
		{
	...
	public partial class XQt8414 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,long ncnt = default,long qrycnt = default,char nday = default,string sdate = default,string stime = default,string edate = default,string etime = default,string cts_date = default,string cts_time = default,char comp_yn = default */)
		{
			using (XQt8414 instance = new XQt8414())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt8414OutBlock" : $"XQt8414OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt8414OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt8414OutBlock1" : $"XQt8414OutBlock1_{tableNamePostfix}";
