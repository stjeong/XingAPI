...
namespace XingAPINet
{
	public partial class XQt1941InBlock : XingBlock
	{
		...
		/// t1941InBlock
		/// </summary>
		static readonly string _blockName = "t1941InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt1941OutBlock1 : XingBlock
	{
		...
		/// t1941OutBlock1
		/// </summary>
		static readonly string _blockName = "t1941OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 당일체결
		/// </summary>
		[XAQueryFieldAttribute("당일체결")]
		public long upvolume;
		/// <summary>
		/// 당일상환
		/// </summary>
		[XAQueryFieldAttribute("당일상환")]
		public long dnvolume;
		/// <summary>
		/// 당일잔고
		/// </summary>
		[XAQueryFieldAttribute("당일잔고")]
		public long tovolume;
		/// <summary>
		/// 잔고금액
		/// </summary>
		[XAQueryFieldAttribute("잔고금액")]
		public long tovalue;
		/// <summary>
		/// 종목코드
		/// </summary>
	...
	public partial class XQt1941 : XingQuery
	{
		...
		/// t1941
		/// </summary>
		static readonly string _typeName = "t1941";
		/// <summary>
		/// 종목별대차거래일간추이(t1941)
		/// </summary>
		static readonly string _typeDesc = "종목별대차거래일간추이(t1941)";
		/// <summary>
		/// 
		/// </summary>
