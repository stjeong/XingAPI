...
namespace XingAPINet
{
	public partial class XQt8403InBlock : XingBlock
	{
		...
		/// t8403InBlock
		/// </summary>
		static readonly string _blockName = "t8403InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8403OutBlock : XingBlock
	{
		...
		/// t8403OutBlock
		/// </summary>
		static readonly string _blockName = "t8403OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		/// 매도호가건수6
		/// </summary>
		[XAQueryFieldAttribute("매도호가건수6")]
		public long dcnt6;
		/// <summary>
		/// 매수호가건수6
		/// </summary>
		[XAQueryFieldAttribute("매수호가건수6")]
		public long scnt6;
		/// <summary>
		/// 매도호가7
		/// </summary>
		...
		/// 매도호가건수7
		/// </summary>
		[XAQueryFieldAttribute("매도호가건수7")]
		public long dcnt7;
		/// <summary>
		/// 매수호가건수7
		/// </summary>
		[XAQueryFieldAttribute("매수호가건수7")]
		public long scnt7;
		/// <summary>
		/// 매도호가8
		/// </summary>
		...
		/// 매도호가건수8
		/// </summary>
		[XAQueryFieldAttribute("매도호가건수8")]
		public long dcnt8;
		/// <summary>
		/// 매수호가건수8
		/// </summary>
		[XAQueryFieldAttribute("매수호가건수8")]
		public long scnt8;
		/// <summary>
		/// 매도호가9
		/// </summary>
		...
		/// 매도호가건수9
		/// </summary>
		[XAQueryFieldAttribute("매도호가건수9")]
		public long dcnt9;
		/// <summary>
		/// 매수호가건수9
		/// </summary>
		[XAQueryFieldAttribute("매수호가건수9")]
		public long scnt9;
		/// <summary>
		/// 매도호가10
		/// </summary>
		...
		/// 매도호가건수10
		/// </summary>
		[XAQueryFieldAttribute("매도호가건수10")]
		public long dcnt10;
		/// <summary>
		/// 매수호가건수10
		/// </summary>
		[XAQueryFieldAttribute("매수호가건수10")]
		public long scnt10;
		/// <summary>
		/// 매도호가총수량
		/// </summary>
		...
		/// 총매도호가건수
		/// </summary>
		[XAQueryFieldAttribute("총매도호가건수")]
		public long toffernum;
		/// <summary>
		/// 총매수호가건수
		/// </summary>
		[XAQueryFieldAttribute("총매수호가건수")]
		public long tbidnum;
		/// <summary>
		/// 수신시간
		/// </summary>
	...
	public partial class XQt8403 : XingQuery
	{
		...
		/// t8403
		/// </summary>
		static readonly string _typeName = "t8403";
		/// <summary>
		/// 주식선물호가조회(API용)(t8403)
		/// </summary>
		static readonly string _typeDesc = "주식선물호가조회(API용)(t8403)";
		/// <summary>
		/// 
		/// </summary>
