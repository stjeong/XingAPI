...
namespace XingAPINet
{
	public partial class XQt1305InBlock : XingBlock
	{
		...
		/// t1305InBlock
		/// </summary>
		public const string _blockName = "t1305InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 일주월구분
		/// </summary>
		[XAQueryFieldAttribute("dwmcode", "일주월구분", "long", "1")]
		public long dwmcode;
		/// <summary>
		/// 날짜
		/// </summary>
		...
		/// 건수
		/// </summary>
		[XAQueryFieldAttribute("cnt", "건수", "long", "4")]
		public long cnt;
	...
	public partial class XQt1305OutBlock : XingBlock
	{
		...
		/// t1305OutBlock
		/// </summary>
		public const string _blockName = "t1305OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt1305OutBlock1 : XingBlock
	{
		...
		/// t1305OutBlock1
		/// </summary>
		public const string _blockName = "t1305OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 체결강도
		/// </summary>
		[XAQueryFieldAttribute("chdegree", "체결강도", "float", "6.2")]
		...
		/// 회전율
		/// </summary>
		[XAQueryFieldAttribute("changerate", "회전율", "float", "6.2")]
		public float changerate;
		/// <summary>
		/// 외인순매수
		/// </summary>
		[XAQueryFieldAttribute("fpvolume", "외인순매수", "long", "12")]
		public long fpvolume;
		/// <summary>
		/// 기관순매수
		/// </summary>
		[XAQueryFieldAttribute("covolume", "기관순매수", "long", "12")]
		...
		/// 누적거래대금(단위:백만)
		/// </summary>
		[XAQueryFieldAttribute("value", "누적거래대금(단위:백만)", "long", "12")]
		public long value;
		/// <summary>
		/// 개인순매수
		/// </summary>
		[XAQueryFieldAttribute("ppvolume", "개인순매수", "long", "12")]
		public long ppvolume;
		/// <summary>
		/// 시가대비구분
		/// </summary>
		[XAQueryFieldAttribute("o_sign", "시가대비구분", "char", "1")]
		public char o_sign;
		/// <summary>
		/// 시가대비
		/// </summary>
		[XAQueryFieldAttribute("o_change", "시가대비", "long", "8")]
		public long o_change;
		/// <summary>
		/// 시가기준등락율
		/// </summary>
		[XAQueryFieldAttribute("o_diff", "시가기준등락율", "float", "6.2")]
		public float o_diff;
		/// <summary>
		/// 고가대비구분
		/// </summary>
		[XAQueryFieldAttribute("h_sign", "고가대비구분", "char", "1")]
		public char h_sign;
		/// <summary>
		/// 고가대비
		/// </summary>
		[XAQueryFieldAttribute("h_change", "고가대비", "long", "8")]
		public long h_change;
		/// <summary>
		/// 고가기준등락율
		/// </summary>
		[XAQueryFieldAttribute("h_diff", "고가기준등락율", "float", "6.2")]
		public float h_diff;
		/// <summary>
		/// 저가대비구분
		/// </summary>
		[XAQueryFieldAttribute("l_sign", "저가대비구분", "char", "1")]
		public char l_sign;
		/// <summary>
		/// 저가대비
		/// </summary>
		[XAQueryFieldAttribute("l_change", "저가대비", "long", "8")]
		public long l_change;
		/// <summary>
		/// 저가기준등락율
		/// </summary>
		[XAQueryFieldAttribute("l_diff", "저가기준등락율", "float", "6.2")]
		public float l_diff;
		/// <summary>
		/// 시가총액(단위:백만)
		/// </summary>
		[XAQueryFieldAttribute("marketcap", "시가총액(단위:백만)", "long", "12")]
	...
	public partial class XQt1305 : XingQuery
	{
		...
		/// t1305
		/// </summary>
		public const string _typeName = "t1305";
		/// <summary>
		/// 기간별주가(t1305)
		/// </summary>
		public const string _typeDesc = "기간별주가(t1305)";
		/// <summary>
		/// 
		/// </summary>
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,long dwmcode = default,string date = default,long idx = default,long cnt = default */)
		{
			using (XQt1305 instance = new XQt1305())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1305OutBlock" : $"XQt1305OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1305OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1305OutBlock1" : $"XQt1305OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1305OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1305OutBlock),
			typeof(XQt1305OutBlock1),
