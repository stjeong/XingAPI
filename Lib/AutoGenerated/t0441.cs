...
namespace XingAPINet
{
	public partial class XQt0441InBlock : XingBlock
	{
		...
		/// CTS_종목번호
		/// </summary>
		[XAQueryFieldAttribute("cts_expcode", "CTS_종목번호", "char", "8")]
		public string cts_expcode;
		/// <summary>
		/// CTS_매매구분
		/// </summary>
		[XAQueryFieldAttribute("cts_medocd", "CTS_매매구분", "char", "1")]
	...
	public partial class XQt0441OutBlock : XingBlock
	{
		...
		/// 매매손익합계
		/// </summary>
		[XAQueryFieldAttribute("tdtsunik", "매매손익합계", "long", "18")]
		...
		/// 평가손익
		/// </summary>
		[XAQueryFieldAttribute("tsunik", "평가손익", "long", "18")]
		public long tsunik;
	...
	public partial class XQt0441OutBlock1 : XingBlock
	{
		...
		/// 구분
		/// </summary>
		[XAQueryFieldAttribute("medosu", "구분", "char", "4")]
		public string medosu;
		/// <summary>
		/// 잔고수량
		/// </summary>
		[XAQueryFieldAttribute("jqty", "잔고수량", "long", "10")]
		public long jqty;
		/// <summary>
		/// 청산가능수량
		/// </summary>
		[XAQueryFieldAttribute("cqty", "청산가능수량", "long", "10")]
		public long cqty;
		/// <summary>
		/// 평균단가
		/// </summary>
		[XAQueryFieldAttribute("pamt", "평균단가", "float", "10.2")]
		public float pamt;
		/// <summary>
		/// 총매입금액
		/// </summary>
		[XAQueryFieldAttribute("mamt", "총매입금액", "long", "18")]
		public long mamt;
		/// <summary>
		/// 매매구분
		/// </summary>
		[XAQueryFieldAttribute("medocd", "매매구분", "char", "1")]
		public char medocd;
		/// <summary>
		/// 매매손익
		/// </summary>
		[XAQueryFieldAttribute("dtsunik", "매매손익", "long", "18")]
		public long dtsunik;
		/// <summary>
		/// 처리순번
		/// </summary>
		...
		/// 평가손익
		/// </summary>
		[XAQueryFieldAttribute("dtsunik1", "평가손익", "long", "18")]
	...
	public partial class XQt0441 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string accno = default,string passwd = default,string cts_expcode = default,char cts_medocd = default */)
		{
			using (XQt0441 instance = new XQt0441())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt0441OutBlock" : $"XQt0441OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt0441OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt0441OutBlock1" : $"XQt0441OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt0441OutBlock1>(qo);
				return results;
			}
		}
