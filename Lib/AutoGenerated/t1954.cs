...
namespace XingAPINet
{
	public partial class XQt1954InBlock : XingBlock
	{
		...
		/// t1954InBlock
		/// </summary>
		public const string _blockName = "t1954InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 건수
		/// </summary>
		[XAQueryFieldAttribute("cnt", "건수", "long", "3")]
		public long cnt;
	...
	public partial class XQt1954OutBlock : XingBlock
	{
		...
		/// t1954OutBlock
		/// </summary>
		public const string _blockName = "t1954OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		/// 기초자산구분
		/// </summary>
		[XAQueryFieldAttribute("bsjgubun", "기초자산구분", "char", "1")]
		public char bsjgubun;
		/// <summary>
		/// 기초자산코드(현물)
		/// </summary>
		[XAQueryFieldAttribute("bscode", "기초자산코드(현물)", "char", "6")]
		public string bscode;
		/// <summary>
		/// 기초자산코드(지수)
		/// </summary>
		[XAQueryFieldAttribute("bjcode", "기초자산코드(지수)", "char", "3")]
	...
	public partial class XQt1954OutBlock1 : XingBlock
	{
		...
		/// t1954OutBlock1
		/// </summary>
		public const string _blockName = "t1954OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 기초자산(현물)
		/// </summary>
		[XAQueryFieldAttribute("bsprice", "기초자산(현물)", "long", "8")]
		public long bsprice;
		/// <summary>
		/// 기초자산(지수)
		/// </summary>
		[XAQueryFieldAttribute("bjprice", "기초자산(지수)", "float", "8.2")]
		public float bjprice;
		/// <summary>
		/// 전일대비구분
		/// </summary>
		[XAQueryFieldAttribute("bsign", "전일대비구분", "char", "1")]
		public char bsign;
		/// <summary>
		/// 전일대비(현물)
		/// </summary>
		[XAQueryFieldAttribute("bschange", "전일대비(현물)", "long", "8")]
		public long bschange;
		/// <summary>
		/// 전일대비(지수)
		/// </summary>
		[XAQueryFieldAttribute("bjchange", "전일대비(지수)", "float", "8.2")]
		public float bjchange;
		/// <summary>
		/// 등락율
		/// </summary>
		[XAQueryFieldAttribute("bdiff", "등락율", "float", "6.2")]
		public float bdiff;
		/// <summary>
		/// 기초자산거래량
		/// </summary>
		...
		/// Moneyness
		/// </summary>
		[XAQueryFieldAttribute("mness", "Moneyness", "char", "1")]
		public char mness;
	...
	public partial class XQt1954 : XingQuery
	{
		...
		/// t1954
		/// </summary>
		public const string _typeName = "t1954";
		/// <summary>
		/// ELW일별주가(t1954)
		/// </summary>
		public const string _typeDesc = "ELW일별주가(t1954)";
		/// <summary>
		/// 
		/// </summary>
		...
		public static XQAllOutBlocks Get(string shcode = default,string date = default,long cnt = default)
		{
			...
			{
				instance.SetFieldData(XQt1954InBlock.BlockName, XQt1954InBlock.F.shcode, 0, shcode); // char 6
				instance.SetFieldData(XQt1954InBlock.BlockName, XQt1954InBlock.F.date, 0, date); // char 8
				instance.SetFieldData(XQt1954InBlock.BlockName, XQt1954InBlock.F.cnt, 0, cnt.ToString("d3")); // long 3
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,string date = default,long cnt = default */)
		{
			using (XQt1954 instance = new XQt1954())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1954OutBlock" : $"XQt1954OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1954OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1954OutBlock1" : $"XQt1954OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1954OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt1954InBlock block)
		{
		...
		{
			typeof(XQt1954OutBlock),
			typeof(XQt1954OutBlock1),
