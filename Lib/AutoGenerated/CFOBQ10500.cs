...
{
	public partial class XQCFOBQ10500InBlock1 : XingBlock
	{
		/// <summary>
		/// CFOBQ10500InBlock1
		/// </summary>
		...
		public void CopyTo(XQCFOBQ10500InBlock1 block)
		{
	...
	public partial class XQCFOBQ10500OutBlock1 : XingBlock
	{
		/// <summary>
		/// CFOBQ10500OutBlock1
		/// </summary>
		...
		public static XQCFOBQ10500OutBlock1 FromQuery(XQCFOBQ10500 query)
		{
			XQCFOBQ10500OutBlock1 block = new XQCFOBQ10500OutBlock1();
		...
		public void CopyTo(XQCFOBQ10500OutBlock1 block)
		{
			block.RecCnt = this.RecCnt;
			block.AcntNo = this.AcntNo;
			block.Pwd = this.Pwd;
	...
	public partial class XQCFOBQ10500OutBlock2 : XingBlock
	{
		/// <summary>
		/// CFOBQ10500OutBlock2
		/// </summary>
		...
		/// 충당예탁금총액
		/// </summary>
		[XAQueryFieldAttribute("FilupDpsamtTotamt", "충당예탁금총액", "long", "16")]
		public long FilupDpsamtTotamt;
		/// <summary>
		/// 충당예수금
		/// </summary>
		[XAQueryFieldAttribute("FilupDps", "충당예수금", "long", "16")]
		public long FilupDps;
		/// <summary>
		/// 선물손익금액
		/// </summary>
		[XAQueryFieldAttribute("FutsPnlAmt", "선물손익금액", "long", "16")]
		public long FutsPnlAmt;
		/// <summary>
		/// 인출가능금액
		/// </summary>
		[XAQueryFieldAttribute("WthdwAbleAmt", "인출가능금액", "long", "16")]
		...
		/// 인출가능대용금액
		/// </summary>
		[XAQueryFieldAttribute("PsnOutAbleSubstAmt", "인출가능대용금액", "long", "16")]
		public long PsnOutAbleSubstAmt;
		/// <summary>
		/// 증거금액
		/// </summary>
		[XAQueryFieldAttribute("Mgn", "증거금액", "long", "16")]
		public long Mgn;
		/// <summary>
		/// 현금증거금액
		/// </summary>
		...
		/// 금전일수표입금액
		/// </summary>
		[XAQueryFieldAttribute("AmtPrdayChckInAmt", "금전일수표입금액", "long", "16")]
		public long AmtPrdayChckInAmt;
		/// <summary>
		/// 선물옵션전일대용매도금액
		/// </summary>
		[XAQueryFieldAttribute("FnoPrdaySubstSellAmt", "선물옵션전일대용매도금액", "long", "16")]
		public long FnoPrdaySubstSellAmt;
		/// <summary>
		/// 선물옵션금일대용매도금액
		/// </summary>
		[XAQueryFieldAttribute("FnoCrdaySubstSellAmt", "선물옵션금일대용매도금액", "long", "16")]
		public long FnoCrdaySubstSellAmt;
		/// <summary>
		/// 선물옵션전일가입금액
		/// </summary>
		[XAQueryFieldAttribute("FnoPrdayFdamt", "선물옵션전일가입금액", "long", "16")]
		public long FnoPrdayFdamt;
		/// <summary>
		/// 선물옵션금일가입금액
		/// </summary>
		[XAQueryFieldAttribute("FnoCrdayFdamt", "선물옵션금일가입금액", "long", "16")]
		public long FnoCrdayFdamt;
		/// <summary>
		/// 외화대용금액
		/// </summary>
		[XAQueryFieldAttribute("FcurrSubstAmt", "외화대용금액", "long", "16")]
		public long FcurrSubstAmt;
		/// <summary>
		/// 선물옵션계좌사후증거금명
		/// </summary>
		[XAQueryFieldAttribute("FnoAcntAfmgnNm", "선물옵션계좌사후증거금명", "char", "20")]
		...
		public static XQCFOBQ10500OutBlock2 FromQuery(XQCFOBQ10500 query)
		{
			XQCFOBQ10500OutBlock2 block = new XQCFOBQ10500OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
		...
		public void CopyTo(XQCFOBQ10500OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
	...
	public partial class XQCFOBQ10500OutBlock3 : XingBlock
	{
		/// <summary>
		/// CFOBQ10500OutBlock3
		/// </summary>
		...
		/// 상품군코드명
		/// </summary>
		[XAQueryFieldAttribute("PdGrpCodeNm", "상품군코드명", "char", "20")]
		public string PdGrpCodeNm;
		/// <summary>
		/// 순위험증거금액
		/// </summary>
		[XAQueryFieldAttribute("NetRiskMgn", "순위험증거금액", "long", "16")]
		public long NetRiskMgn;
		/// <summary>
		/// 가격증거금액
		/// </summary>
		[XAQueryFieldAttribute("PrcMgn", "가격증거금액", "long", "16")]
		public long PrcMgn;
		/// <summary>
		/// 스프레드증거금액
		/// </summary>
		[XAQueryFieldAttribute("SprdMgn", "스프레드증거금액", "long", "16")]
		public long SprdMgn;
		/// <summary>
		/// 가격변동증거금액
		/// </summary>
		[XAQueryFieldAttribute("PrcFlctMgn", "가격변동증거금액", "long", "16")]
		public long PrcFlctMgn;
		/// <summary>
		/// 최소증거금액
		/// </summary>
		[XAQueryFieldAttribute("MinMgn", "최소증거금액", "long", "16")]
		public long MinMgn;
		/// <summary>
		/// 주문증거금액
		/// </summary>
		[XAQueryFieldAttribute("OrdMgn", "주문증거금액", "long", "16")]
		public long OrdMgn;
		/// <summary>
		/// 옵션순매수금액
		/// </summary>
		[XAQueryFieldAttribute("OptNetBuyAmt", "옵션순매수금액", "long", "16")]
		...
		/// 선물매수체결금액
		/// </summary>
		[XAQueryFieldAttribute("FutsBuyExecAmt", "선물매수체결금액", "long", "16")]
		public long FutsBuyExecAmt;
		/// <summary>
		/// 선물매도체결금액
		/// </summary>
		[XAQueryFieldAttribute("FutsSellExecAmt", "선물매도체결금액", "long", "16")]
		public long FutsSellExecAmt;
		/// <summary>
		/// 옵션매수체결금액
		/// </summary>
		[XAQueryFieldAttribute("OptBuyExecAmt", "옵션매수체결금액", "long", "16")]
		public long OptBuyExecAmt;
		/// <summary>
		/// 옵션매도체결금액
		/// </summary>
		[XAQueryFieldAttribute("OptSellExecAmt", "옵션매도체결금액", "long", "16")]
		...
		/// 총위험위탁증거금
		/// </summary>
		[XAQueryFieldAttribute("TotRiskCsgnMgn", "총위험위탁증거금", "long", "16")]
		public long TotRiskCsgnMgn;
		/// <summary>
		/// 인수도위탁증거금
		/// </summary>
		[XAQueryFieldAttribute("UndCsgnMgn", "인수도위탁증거금", "long", "16")]
		public long UndCsgnMgn;
		/// <summary>
		/// 증거금감면금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRdctAmt", "증거금감면금액", "long", "16")]
		...
		public static XQCFOBQ10500OutBlock3[] ListFromQuery(XQCFOBQ10500 query)
		{
			int count = query.GetBlockCount(XQCFOBQ10500OutBlock3.BlockName);
			List<XQCFOBQ10500OutBlock3> list = new List<XQCFOBQ10500OutBlock3>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQCFOBQ10500OutBlock3 block = new XQCFOBQ10500OutBlock3();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
		...
		public void CopyTo(XQCFOBQ10500OutBlock3 block)
		{
	...
	public partial class XQCFOBQ10500 : XingQuery
	{
		...
		public bool SetBlock(XQCFOBQ10500InBlock1 block)
		{
		...
		public XQCFOBQ10500OutBlock1 GetBlock1()
		{
			XQCFOBQ10500OutBlock1 instance = XQCFOBQ10500OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCFOBQ10500OutBlock2 GetBlock2()
		{
			XQCFOBQ10500OutBlock2 instance = XQCFOBQ10500OutBlock2.FromQuery(this);
			return instance;

		}

		public XQCFOBQ10500OutBlock3[] GetBlock3s()
		{
			XQCFOBQ10500OutBlock3[] instance = XQCFOBQ10500OutBlock3.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQCFOBQ10500OutBlock1),
			typeof(XQCFOBQ10500OutBlock2),
			typeof(XQCFOBQ10500OutBlock3),
