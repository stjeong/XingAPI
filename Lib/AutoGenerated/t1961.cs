...
namespace XingAPINet
{
	...
	public partial class XQt1961OutBlock1 : XingBlock
	{
		...
		/// 전일거래량
		/// </summary>
		[XAQueryFieldAttribute("jnilvolume", "전일거래량", "double", "12.0")]
	...
	public partial class XQt1961 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,string ggubun = default,string itemcode = default,string lastdate = default,string exgubun = default,long sprice = default,long eprice = default,long volume = default,long sjanday = default,long ejanday = default,long idx = default */)
		{
			using (XQt1961 instance = new XQt1961())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1961OutBlock" : $"XQt1961OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1961OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1961OutBlock1" : $"XQt1961OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1961OutBlock1>(qo);
				return results;
			}
		}
