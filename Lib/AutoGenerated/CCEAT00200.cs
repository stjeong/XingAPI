...
{
	public partial class XQCCEAT00200InBlock1 : XingBlock
	{
		/// <summary>
		/// CCEAT00200InBlock1
		/// </summary>
		...
		public void CopyTo(XQCCEAT00200InBlock1 block)
		{
	...
	public partial class XQCCEAT00200OutBlock1 : XingBlock
	{
		/// <summary>
		/// CCEAT00200OutBlock1
		/// </summary>
		...
		public static XQCCEAT00200OutBlock1 FromQuery(XQCCEAT00200 query)
		{
			XQCCEAT00200OutBlock1 block = new XQCCEAT00200OutBlock1();
		...
		public void CopyTo(XQCCEAT00200OutBlock1 block)
		{
	...
	public partial class XQCCEAT00200OutBlock2 : XingBlock
	{
		/// <summary>
		/// CCEAT00200OutBlock2
		/// </summary>
		...
		public static XQCCEAT00200OutBlock2 FromQuery(XQCCEAT00200 query)
		{
			XQCCEAT00200OutBlock2 block = new XQCCEAT00200OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
		...
		public void CopyTo(XQCCEAT00200OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
	...
	/// CME 정정주문
	/// </summary>
	public partial class XQCCEAT00200 : XingQuery
	{
		/// <summary>
		/// CCEAT00200
		/// </summary>
		...
		public XQCCEAT00200OutBlock1 GetBlock1()
		{
			XQCCEAT00200OutBlock1 instance = XQCCEAT00200OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCCEAT00200OutBlock2 GetBlock2()
		{
			XQCCEAT00200OutBlock2 instance = XQCCEAT00200OutBlock2.FromQuery(this);
			return instance;
		...
		{
			typeof(XQCCEAT00200OutBlock1),
			typeof(XQCCEAT00200OutBlock2),
