...
namespace XingAPINet
{
	public partial class XQt2830InBlock : XingBlock
	{
		...
		/// t2830InBlock
		/// </summary>
		static readonly string _blockName = "t2830InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt2830OutBlock : XingBlock
	{
		...
		/// t2830OutBlock
		/// </summary>
		static readonly string _blockName = "t2830OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt2830 : XingQuery
	{
		...
		/// t2830
		/// </summary>
		static readonly string _typeName = "t2830";
		/// <summary>
		/// EUREXKOSPI200옵션선물현재가(시세)조회(t2830)
		/// </summary>
		static readonly string _typeDesc = "EUREXKOSPI200옵션선물현재가(시세)조회(t2830)";
		/// <summary>
		/// 
		/// </summary>
