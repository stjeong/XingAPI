...
namespace XingAPINet
{
	public partial class XQt2833InBlock : XingBlock
	{
		...
		public void CopyTo(XQt2833InBlock block)
		{
	...
	public partial class XQt2833OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt2833OutBlock block)
		{
			block.date = this.date;
			block.cts_code = this.cts_code;
			block.lastdate = this.lastdate;
	...
	public partial class XQt2833OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQt2833OutBlock1 block)
		{
			block.date = this.date;
	...
	public partial class XQt2833 : XingQuery
	{
		...
		{
			public XQt2833OutBlock OutBlock { get; internal set; }
			public XQt2833OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,char futcheck = default,string date = default,string cts_code = default,string lastdate = default,int cnt = default */)
		{
			using (XQt2833 instance = new XQt2833())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt2833OutBlock" : $"XQt2833OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt2833OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt2833OutBlock1" : $"XQt2833OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt2833OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt2833OutBlock),
			typeof(XQt2833OutBlock1),
