...
namespace XingAPINet
{
	public partial class XQt1826InBlock : XingBlock
	{
		...
		/// t1826InBlock
		/// </summary>
		static readonly string _blockName = "t1826InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// </summary>
		[XAQueryFieldAttribute("검색구분(0:핵심검색1:지표검색2:시세동향3:투자자동향)")]
	...
	public partial class XQt1826OutBlock : XingBlock
	{
		...
		/// t1826OutBlock
		/// </summary>
		static readonly string _blockName = "t1826OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt1826 : XingQuery
	{
		...
		/// t1826
		/// </summary>
		static readonly string _typeName = "t1826";
		/// <summary>
		/// 종목Q클릭검색리스트조회(씽큐스마트)(t1826)
		/// </summary>
		static readonly string _typeDesc = "종목Q클릭검색리스트조회(씽큐스마트)(t1826)";
		/// <summary>
		/// 
		/// </summary>
