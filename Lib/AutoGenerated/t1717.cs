...
namespace XingAPINet
{
	public partial class XQt1717InBlock : XingBlock
	{
		...
		/// t1717InBlock
		/// </summary>
		public const string _blockName = "t1717InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 구분(0:일간순매수1:기간누적순매수)
		/// </summary>
		[XAQueryFieldAttribute("gubun", "구분(0:일간순매수1:기간누적순매수)", "char", "1")]
		public char gubun;
		/// <summary>
		/// 시작일자(일간조회일경우는space)
		/// </summary>
		[XAQueryFieldAttribute("fromdt", "시작일자(일간조회일경우는space)", "char", "8")]
	...
	public partial class XQt1717OutBlock : XingBlock
	{
		...
		/// t1717OutBlock
		/// </summary>
		public const string _blockName = "t1717OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		/// 사모펀드(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0000_vol", "사모펀드(순매수량)", "long", "12")]
		public long tjj0000_vol;
		/// <summary>
		/// 증권(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0001_vol", "증권(순매수량)", "long", "12")]
		public long tjj0001_vol;
		/// <summary>
		/// 보험(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0002_vol", "보험(순매수량)", "long", "12")]
		public long tjj0002_vol;
		/// <summary>
		/// 투신(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0003_vol", "투신(순매수량)", "long", "12")]
		public long tjj0003_vol;
		/// <summary>
		/// 은행(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0004_vol", "은행(순매수량)", "long", "12")]
		public long tjj0004_vol;
		/// <summary>
		/// 종금(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0005_vol", "종금(순매수량)", "long", "12")]
		public long tjj0005_vol;
		/// <summary>
		/// 기금(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0006_vol", "기금(순매수량)", "long", "12")]
		public long tjj0006_vol;
		/// <summary>
		/// 기타법인(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0007_vol", "기타법인(순매수량)", "long", "12")]
		public long tjj0007_vol;
		/// <summary>
		/// 개인(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0008_vol", "개인(순매수량)", "long", "12")]
		public long tjj0008_vol;
		/// <summary>
		/// 등록외국인(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0009_vol", "등록외국인(순매수량)", "long", "12")]
		public long tjj0009_vol;
		/// <summary>
		/// 미등록외국인(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0010_vol", "미등록외국인(순매수량)", "long", "12")]
		public long tjj0010_vol;
		/// <summary>
		/// 국가외(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0011_vol", "국가외(순매수량)", "long", "12")]
		public long tjj0011_vol;
		/// <summary>
		/// 기관(순매수량)
		/// </summary>
		[XAQueryFieldAttribute("tjj0018_vol", "기관(순매수량)", "long", "12")]
		public long tjj0018_vol;
		/// <summary>
		/// 외인계(순매수량)(등록+미등록)
		/// </summary>
		[XAQueryFieldAttribute("tjj0016_vol", "외인계(순매수량)(등록+미등록)", "long", "12")]
		public long tjj0016_vol;
		/// <summary>
		/// 기타계(순매수량)(기타+국가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0017_vol", "기타계(순매수량)(기타+국가)", "long", "12")]
		public long tjj0017_vol;
		/// <summary>
		/// 사모펀드(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0000_dan", "사모펀드(단가)", "long", "12")]
		public long tjj0000_dan;
		/// <summary>
		/// 증권(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0001_dan", "증권(단가)", "long", "12")]
		public long tjj0001_dan;
		/// <summary>
		/// 보험(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0002_dan", "보험(단가)", "long", "12")]
		public long tjj0002_dan;
		/// <summary>
		/// 투신(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0003_dan", "투신(단가)", "long", "12")]
		public long tjj0003_dan;
		/// <summary>
		/// 은행(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0004_dan", "은행(단가)", "long", "12")]
		public long tjj0004_dan;
		/// <summary>
		/// 종금(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0005_dan", "종금(단가)", "long", "12")]
		public long tjj0005_dan;
		/// <summary>
		/// 기금(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0006_dan", "기금(단가)", "long", "12")]
		public long tjj0006_dan;
		/// <summary>
		/// 기타법인(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0007_dan", "기타법인(단가)", "long", "12")]
		public long tjj0007_dan;
		/// <summary>
		/// 개인(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0008_dan", "개인(단가)", "long", "12")]
		public long tjj0008_dan;
		/// <summary>
		/// 등록외국인(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0009_dan", "등록외국인(단가)", "long", "12")]
		public long tjj0009_dan;
		/// <summary>
		/// 미등록외국인(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0010_dan", "미등록외국인(단가)", "long", "12")]
		public long tjj0010_dan;
		/// <summary>
		/// 국가외(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0011_dan", "국가외(단가)", "long", "12")]
		public long tjj0011_dan;
		/// <summary>
		/// 기관(단가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0018_dan", "기관(단가)", "long", "12")]
		public long tjj0018_dan;
		/// <summary>
		/// 외인계(단가)(등록+미등록)
		/// </summary>
		[XAQueryFieldAttribute("tjj0016_dan", "외인계(단가)(등록+미등록)", "long", "12")]
		public long tjj0016_dan;
		/// <summary>
		/// 기타계(단가)(기타+국가)
		/// </summary>
		[XAQueryFieldAttribute("tjj0017_dan", "기타계(단가)(기타+국가)", "long", "12")]
	...
	public partial class XQt1717 : XingQuery
	{
		...
		/// t1717
		/// </summary>
		public const string _typeName = "t1717";
		/// <summary>
		/// 외인기관종목별동향(t1717)
		/// </summary>
		public const string _typeDesc = "외인기관종목별동향(t1717)";
		/// <summary>
		/// 
		/// </summary>
