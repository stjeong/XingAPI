...
{
	public partial class XRh3_InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRh3_OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		/// 매도호가잔량1
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량1")]
		public long offerrem1;
		/// <summary>
		/// 매수호가잔량1
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량1")]
		public long bidrem1;
		/// <summary>
		/// LP매도호가수량1
		/// </summary>
		...
		/// 매도호가잔량2
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량2")]
		public long offerrem2;
		/// <summary>
		/// 매수호가잔량2
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량2")]
		public long bidrem2;
		/// <summary>
		/// LP매도호가수량2
		/// </summary>
		...
		/// 매도호가잔량3
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량3")]
		public long offerrem3;
		/// <summary>
		/// 매수호가잔량3
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량3")]
		public long bidrem3;
		/// <summary>
		/// LP매도호가수량3
		/// </summary>
		...
		/// 매도호가잔량4
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량4")]
		public long offerrem4;
		/// <summary>
		/// 매수호가잔량4
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량4")]
		public long bidrem4;
		/// <summary>
		/// LP매도호가수량4
		/// </summary>
		...
		/// 매도호가잔량5
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량5")]
		public long offerrem5;
		/// <summary>
		/// 매수호가잔량5
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량5")]
		public long bidrem5;
		/// <summary>
		/// LP매도호가수량5
		/// </summary>
		...
		/// 매도호가잔량6
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량6")]
		public long offerrem6;
		/// <summary>
		/// 매수호가잔량6
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량6")]
		public long bidrem6;
		/// <summary>
		/// LP매도호가수량6
		/// </summary>
		...
		/// 매도호가잔량7
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량7")]
		public long offerrem7;
		/// <summary>
		/// 매수호가잔량7
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량7")]
		public long bidrem7;
		/// <summary>
		/// LP매도호가수량7
		/// </summary>
		...
		/// 매도호가잔량8
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량8")]
		public long offerrem8;
		/// <summary>
		/// 매수호가잔량8
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량8")]
		public long bidrem8;
		/// <summary>
		/// LP매도호가수량8
		/// </summary>
		...
		/// 매도호가잔량9
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량9")]
		public long offerrem9;
		/// <summary>
		/// 매수호가잔량9
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량9")]
		public long bidrem9;
		/// <summary>
		/// LP매도호가수량9
		/// </summary>
		...
		/// 매도호가잔량10
		/// </summary>
		[XAQueryFieldAttribute("매도호가잔량10")]
		public long offerrem10;
		/// <summary>
		/// 매수호가잔량10
		/// </summary>
		[XAQueryFieldAttribute("매수호가잔량10")]
		...
		/// 총매도호가잔량
		/// </summary>
		[XAQueryFieldAttribute("총매도호가잔량")]
		public long totofferrem;
		/// <summary>
		/// 총매수호가잔량
		/// </summary>
		[XAQueryFieldAttribute("총매수호가잔량")]
		public long totbidrem;
		/// <summary>
		/// 동시호가구분
		/// </summary>
		[XAQueryFieldAttribute("동시호가구분")]
		...
		public static XRh3_OutBlock FromQuery(XRh3_ query)
		{
			XRh3_OutBlock block = new XRh3_OutBlock();
			...
			try
			{
				...
				block.spread = query.GetFieldData(block.GetBlockName(), "spread").ParseFloat("spread"); // float 6.2
	...
	public partial class XRh3_ : XingReal
	{
		...
		/// h3_
		/// </summary>
		public const string _typeName = "h3_";
		/// <summary>
		/// ELW호가잔량(h3)
		/// </summary>
		public const string _typeDesc = "ELW호가잔량(h3)";
		/// <summary>
		/// false
		/// </summary>
		...
		public XRh3_OutBlock GetBlock()
		{
			XRh3_OutBlock instance = XRh3_OutBlock.FromQuery(this);
			return instance;
