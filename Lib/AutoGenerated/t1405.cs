...
namespace XingAPINet
{
	public partial class XQt1405InBlock : XingBlock
	{
		...
		/// 종목체크
		/// </summary>
		[XAQueryFieldAttribute("jongchk", "종목체크", "char", "1")]
		public char jongchk;
		/// <summary>
		/// 종목코드_CTS
		/// </summary>
		...
		public void CopyTo(XQt1405InBlock block)
		{
	...
	public partial class XQt1405OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1405OutBlock block)
		{
			block.cts_shcode = this.cts_shcode;
	...
	public partial class XQt1405OutBlock1 : XingBlock
	{
		...
		/// 지정일
		/// </summary>
		[XAQueryFieldAttribute("date", "지정일", "char", "8")]
		public string date;
		/// <summary>
		/// 해제일
		/// </summary>
		[XAQueryFieldAttribute("edate", "해제일", "char", "8")]
		public string edate;
		/// <summary>
		/// 종목코드
		/// </summary>
		...
		public void CopyTo(XQt1405OutBlock1 block)
		{
	...
	public partial class XQt1405 : XingQuery
	{
		...
		public static XQAllOutBlocks Get(char gubun = default,char jongchk = default,string cts_shcode = default)
		{
			...
			{
				instance.SetFieldData(XQt1405InBlock.BlockName, XQt1405InBlock.F.gubun, 0, gubun.ToString()); // char 1
				instance.SetFieldData(XQt1405InBlock.BlockName, XQt1405InBlock.F.jongchk, 0, jongchk.ToString()); // char 1
				instance.SetFieldData(XQt1405InBlock.BlockName, XQt1405InBlock.F.cts_shcode, 0, cts_shcode); // char 6
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,char jongchk = default,string cts_shcode = default */)
		{
			using (XQt1405 instance = new XQt1405())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1405OutBlock" : $"XQt1405OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1405OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1405OutBlock1" : $"XQt1405OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1405OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt1405InBlock block)
		{
