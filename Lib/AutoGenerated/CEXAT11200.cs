...
{
	public partial class XQCEXAT11200InBlock1 : XingBlock
	{
		/// <summary>
		/// CEXAT11200InBlock1
		/// </summary>
		...
		public void CopyTo(XQCEXAT11200InBlock1 block)
		{
	...
	public partial class XQCEXAT11200OutBlock1 : XingBlock
	{
		/// <summary>
		/// CEXAT11200OutBlock1
		/// </summary>
		...
		/// 매매구분코드
		/// </summary>
		[XAQueryFieldAttribute("BnsTpCode", "매매구분코드", "char", "1")]
		public char BnsTpCode;
		/// <summary>
		/// 유렉스가격조건구분코드
		/// </summary>
		[XAQueryFieldAttribute("ErxPrcCndiTpCode", "유렉스가격조건구분코드", "char", "1")]
		...
		/// 주문조건가격
		/// </summary>
		[XAQueryFieldAttribute("OrdCndiPrc", "주문조건가격", "double", "25.8")]
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["Pwd"] = new XAQueryFieldInfo("char", Pwd, Pwd, "비밀번호", (decimal)8);
			dict["FnoIsuNo"] = new XAQueryFieldInfo("char", FnoIsuNo, FnoIsuNo, "선물옵션종목번호", (decimal)12);
			dict["BnsTpCode"] = new XAQueryFieldInfo("char", BnsTpCode, BnsTpCode.ToString(), "매매구분코드", (decimal)1);
		...
		public static XQCEXAT11200OutBlock1 FromQuery(XQCEXAT11200 query)
		{
			XQCEXAT11200OutBlock1 block = new XQCEXAT11200OutBlock1();
		...
		public void CopyTo(XQCEXAT11200OutBlock1 block)
		{
	...
	public partial class XQCEXAT11200OutBlock2 : XingBlock
	{
		/// <summary>
		/// CEXAT11200OutBlock2
		/// </summary>
		...
		public static XQCEXAT11200OutBlock2 FromQuery(XQCEXAT11200 query)
		{
			XQCEXAT11200OutBlock2 block = new XQCEXAT11200OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
		...
		public void CopyTo(XQCEXAT11200OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
	...
	public partial class XQCEXAT11200 : XingQuery
	{
		...
		/// 유렉스 정정주문
		/// </summary>
		public XQCEXAT11200() : base("CEXAT11200") { }




		public bool SetBlock(XQCEXAT11200InBlock1 block)
		{
		...
		public XQCEXAT11200OutBlock1 GetBlock1()
		{
			XQCEXAT11200OutBlock1 instance = XQCEXAT11200OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCEXAT11200OutBlock2 GetBlock2()
		{
			XQCEXAT11200OutBlock2 instance = XQCEXAT11200OutBlock2.FromQuery(this);
			return instance;
		...
		{
			typeof(XQCEXAT11200OutBlock1),
			typeof(XQCEXAT11200OutBlock2),
