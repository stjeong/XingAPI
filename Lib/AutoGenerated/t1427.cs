...
namespace XingAPINet
{
	public partial class XQt1427InBlock : XingBlock
	{
		...
		/// 상하한가구분
		/// </summary>
		[XAQueryFieldAttribute("signgubun", "상하한가구분", "char", "1")]
		public char signgubun;
		/// <summary>
		/// 등락율
		/// </summary>
		[XAQueryFieldAttribute("diff", "등락율", "long", "3")]
		public long diff;
		/// <summary>
		/// 대상제외
		/// </summary>
		...
		/// 전일상하한제외
		/// </summary>
		[XAQueryFieldAttribute("jshex", "전일상하한제외", "char", "1")]
		public char jshex;
	...
	public partial class XQt1427OutBlock1 : XingBlock
	{
		...
		/// 상한가/하한가
		/// </summary>
		[XAQueryFieldAttribute("lmtprice", "상한가/하한가", "long", "8")]
		public long lmtprice;
		/// <summary>
		/// 대비율
		/// </summary>
		[XAQueryFieldAttribute("rate", "대비율", "float", "12.2")]
		public float rate;
		/// <summary>
		/// 종목코드
		/// </summary>
	...
	public partial class XQt1427 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char qrygb = default,char gubun = default,char signgubun = default,long diff = default,long jc_num = default,long sprice = default,long eprice = default,long volume = default,long idx = default,char jshex = default */)
		{
			using (XQt1427 instance = new XQt1427())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1427OutBlock" : $"XQt1427OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1427OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1427OutBlock1" : $"XQt1427OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1427OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1427OutBlock),
			typeof(XQt1427OutBlock1),
