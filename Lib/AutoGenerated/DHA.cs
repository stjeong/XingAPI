...
{
	public partial class XRDHAInBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
		...
		public void CopyTo(XRDHAInBlock block)
		{
	...
	public partial class XRDHAOutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		public static XRDHAOutBlock FromQuery(XRDHA query)
		{
			XRDHAOutBlock block = new XRDHAOutBlock();
		...
		public void CopyTo(XRDHAOutBlock block)
		{
	...
	/// </summary>
	public partial class XRDHA : XingReal
	{
		/// <summary>
		/// DHA
		/// </summary>
		public const string _typeName = "DHA";
		/// <summary>
		/// KOSDAQ시간외단일가호가잔량(DHA)
		/// </summary>
		public const string _typeDesc = "KOSDAQ시간외단일가호가잔량(DHA)";
		/// <summary>
		/// false
		/// </summary>
		...
		/// KOSDAQ시간외단일가호가잔량(DHA)
		/// </summary>
		public XRDHA() : base("DHA") { }


		public bool SetBlock(XRDHAInBlock block)
		{
		...
		public XRDHAOutBlock GetBlock()
		{
			XRDHAOutBlock instance = XRDHAOutBlock.FromQuery(this);
			return instance;
