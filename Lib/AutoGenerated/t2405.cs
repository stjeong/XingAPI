...
namespace XingAPINet
{
	public partial class XQt2405InBlock : XingBlock
	{
		...
		/// t2405InBlock
		/// </summary>
		static readonly string _blockName = "t2405InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt2405OutBlock : XingBlock
	{
		...
		/// t2405OutBlock
		/// </summary>
		static readonly string _blockName = "t2405OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt2405OutBlock1 : XingBlock
	{
		...
		/// t2405OutBlock1
		/// </summary>
		static readonly string _blockName = "t2405OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 매도1호가
		/// </summary>
		[XAQueryFieldAttribute("매도1호가")]
		public float offerho1;
		/// <summary>
		/// 매수1호가
		/// </summary>
		[XAQueryFieldAttribute("매수1호가")]
		public float bidho1;
		/// <summary>
		/// 매도수량
		/// </summary>
		...
		/// 매도건수
		/// </summary>
		[XAQueryFieldAttribute("매도건수")]
		public long offercnt;
		/// <summary>
		/// 매수건수
		/// </summary>
		[XAQueryFieldAttribute("매수건수")]
		public long bidcnt;
		/// <summary>
		/// 매도증감수량
		/// </summary>
		[XAQueryFieldAttribute("매도증감수량")]
		public long c_offerrem;
		/// <summary>
		/// 매수증감수량
		/// </summary>
		[XAQueryFieldAttribute("매수증감수량")]
		public long c_bidrem;
		/// <summary>
		/// 매도증감건수
		/// </summary>
		[XAQueryFieldAttribute("매도증감건수")]
		public long c_offercnt;
		/// <summary>
		/// 매수증감건수
		/// </summary>
		[XAQueryFieldAttribute("매수증감건수")]
		public long c_bidcnt;
		/// <summary>
		/// 매수수량비율
		/// </summary>
		[XAQueryFieldAttribute("매수수량비율")]
		public float r_bidrem;
		/// <summary>
		/// 매수건수비율
		/// </summary>
		[XAQueryFieldAttribute("매수건수비율")]
		public float r_bidcnt;
		/// <summary>
		/// 매수비율구분
		/// </summary>
		[XAQueryFieldAttribute("매수비율구분")]
		public char r_sign;
		/// <summary>
		/// 일자
		/// </summary>
	...
	public partial class XQt2405 : XingQuery
	{
		...
		/// t2405
		/// </summary>
		static readonly string _typeName = "t2405";
		/// <summary>
		/// 선물옵션호가잔량비율챠트(t2405)
		/// </summary>
		static readonly string _typeDesc = "선물옵션호가잔량비율챠트(t2405)";
		/// <summary>
		/// 
		/// </summary>
