...
namespace XingAPINet
{
	public partial class XQt2105InBlock : XingBlock
	{
		...
		public void CopyTo(XQt2105InBlock block)
		{
	...
	public partial class XQt2105OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt2105OutBlock block)
		{
	...
	public partial class XQt2105 : XingQuery
	{
		...
		public static XQt2105OutBlock ReadFromDB(string tableNamePostfix = null /*, string shcode = default */)
		{
			using (XQt2105 instance = new XQt2105())
			{

				string tableName = (tableNamePostfix == null) ? "XQt2105OutBlock" : $"XQt2105OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (shcode != default) qo.Add("shcode", shcode);


				var outBlock = instance.Select<XQt2105OutBlock>(qo);
				return outBlock;
			}
		}
