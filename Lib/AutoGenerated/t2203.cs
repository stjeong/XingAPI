...
namespace XingAPINet
{
	public partial class XQt2203InBlock : XingBlock
	{
		...
		/// t2203InBlock
		/// </summary>
		public const string _blockName = "t2203InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		public void CopyTo(XQt2203InBlock block)
		{
	...
	public partial class XQt2203OutBlock : XingBlock
	{
		...
		/// t2203OutBlock
		/// </summary>
		public const string _blockName = "t2203OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public void CopyTo(XQt2203OutBlock block)
		{
			block.date = this.date;
			block.cts_code = this.cts_code;
			block.lastdate = this.lastdate;
	...
	public partial class XQt2203OutBlock1 : XingBlock
	{
		...
		/// t2203OutBlock1
		/// </summary>
		public const string _blockName = "t2203OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		public void CopyTo(XQt2203OutBlock1 block)
		{
			block.date = this.date;
	...
	public partial class XQt2203 : XingQuery
	{
		...
		/// t2203
		/// </summary>
		public const string _typeName = "t2203";
		/// <summary>
		/// 기간별주가(t2203)
		/// </summary>
		public const string _typeDesc = "기간별주가(t2203)";
		/// <summary>
		/// 
		/// </summary>
		...
		{
			public XQt2203OutBlock OutBlock { get; internal set; }
			public XQt2203OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt2203 instance = new XQt2203())
			{
				instance.SetFieldData(XQt2203InBlock.BlockName, XQt2203InBlock.F.shcode, 0, shcode); // char 8
				instance.SetFieldData(XQt2203InBlock.BlockName, XQt2203InBlock.F.futcheck, 0, futcheck.ToString()); // char 1
				instance.SetFieldData(XQt2203InBlock.BlockName, XQt2203InBlock.F.date, 0, date); // char 8
				instance.SetFieldData(XQt2203InBlock.BlockName, XQt2203InBlock.F.cts_code, 0, cts_code); // char 8
				instance.SetFieldData(XQt2203InBlock.BlockName, XQt2203InBlock.F.lastdate, 0, lastdate); // char 8
				instance.SetFieldData(XQt2203InBlock.BlockName, XQt2203InBlock.F.cnt, 0, cnt.ToString("d3")); // int 3
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,char futcheck = default,string date = default,string cts_code = default,string lastdate = default,int cnt = default */)
		{
			using (XQt2203 instance = new XQt2203())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt2203OutBlock" : $"XQt2203OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt2203OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt2203OutBlock1" : $"XQt2203OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt2203OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt2203InBlock block)
		{
		...
		{
			typeof(XQt2203OutBlock),
			typeof(XQt2203OutBlock1),
