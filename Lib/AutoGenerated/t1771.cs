...
namespace XingAPINet
{
	public partial class XQt1771InBlock : XingBlock
	{
		...
		/// 거래원코드
		/// </summary>
		[XAQueryFieldAttribute("tradno", "거래원코드", "char", "3")]
		...
		/// 거래원날짜1
		/// </summary>
		[XAQueryFieldAttribute("traddate1", "거래원날짜1", "char", "8")]
		public string traddate1;
		/// <summary>
		/// 거래원날짜2
		/// </summary>
		[XAQueryFieldAttribute("traddate2", "거래원날짜2", "char", "8")]
		...
		/// 요청건수
		/// </summary>
		[XAQueryFieldAttribute("cnt", "요청건수", "int", "3")]
		public int cnt;
	...
	public partial class XQt1771OutBlock2 : XingBlock
	{
		...
		/// 날짜
		/// </summary>
		[XAQueryFieldAttribute("traddate", "날짜", "char", "8")]
		public string traddate;
		/// <summary>
		/// 시간
		/// </summary>
		[XAQueryFieldAttribute("tradtime", "시간", "char", "8")]
		...
		/// 매도
		/// </summary>
		[XAQueryFieldAttribute("tradmdcha", "매도", "long", "12")]
		public long tradmdcha;
		/// <summary>
		/// 매수
		/// </summary>
		[XAQueryFieldAttribute("tradmscha", "매수", "long", "12")]
		public long tradmscha;
		/// <summary>
		/// 매도대금
		/// </summary>
		[XAQueryFieldAttribute("tradmdval", "매도대금", "long", "18")]
		public long tradmdval;
		/// <summary>
		/// 매수대금
		/// </summary>
		[XAQueryFieldAttribute("tradmsval", "매수대금", "long", "18")]
		public long tradmsval;
		/// <summary>
		/// 순매수
		/// </summary>
		[XAQueryFieldAttribute("tradmsscha", "순매수", "long", "12")]
		public long tradmsscha;
		/// <summary>
		/// 누적순매수
		/// </summary>
		[XAQueryFieldAttribute("tradmttvolume", "누적순매수", "long", "12")]
		public long tradmttvolume;
		/// <summary>
		/// 평균단가
		/// </summary>
		[XAQueryFieldAttribute("tradavg", "평균단가", "long", "8")]
		public long tradavg;
		/// <summary>
		/// 누적평균단가
		/// </summary>
		[XAQueryFieldAttribute("tradmttavg", "누적평균단가", "long", "8")]
	...
	public partial class XQt1771 : XingQuery
	{
		...
		{
			public XQt1771OutBlock OutBlock { get; internal set; }
			public XQt1771OutBlock2[] OutBlock2 { get; internal set; }
		}

		public static XQAllOutBlocks Get(string shcode = default,string tradno = default,char gubun1 = default,string traddate1 = default,string traddate2 = default,long cts_idx = default,int cnt = default)
		{
			using (XQt1771 instance = new XQt1771())
			{
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.shcode, 0, shcode); // char 6
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.tradno, 0, tradno); // char 3
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.gubun1, 0, gubun1.ToString()); // char 1
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.traddate1, 0, traddate1); // char 8
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.traddate2, 0, traddate2); // char 8
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.cts_idx, 0, cts_idx.ToString("d4")); // long 4
				instance.SetFieldData(XQt1771InBlock.BlockName, XQt1771InBlock.F.cnt, 0, cnt.ToString("d3")); // int 3
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,string tradno = default,char gubun1 = default,string traddate1 = default,string traddate2 = default,long cts_idx = default,int cnt = default */)
		{
			using (XQt1771 instance = new XQt1771())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1771OutBlock" : $"XQt1771OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1771OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1771OutBlock2" : $"XQt1771OutBlock2_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock2 = instance.SelectMany<XQt1771OutBlock2>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt1771InBlock block)
		{
		...
		{
			typeof(XQt1771OutBlock),
			typeof(XQt1771OutBlock2),
