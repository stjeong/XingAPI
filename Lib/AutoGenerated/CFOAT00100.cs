...
{
	public partial class XQCFOAT00100InBlock1 : XingBlock
	{
		/// <summary>
		/// CFOAT00100InBlock1
		/// </summary>
		public const string _blockName = "CFOAT00100InBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		...
		public void CopyTo(XQCFOAT00100InBlock1 block)
		{
	...
	public partial class XQCFOAT00100OutBlock1 : XingBlock
	{
		/// <summary>
		/// CFOAT00100OutBlock1
		/// </summary>
		public const string _blockName = "CFOAT00100OutBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		public const string _blockDesc = "In(*EMPTY*)";
		...
		public static XQCFOAT00100OutBlock1 FromQuery(XQCFOAT00100 query)
		{
			XQCFOAT00100OutBlock1 block = new XQCFOAT00100OutBlock1();
		...
		public void CopyTo(XQCFOAT00100OutBlock1 block)
		{
	...
	public partial class XQCFOAT00100OutBlock2 : XingBlock
	{
		/// <summary>
		/// CFOAT00100OutBlock2
		/// </summary>
		public const string _blockName = "CFOAT00100OutBlock2";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
		...
		public static XQCFOAT00100OutBlock2 FromQuery(XQCFOAT00100 query)
		{
			XQCFOAT00100OutBlock2 block = new XQCFOAT00100OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
		...
		public void CopyTo(XQCFOAT00100OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
	...
	public partial class XQCFOAT00100 : XingQuery
	{
		...
		/// CFOAT00100
		/// </summary>
		public const string _typeName = "CFOAT00100";
		/// <summary>
		/// 선물옵션 정상주문
		/// </summary>
		public const string _typeDesc = "선물옵션 정상주문";
		/// <summary>
		/// CFOAT00100
		/// </summary>
		public const string _service = "CFOAT00100";
		/// <summary>
		/// B
		/// </summary>
		...
		/// 2022/02/16 14:20:59
		/// </summary>
		public const string _createdDate = "2022/02/16 14:20:59";
		/// <summary>
		/// false
		/// </summary>
		...
		public bool SetBlock(XQCFOAT00100InBlock1 block)
		{
		...
		public XQCFOAT00100OutBlock1 GetBlock1()
		{
			XQCFOAT00100OutBlock1 instance = XQCFOAT00100OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCFOAT00100OutBlock2 GetBlock2()
		{
			XQCFOAT00100OutBlock2 instance = XQCFOAT00100OutBlock2.FromQuery(this);
			return instance;
		...
		{
			typeof(XQCFOAT00100OutBlock1),
			typeof(XQCFOAT00100OutBlock2),
