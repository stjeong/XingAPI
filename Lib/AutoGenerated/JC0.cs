...
namespace XingAPINet
{
	...
	public partial class XRJC0OutBlock : XingBlock
	{
		...
		/// 대비기호
		/// </summary>
		[XAQueryFieldAttribute("대비기호", "1")]
		public char sign;
		/// <summary>
		/// 전일대비
		/// </summary>
		[XAQueryFieldAttribute("전일대비", "10")]
		public long change;
		/// <summary>
		/// 등락율
		/// </summary>
		...
		/// 누적거래대금
		/// </summary>
		[XAQueryFieldAttribute("누적거래대금", "15")]
		public long value;
		/// <summary>
		/// 매도누적체결량
		/// </summary>
		...
		/// 시장BASIS
		/// </summary>
		[XAQueryFieldAttribute("시장BASIS", "6")]
		public long sbasis;
		/// <summary>
		/// 이론BASIS
		/// </summary>
		[XAQueryFieldAttribute("이론BASIS", "6")]
		public long ibasis;
		/// <summary>
		/// 미결제약정증감
		/// </summary>
