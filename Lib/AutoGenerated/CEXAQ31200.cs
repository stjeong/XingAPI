...
{
	public partial class XQCEXAQ31200InBlock1 : XingBlock
	{
		/// <summary>
		/// CEXAQ31200InBlock1
		/// </summary>
		static readonly string _blockName = "CEXAQ31200InBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		...
		/// 선물가격평가구분
		/// </summary>
		[XAQueryFieldAttribute("선물가격평가구분")]
	...
	public partial class XQCEXAQ31200OutBlock1 : XingBlock
	{
		/// <summary>
		/// CEXAQ31200OutBlock1
		/// </summary>
		static readonly string _blockName = "CEXAQ31200OutBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		static readonly string _blockDesc = "In(*EMPTY*)";
		...
		public static XQCEXAQ31200OutBlock1 FromQuery(XQCEXAQ31200 query)
		{
			XQCEXAQ31200OutBlock1 block = new XQCEXAQ31200OutBlock1();
	...
	public partial class XQCEXAQ31200OutBlock2 : XingBlock
	{
		/// <summary>
		/// CEXAQ31200OutBlock2
		/// </summary>
		static readonly string _blockName = "CEXAQ31200OutBlock2";
		/// <summary>
		/// Out1(*EMPTY*)
		/// </summary>
		...
		/// 평가예탁금총액
		/// </summary>
		[XAQueryFieldAttribute("평가예탁금총액")]
		public long EvalDpsamtTotamt;
		/// <summary>
		/// 현금평가예탁금액
		/// </summary>
		[XAQueryFieldAttribute("현금평가예탁금액")]
		...
		/// 위탁증거금총액
		/// </summary>
		[XAQueryFieldAttribute("위탁증거금총액")]
		public long CsgnMgnTotamt;
		/// <summary>
		/// 현금위탁증거금액
		/// </summary>
		[XAQueryFieldAttribute("현금위탁증거금액")]
		public long MnyCsgnMgn;
		/// <summary>
		/// 추가증거금총액
		/// </summary>
		[XAQueryFieldAttribute("추가증거금총액")]
		...
		/// 선물평가손익금액
		/// </summary>
		[XAQueryFieldAttribute("선물평가손익금액")]
		...
		/// 총손익금액
		/// </summary>
		[XAQueryFieldAttribute("총손익금액")]
		public long TotPnlAmt;
		/// <summary>
		/// 순손익금액
		/// </summary>
		[XAQueryFieldAttribute("순손익금액")]
		public long NetPnlAmt;
		/// <summary>
		/// 총평가금액
		/// </summary>
		[XAQueryFieldAttribute("총평가금액")]
		...
		/// 선물수수료금액
		/// </summary>
		[XAQueryFieldAttribute("선물수수료금액")]
		public long FutsCmsnAmt;
		...
		public static class F
		{
			...
			/// 선물수수료금액
			/// </summary>
			public const string FutsCmsnAmt = "FutsCmsnAmt";
		}
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["FutsCmsnAmt"] = new XAQueryFieldInfo("long", FutsCmsnAmt, FutsCmsnAmt.ToString("d16"), "선물수수료금액", (decimal)16);
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "FutsCmsnAmt":
					this.FutsCmsnAmt = fieldInfo.FieldValue.ParseLong("FutsCmsnAmt");
				break;
		...
		public static XQCEXAQ31200OutBlock2 FromQuery(XQCEXAQ31200 query)
		{
			XQCEXAQ31200OutBlock2 block = new XQCEXAQ31200OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
			...
			try
			{
				...
				block.FutsCmsnAmt = query.GetFieldData(block.GetBlockName(), "FutsCmsnAmt", 0).ParseLong("FutsCmsnAmt"); // long 16
		...
		public bool VerifyData()
		{
			...
			if (FutsCmsnAmt.ToString().Length > 16) return false; // long 16

			return true;
		}
	}

	public partial class XQCEXAQ31200OutBlock3 : XingBlock
	{
		/// <summary>
		/// CEXAQ31200OutBlock3
		/// </summary>
		static readonly string _blockName = "CEXAQ31200OutBlock3";
		/// <summary>
		/// Out2(*EMPTY*)
		/// </summary>
		...
		public static XQCEXAQ31200OutBlock3[] ListFromQuery(XQCEXAQ31200 query)
		{
			int count = query.GetBlockCount(XQCEXAQ31200OutBlock3.BlockName);
			List<XQCEXAQ31200OutBlock3> list = new List<XQCEXAQ31200OutBlock3>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQCEXAQ31200OutBlock3 block = new XQCEXAQ31200OutBlock3();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
	...
	public partial class XQCEXAQ31200 : XingQuery
	{
		...
		/// CEXAQ31200
		/// </summary>
		static readonly string _typeName = "CEXAQ31200";
		/// <summary>
		/// 유렉스 예탁금 및 통합잔고조회
		/// </summary>
		static readonly string _typeDesc = "유렉스 예탁금 및 통합잔고조회";
		/// <summary>
		/// CEXAQ31200
		/// </summary>
		static readonly string _service = "CEXAQ31200";
		/// <summary>
		/// B
		/// </summary>
		...
		/// 이유리
		/// </summary>
		static readonly string _creator = "이유리";
		/// <summary>
		/// 2014/12/08 10:30:17
		/// </summary>
		static readonly string _createdDate = "2014/12/08 10:30:17";
		/// <summary>
		/// false
		/// </summary>
		...
		public bool SetFields(XQCEXAQ31200InBlock1 block)
		{
		...
		public XQCEXAQ31200OutBlock1 GetBlock1()
		{
			XQCEXAQ31200OutBlock1 instance = XQCEXAQ31200OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCEXAQ31200OutBlock2 GetBlock2()
		{
			XQCEXAQ31200OutBlock2 instance = XQCEXAQ31200OutBlock2.FromQuery(this);
			return instance;

		}

		public XQCEXAQ31200OutBlock3[] GetBlock3s()
		{
			XQCEXAQ31200OutBlock3[] instance = XQCEXAQ31200OutBlock3.ListFromQuery(this);
			return instance;
