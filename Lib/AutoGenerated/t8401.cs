...
namespace XingAPINet
{
	public partial class XQt8401InBlock : XingBlock
	{
		...
		public void CopyTo(XQt8401InBlock block)
		{
	...
	public partial class XQt8401OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt8401OutBlock block)
		{
			block.hname = this.hname;
			block.shcode = this.shcode;
			block.expcode = this.expcode;
			block.basecode = this.basecode;
	...
	public partial class XQt8401 : XingQuery
	{
		...
		public static XQt8401OutBlock[] ReadFromDB(string tableNamePostfix = null /*, char dummy = default */)
		{
			using (XQt8401 instance = new XQt8401())
			{

				string tableName = (tableNamePostfix == null) ? "XQt8401OutBlock" : $"XQt8401OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (dummy != default) qo.Add("dummy", dummy);


				var outBlock = instance.SelectMany<XQt8401OutBlock>(qo);
				return outBlock;
			}
		}
