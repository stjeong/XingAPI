...
namespace XingAPINet
{
	...
	public partial class XQCSPAQ13700OutBlock2 : XingBlock
	{
		...
		/// 매도체결금액
		/// </summary>
		[XAQueryFieldAttribute("매도체결금액")]
		public long SellExecAmt;
		/// <summary>
		/// 매수체결금액
		/// </summary>
		[XAQueryFieldAttribute("매수체결금액")]
	...
	public partial class XQCSPAQ13700OutBlock3 : XingBlock
	{
		...
		/// 정정취소수량
		/// </summary>
		[XAQueryFieldAttribute("정정취소수량")]
		public long MrcQty;
		/// <summary>
		/// 정정취소가능수량
		/// </summary>
		[XAQueryFieldAttribute("정정취소가능수량")]
		...
		/// 체결처리시각
		/// </summary>
		[XAQueryFieldAttribute("체결처리시각")]
		public string ExecTrxTime;
		/// <summary>
		/// 최종체결시각
		/// </summary>
		[XAQueryFieldAttribute("최종체결시각")]
