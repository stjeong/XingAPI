...
{
	public partial class XRSC2InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
		...
		public void CopyTo(XRSC2InBlock block)
		{

		}
	}

	public partial class XRSC2OutBlock : XingBlock
	{
		/// <summary>
		/// OutBlock
		/// </summary>
		...
		/// 주문체결유형코드
		/// </summary>
		[XAQueryFieldAttribute("ordxctptncode", "주문체결유형코드", "char", "2")]
		...
		/// 계좌번호
		/// </summary>
		[XAQueryFieldAttribute("accno1", "계좌번호", "char", "11")]
		public string accno1;
		/// <summary>
		/// 계좌번호
		/// </summary>
		[XAQueryFieldAttribute("accno2", "계좌번호", "char", "9")]
		...
		/// 주문가격
		/// </summary>
		[XAQueryFieldAttribute("ordprc", "주문가격", "long", "13")]
		public long ordprc;
		/// <summary>
		/// 체결수량
		/// </summary>
		...
		/// 체결가격
		/// </summary>
		[XAQueryFieldAttribute("execprc", "체결가격", "long", "13")]
		public long execprc;
		/// <summary>
		/// 정정확인수량
		/// </summary>
		[XAQueryFieldAttribute("mdfycnfqty", "정정확인수량", "long", "16")]
		public long mdfycnfqty;
		/// <summary>
		/// 정정확인가격
		/// </summary>
		[XAQueryFieldAttribute("mdfycnfprc", "정정확인가격", "long", "16")]
		public long mdfycnfprc;
		/// <summary>
		/// 취소확인수량
		/// </summary>
		[XAQueryFieldAttribute("canccnfqty", "취소확인수량", "long", "16")]
		public long canccnfqty;
		/// <summary>
		/// 거부수량
		/// </summary>
		[XAQueryFieldAttribute("rjtqty", "거부수량", "long", "16")]
		public long rjtqty;
		/// <summary>
		/// 주문처리유형코드
		/// </summary>
		[XAQueryFieldAttribute("ordtrxptncode", "주문처리유형코드", "long", "4")]
		public long ordtrxptncode;
		/// <summary>
		/// 복수주문일련번호
		/// </summary>
		[XAQueryFieldAttribute("mtiordseqno", "복수주문일련번호", "long", "10")]
		public long mtiordseqno;
		/// <summary>
		/// 주문조건
		/// </summary>
		[XAQueryFieldAttribute("ordcndi", "주문조건", "char", "1")]
		public char ordcndi;
		/// <summary>
		/// 호가유형코드
		/// </summary>
		...
		/// 비저축체결수량
		/// </summary>
		[XAQueryFieldAttribute("nsavtrdqty", "비저축체결수량", "long", "16")]
		...
		/// 미체결수량(주문)
		/// </summary>
		[XAQueryFieldAttribute("unercqty", "미체결수량(주문)", "long", "16")]
		...
		/// 원주문정정수량
		/// </summary>
		[XAQueryFieldAttribute("orgordmdfyqty", "원주문정정수량", "long", "16")]
		public long orgordmdfyqty;
		/// <summary>
		/// 원주문취소수량
		/// </summary>
		[XAQueryFieldAttribute("orgordcancqty", "원주문취소수량", "long", "16")]
		public long orgordcancqty;
		/// <summary>
		/// 주문평균체결가격
		/// </summary>
		[XAQueryFieldAttribute("ordavrexecprc", "주문평균체결가격", "long", "13")]
		...
		/// 표준종목번호
		/// </summary>
		[XAQueryFieldAttribute("stdIsuno", "표준종목번호", "char", "12")]
		public string stdIsuno;
		/// <summary>
		/// 전표준종목번호
		/// </summary>
		[XAQueryFieldAttribute("bfstdIsuno", "전표준종목번호", "char", "12")]
		...
		/// 주문거래유형코드
		/// </summary>
		[XAQueryFieldAttribute("ordtrdptncode", "주문거래유형코드", "char", "2")]
		...
		/// 수수료합산코드
		/// </summary>
		[XAQueryFieldAttribute("adduptp", "수수료합산코드", "char", "2")]
		...
		/// 회원/비회원사번호
		/// </summary>
		[XAQueryFieldAttribute("mbrnmbrno", "회원/비회원사번호", "long", "3")]
		public long mbrnmbrno;
		/// <summary>
		/// 주문계좌번호
		/// </summary>
		[XAQueryFieldAttribute("ordacntno", "주문계좌번호", "char", "20")]
		public string ordacntno;
		/// <summary>
		/// 집계지점번호
		/// </summary>
		[XAQueryFieldAttribute("agrgbrnno", "집계지점번호", "char", "3")]
		...
		/// 선물연계지점번호
		/// </summary>
		[XAQueryFieldAttribute("futsLnkbrnno", "선물연계지점번호", "char", "3")]
		public string futsLnkbrnno;
		/// <summary>
		/// 선물연계계좌번호
		/// </summary>
		[XAQueryFieldAttribute("futsLnkacntno", "선물연계계좌번호", "char", "20")]
		public string futsLnkacntno;
		/// <summary>
		/// 선물시장구분
		/// </summary>
		[XAQueryFieldAttribute("futsmkttp", "선물시장구분", "char", "1")]
		...
		/// 현금증거금률
		/// </summary>
		[XAQueryFieldAttribute("mnymgnrat", "현금증거금률", "long", "7")]
		public long mnymgnrat;
		/// <summary>
		/// 대용증거금률
		/// </summary>
		[XAQueryFieldAttribute("substmgnrat", "대용증거금률", "long", "9")]
		public long substmgnrat;
		/// <summary>
		/// 현금체결금액
		/// </summary>
		[XAQueryFieldAttribute("mnyexecamt", "현금체결금액", "long", "16")]
		public long mnyexecamt;
		/// <summary>
		/// 대용체결금액
		/// </summary>
		[XAQueryFieldAttribute("ubstexecamt", "대용체결금액", "long", "16")]
		public long ubstexecamt;
		/// <summary>
		/// 수수료체결금액
		/// </summary>
		[XAQueryFieldAttribute("cmsnamtexecamt", "수수료체결금액", "long", "16")]
		public long cmsnamtexecamt;
		/// <summary>
		/// 신용담보체결금액
		/// </summary>
		[XAQueryFieldAttribute("crdtpldgexecamt", "신용담보체결금액", "long", "16")]
		public long crdtpldgexecamt;
		/// <summary>
		/// 신용체결금액
		/// </summary>
		[XAQueryFieldAttribute("crdtexecamt", "신용체결금액", "long", "16")]
		public long crdtexecamt;
		/// <summary>
		/// 전일재사용체결금액
		/// </summary>
		[XAQueryFieldAttribute("prdayruseexecval", "전일재사용체결금액", "long", "16")]
		public long prdayruseexecval;
		/// <summary>
		/// 금일재사용체결금액
		/// </summary>
		[XAQueryFieldAttribute("crdayruseexecval", "금일재사용체결금액", "long", "16")]
		public long crdayruseexecval;
		/// <summary>
		/// 실물체결수량
		/// </summary>
		[XAQueryFieldAttribute("spotexecqty", "실물체결수량", "long", "16")]
		public long spotexecqty;
		/// <summary>
		/// 공매도체결수량
		/// </summary>
		[XAQueryFieldAttribute("stslexecqty", "공매도체결수량", "long", "16")]
		...
		/// 주문자Id
		/// </summary>
		[XAQueryFieldAttribute("orduserId", "주문자Id", "char", "16")]
		public string orduserId;
		/// <summary>
		/// 차입관리여부
		/// </summary>
		[XAQueryFieldAttribute("brwmgmtYn", "차입관리여부", "long", "1")]
		public long brwmgmtYn;
		/// <summary>
		/// 외국인고유번호
		/// </summary>
		[XAQueryFieldAttribute("frgrunqno", "외국인고유번호", "char", "6")]
		public string frgrunqno;
		/// <summary>
		/// 거래세징수구분
		/// </summary>
		[XAQueryFieldAttribute("trtzxLevytp", "거래세징수구분", "char", "1")]
		public char trtzxLevytp;
		/// <summary>
		/// 유동성공급자구분
		/// </summary>
		[XAQueryFieldAttribute("lptp", "유동성공급자구분", "char", "1")]
		public char lptp;
		/// <summary>
		/// 체결시각
		/// </summary>
		[XAQueryFieldAttribute("exectime", "체결시각", "char", "9")]
		public string exectime;
		/// <summary>
		/// 거래소수신체결시각
		/// </summary>
		[XAQueryFieldAttribute("rcptexectime", "거래소수신체결시각", "char", "9")]
		public string rcptexectime;
		/// <summary>
		/// 잔여대출금액
		/// </summary>
		[XAQueryFieldAttribute("rmndLoanamt", "잔여대출금액", "long", "16")]
		public long rmndLoanamt;
		/// <summary>
		/// 잔고수량
		/// </summary>
		[XAQueryFieldAttribute("secbalqty", "잔고수량", "long", "16")]
		public long secbalqty;
		/// <summary>
		/// 실물가능수량
		/// </summary>
		[XAQueryFieldAttribute("spotordableqty", "실물가능수량", "long", "16")]
		public long spotordableqty;
		/// <summary>
		/// 재사용가능수량(매도)
		/// </summary>
		[XAQueryFieldAttribute("ordableruseqty", "재사용가능수량(매도)", "long", "16")]
		public long ordableruseqty;
		/// <summary>
		/// 변동수량
		/// </summary>
		[XAQueryFieldAttribute("flctqty", "변동수량", "long", "16")]
		public long flctqty;
		/// <summary>
		/// 잔고수량(d2)
		/// </summary>
		[XAQueryFieldAttribute("secbalqtyd2", "잔고수량(d2)", "long", "16")]
		public long secbalqtyd2;
		/// <summary>
		/// 매도주문가능수량
		/// </summary>
		[XAQueryFieldAttribute("sellableqty", "매도주문가능수량", "long", "16")]
		public long sellableqty;
		/// <summary>
		/// 미체결매도주문수량
		/// </summary>
		[XAQueryFieldAttribute("unercsellordqty", "미체결매도주문수량", "long", "16")]
		public long unercsellordqty;
		/// <summary>
		/// 평균매입가
		/// </summary>
		[XAQueryFieldAttribute("avrpchsprc", "평균매입가", "long", "13")]
		public long avrpchsprc;
		/// <summary>
		/// 매입금액
		/// </summary>
		[XAQueryFieldAttribute("pchsant", "매입금액", "long", "16")]
		public long pchsant;
		/// <summary>
		/// 예수금
		/// </summary>
		[XAQueryFieldAttribute("deposit", "예수금", "long", "16")]
		public long deposit;
		/// <summary>
		/// 대용금
		/// </summary>
		[XAQueryFieldAttribute("substamt", "대용금", "long", "16")]
		public long substamt;
		/// <summary>
		/// 위탁증거금현금
		/// </summary>
		[XAQueryFieldAttribute("csgnmnymgn", "위탁증거금현금", "long", "16")]
		public long csgnmnymgn;
		/// <summary>
		/// 위탁증거금대용
		/// </summary>
		[XAQueryFieldAttribute("csgnsubstmgn", "위탁증거금대용", "long", "16")]
		public long csgnsubstmgn;
		/// <summary>
		/// 신용담보재사용금
		/// </summary>
		[XAQueryFieldAttribute("crdtpldgruseamt", "신용담보재사용금", "long", "16")]
		public long crdtpldgruseamt;
		/// <summary>
		/// 주문가능현금
		/// </summary>
		[XAQueryFieldAttribute("ordablemny", "주문가능현금", "long", "16")]
		public long ordablemny;
		/// <summary>
		/// 주문가능대용
		/// </summary>
		[XAQueryFieldAttribute("ordablesubstamt", "주문가능대용", "long", "16")]
		public long ordablesubstamt;
		/// <summary>
		/// 재사용가능금액
		/// </summary>
		[XAQueryFieldAttribute("ruseableamt", "재사용가능금액", "long", "16")]
		...
		public static XRSC2OutBlock FromQuery(XRSC2 query)
		{
			XRSC2OutBlock block = new XRSC2OutBlock();
		...
		public void CopyTo(XRSC2OutBlock block)
		{
	...
	/// 주식주문정정
	/// </summary>
	public partial class XRSC2 : XingReal
	{
		/// <summary>
		/// SC2
		/// </summary>
		public const string _typeName = "SC2";
		/// <summary>
		/// 주식주문정정
		/// </summary>
		public const string _typeDesc = "주식주문정정";
		/// <summary>
		/// false
		/// </summary>
		...
		/// 주식주문정정
		/// </summary>
		public XRSC2() : base("SC2") { }


		public bool SetBlock(XRSC2InBlock block)
		{
		...
		public XRSC2OutBlock GetBlock()
		{
			XRSC2OutBlock instance = XRSC2OutBlock.FromQuery(this);
			return instance;
