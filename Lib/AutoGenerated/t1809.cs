...
namespace XingAPINet
{
	public partial class XQt1809InBlock : XingBlock
	{
		...
		/// 신호구분
		/// </summary>
		[XAQueryFieldAttribute("gubun", "신호구분", "char", "1")]
		public char gubun;
		/// <summary>
		/// 종목구분
		/// </summary>
		[XAQueryFieldAttribute("jmGb", "종목구분", "char", "1")]
		public char jmGb;
		/// <summary>
		/// 종목코드
		/// </summary>
		[XAQueryFieldAttribute("jmcode", "종목코드", "char", "6")]
		public string jmcode;
		/// <summary>
		/// NEXTKEY
		/// </summary>
		[XAQueryFieldAttribute("cts", "NEXTKEY", "char", "30")]
		public string cts;
		...
		public void CopyTo(XQt1809InBlock block)
		{
			block.gubun = this.gubun;
			block.jmGb = this.jmGb;
			block.jmcode = this.jmcode;
			block.cts = this.cts;
	...
	public partial class XQt1809OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1809OutBlock block)
		{
			block.cts = this.cts;
	...
	public partial class XQt1809OutBlock1 : XingBlock
	{
		...
		/// 신호ID
		/// </summary>
		[XAQueryFieldAttribute("signal_id", "신호ID", "char", "4")]
		public string signal_id;
		/// <summary>
		/// 신호명
		/// </summary>
		[XAQueryFieldAttribute("signal_desc", "신호명", "char", "300")]
		public string signal_desc;
		/// <summary>
		/// 신호강도
		/// </summary>
		[XAQueryFieldAttribute("point", "신호강도", "char", "3")]
		public string point;
		/// <summary>
		/// 뉴스신호키워드
		/// </summary>
		[XAQueryFieldAttribute("keyword", "뉴스신호키워드", "char", "40")]
		public string keyword;
		/// <summary>
		/// 신호별구분
		/// </summary>
		[XAQueryFieldAttribute("seq", "신호별구분", "char", "24")]
		public string seq;
		/// <summary>
		/// 신호구분
		/// </summary>
		[XAQueryFieldAttribute("gubun", "신호구분", "char", "2")]
		public string gubun;
		/// <summary>
		/// 신호종목
		/// </summary>
		[XAQueryFieldAttribute("jmcode", "신호종목", "char", "6")]
		public string jmcode;
		/// <summary>
		/// 종목가격
		/// </summary>
		[XAQueryFieldAttribute("price", "종목가격", "long", "7")]
		public long price;
		/// <summary>
		/// 종목등락부호
		/// </summary>
		[XAQueryFieldAttribute("sign", "종목등락부호", "char", "1")]
		public char sign;
		/// <summary>
		/// 대비등락율
		/// </summary>
		[XAQueryFieldAttribute("chgrate", "대비등락율", "float", "6.2")]
		public float chgrate;
		/// <summary>
		/// 거래량
		/// </summary>
		[XAQueryFieldAttribute("volume", "거래량", "long", "9")]
		public long volume;
		/// <summary>
		/// 신호일시
		/// </summary>
		[XAQueryFieldAttribute("datetime", "신호일시", "char", "16")]
		...
		public void CopyTo(XQt1809OutBlock1 block)
		{
			block.date = this.date;
			block.time = this.time;
			block.signal_id = this.signal_id;
			block.signal_desc = this.signal_desc;
			block.point = this.point;
			block.keyword = this.keyword;
			block.seq = this.seq;
			block.gubun = this.gubun;
			block.jmcode = this.jmcode;
			block.price = this.price;
			block.sign = this.sign;
			block.chgrate = this.chgrate;
	...
	public partial class XQt1809 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,char jmGb = default,string jmcode = default,string cts = default */)
		{
			using (XQt1809 instance = new XQt1809())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1809OutBlock" : $"XQt1809OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1809OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1809OutBlock1" : $"XQt1809OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1809OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1809OutBlock),
			typeof(XQt1809OutBlock1),
