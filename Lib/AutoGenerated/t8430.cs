...
namespace XingAPINet
{
	public partial class XQt8430InBlock : XingBlock
	{
		...
		public void CopyTo(XQt8430InBlock block)
		{
	...
	public partial class XQt8430OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt8430OutBlock block)
		{
	...
	public partial class XQt8430 : XingQuery
	{
		...
		public static XQt8430OutBlock[] ReadFromDB(string tableNamePostfix = null /*, char gubun = default */)
		{
			using (XQt8430 instance = new XQt8430())
			{

				string tableName = (tableNamePostfix == null) ? "XQt8430OutBlock" : $"XQt8430OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (gubun != default) qo.Add("gubun", gubun);


				var outBlock = instance.SelectMany<XQt8430OutBlock>(qo);
				return outBlock;
			}
		}
