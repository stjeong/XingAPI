...
namespace XingAPINet
{
	public partial class XQt1960InBlock : XingBlock
	{
		...
		public void CopyTo(XQt1960InBlock block)
		{
	...
	public partial class XQt1960OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1960OutBlock block)
		{
			block.idx = this.idx;
	...
	public partial class XQt1960OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQt1960OutBlock1 block)
		{
	...
	public partial class XQt1960 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,string ggubun = default,string itemcode = default,string lastdate = default,string exgubun = default,long sprice = default,long eprice = default,long volume = default,long sjanday = default,long ejanday = default,long idx = default */)
		{
			using (XQt1960 instance = new XQt1960())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1960OutBlock" : $"XQt1960OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1960OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1960OutBlock1" : $"XQt1960OutBlock1_{tableNamePostfix}";
