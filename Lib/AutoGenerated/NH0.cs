...
{
	public partial class XRNH0InBlock : XingBlock
	{
		/// <summary>
		/// InBlock
		/// </summary>
	...
	public partial class XRNH0OutBlock : XingBlock
	{
		...
		public static XRNH0OutBlock FromQuery(XRNH0 query)
		{
			XRNH0OutBlock block = new XRNH0OutBlock();
	...
	public partial class XRNH0 : XingReal
	{
		...
		/// NH0
		/// </summary>
		public const string _typeName = "NH0";
		/// <summary>
		/// CME연계KP200지수선물호가(NH0)
		/// </summary>
		public const string _typeDesc = "CME연계KP200지수선물호가(NH0)";
		/// <summary>
		/// false
		/// </summary>
		...
		public bool SetBlock(XRNH0InBlock block)
		{
		...
		public XRNH0OutBlock GetBlock()
		{
			XRNH0OutBlock instance = XRNH0OutBlock.FromQuery(this);
			return instance;
