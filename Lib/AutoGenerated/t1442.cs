...
namespace XingAPINet
{
	public partial class XQt1442InBlock : XingBlock
	{
		...
		/// t1442InBlock
		/// </summary>
		static readonly string _blockName = "t1442InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 신고신저
		/// </summary>
		[XAQueryFieldAttribute("신고신저")]
		public char type1;
		/// <summary>
		/// 기간
		/// </summary>
		[XAQueryFieldAttribute("기간")]
		public char type2;
		/// <summary>
		/// 유지여부
		/// </summary>
		[XAQueryFieldAttribute("유지여부")]
		public char type3;
		/// <summary>
		/// 대상제외
		/// </summary>
	...
	public partial class XQt1442OutBlock : XingBlock
	{
		...
		/// t1442OutBlock
		/// </summary>
		static readonly string _blockName = "t1442OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt1442OutBlock1 : XingBlock
	{
		...
		/// t1442OutBlock1
		/// </summary>
		static readonly string _blockName = "t1442OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 이전가
		/// </summary>
		[XAQueryFieldAttribute("이전가")]
		public long pastprice;
		/// <summary>
		/// 이전가대비구분
		/// </summary>
		[XAQueryFieldAttribute("이전가대비구분")]
		public char pastsign;
		/// <summary>
		/// 이전가대비
		/// </summary>
		[XAQueryFieldAttribute("이전가대비")]
		public long pastchange;
		/// <summary>
		/// 이전가대비율
		/// </summary>
		[XAQueryFieldAttribute("이전가대비율")]
	...
	public partial class XQt1442 : XingQuery
	{
		...
		/// t1442
		/// </summary>
		static readonly string _typeName = "t1442";
		/// <summary>
		/// 신고/신저가(t1442)
		/// </summary>
		static readonly string _typeDesc = "신고/신저가(t1442)";
		/// <summary>
		/// 
		/// </summary>
