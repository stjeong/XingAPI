...
namespace XingAPINet
{
	public partial class XQt1302InBlock : XingBlock
	{
		...
		/// 작업구분
		/// </summary>
		[XAQueryFieldAttribute("gubun", "작업구분", "char", "1")]
		public char gubun;
		/// <summary>
		/// 시간
		/// </summary>
		...
		/// 건수
		/// </summary>
		[XAQueryFieldAttribute("cnt", "건수", "int", "3")]
		public int cnt;
	...
	public partial class XQt1302OutBlock1 : XingBlock
	{
		...
		/// 순매수체결량
		/// </summary>
		[XAQueryFieldAttribute("revolume", "순매수체결량", "long", "12")]
		...
		/// 매도체결건수(시간)
		/// </summary>
		[XAQueryFieldAttribute("mdchecnttm", "매도체결건수(시간)", "long", "8")]
		public long mdchecnttm;
		/// <summary>
		/// 매수체결건수(시간)
		/// </summary>
		[XAQueryFieldAttribute("mschecnttm", "매수체결건수(시간)", "long", "8")]
		public long mschecnttm;
		/// <summary>
		/// 매도잔량
		/// </summary>
		[XAQueryFieldAttribute("totofferrem", "매도잔량", "long", "12")]
		public long totofferrem;
		/// <summary>
		/// 매수잔량
		/// </summary>
		[XAQueryFieldAttribute("totbidrem", "매수잔량", "long", "12")]
		public long totbidrem;
		/// <summary>
		/// 시간별매도체결량
		/// </summary>
		[XAQueryFieldAttribute("mdvolumetm", "시간별매도체결량", "long", "12")]
		public long mdvolumetm;
		/// <summary>
		/// 시간별매수체결량
		/// </summary>
		[XAQueryFieldAttribute("msvolumetm", "시간별매수체결량", "long", "12")]
	...
	public partial class XQt1302 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,char gubun = default,string time = default,int cnt = default */)
		{
			using (XQt1302 instance = new XQt1302())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1302OutBlock" : $"XQt1302OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1302OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1302OutBlock1" : $"XQt1302OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1302OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1302OutBlock),
			typeof(XQt1302OutBlock1),
