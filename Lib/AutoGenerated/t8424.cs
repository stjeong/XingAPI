...
namespace XingAPINet
{
	public partial class XQt8424InBlock : XingBlock
	{
		...
		public void CopyTo(XQt8424InBlock block)
		{
	...
	public partial class XQt8424OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt8424OutBlock block)
		{
	...
	public partial class XQt8424 : XingQuery
	{
		...
		public static XQt8424OutBlock[] ReadFromDB(string tableNamePostfix = null /*, char gubun1 = default */)
		{
			using (XQt8424 instance = new XQt8424())
			{

				string tableName = (tableNamePostfix == null) ? "XQt8424OutBlock" : $"XQt8424OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				// if (gubun1 != default) qo.Add("gubun1", gubun1);


				var outBlock = instance.SelectMany<XQt8424OutBlock>(qo);
				return outBlock;
			}
		}
