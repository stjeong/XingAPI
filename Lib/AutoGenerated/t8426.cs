...
namespace XingAPINet
{
	public partial class XQt8426InBlock : XingBlock
	{
		...
		/// t8426InBlock
		/// </summary>
		public const string _blockName = "t8426InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		public void CopyTo(XQt8426InBlock block)
		{
	...
	public partial class XQt8426OutBlock : XingBlock
	{
		...
		/// t8426OutBlock
		/// </summary>
		public const string _blockName = "t8426OutBlock";
		/// <summary>
		/// 주식종목마스터
		/// </summary>
		...
		public void CopyTo(XQt8426OutBlock block)
		{
	...
	public partial class XQt8426 : XingQuery
	{
		...
		/// t8426
		/// </summary>
		public const string _typeName = "t8426";
		/// <summary>
		/// 상품선물마스터조회(API용)(t8426)
		/// </summary>
		public const string _typeDesc = "상품선물마스터조회(API용)(t8426)";
		/// <summary>
		/// 
		/// </summary>
		...
		public static XQt8426OutBlock[] Get(char dummy = default)
		{
			using (XQt8426 instance = new XQt8426())
			{
				instance.SetFieldData(XQt8426InBlock.BlockName, XQt8426InBlock.F.dummy, 0, dummy.ToString()); // char 1
		...
		public static XQt8426OutBlock[] ReadFromDB(string tableNamePostfix = null /*, char dummy = default */)
		{
			using (XQt8426 instance = new XQt8426())
			{
				...
				var outBlock = instance.SelectMany<XQt8426OutBlock>(qo);
				return outBlock;
			}
		}

		public bool SetBlock(XQt8426InBlock block)
		{
