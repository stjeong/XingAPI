...
namespace XingAPINet
{
	...
	public partial class XRSHIOutBlock : XingBlock
	{
		...
		/// 매도호가총수량
		/// </summary>
		[XAQueryFieldAttribute("매도호가총수량", "12")]
		public long totofferrem;
		/// <summary>
		/// 매수호가총수량
		/// </summary>
		[XAQueryFieldAttribute("매수호가총수량", "12")]
		public long totbidrem;
		/// <summary>
		/// 상한가/하한가최종진입시간
		/// </summary>
		[XAQueryFieldAttribute("상한가/하한가최종진입시간", "6")]
		public string updnlmtstime;
		/// <summary>
		/// 상한가/하한가연속일수
		/// </summary>
		[XAQueryFieldAttribute("상한가/하한가연속일수", "3")]
