...
namespace XingAPINet
{
	public partial class XRSHIInBlock : XingBlock
	{
		...
		public void CopyTo(XRSHIInBlock block)
		{
	...
	public partial class XRSHIOutBlock : XingBlock
	{
		...
		/// 매도호가총수량
		/// </summary>
		[XAQueryFieldAttribute("totofferrem", "매도호가총수량", "long", "12")]
		public long totofferrem;
		/// <summary>
		/// 매수호가총수량
		/// </summary>
		[XAQueryFieldAttribute("totbidrem", "매수호가총수량", "long", "12")]
		public long totbidrem;
		/// <summary>
		/// 상한가/하한가최종진입시간
		/// </summary>
		[XAQueryFieldAttribute("updnlmtstime", "상한가/하한가최종진입시간", "char", "6")]
		...
		public void CopyTo(XRSHIOutBlock block)
		{
			...
			block.updnlmtstime = this.updnlmtstime;
