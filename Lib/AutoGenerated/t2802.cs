...
{
	public partial class XQt2802InBlock : XingBlock
	{
		/// <summary>
		/// t2802InBlock
		/// </summary>
	...
	public partial class XQt2802OutBlock : XingBlock
	{
		/// <summary>
		/// t2802OutBlock
		/// </summary>
		...
		public static XQt2802OutBlock FromQuery(XQt2802 query)
		{
			XQt2802OutBlock block = new XQt2802OutBlock();
	...
	public partial class XQt2802 : XingQuery
	{
		...
		public static XQt2802OutBlock Get(string shcode = default)
		{
			using (XQt2802 instance = new XQt2802())
			{
				instance.SetFieldData(XQt2802InBlock.BlockName, XQt2802InBlock.F.shcode, 0, shcode); // char 8
		...
		public XQt2802OutBlock GetBlock()
		{
			XQt2802OutBlock instance = XQt2802OutBlock.FromQuery(this);
			return instance;
