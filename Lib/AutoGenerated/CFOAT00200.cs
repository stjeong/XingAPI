...
{
	public partial class XQCFOAT00200InBlock1 : XingBlock
	{
		/// <summary>
		/// CFOAT00200InBlock1
		/// </summary>
		public const string _blockName = "CFOAT00200InBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		...
		/// 정정수량
		/// </summary>
		[XAQueryFieldAttribute("MdfyQty", "정정수량", "long", "16")]
		public long MdfyQty;
		...
		public static class F
		{
			...
			/// 정정수량
			/// </summary>
			public const string MdfyQty = "MdfyQty";
		}
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "MdfyQty":
					this.MdfyQty = fieldInfo.FieldValue.ParseLong("MdfyQty");
				break;
		...
		public void CopyTo(XQCFOAT00200InBlock1 block)
		{
			...
			block.MdfyQty = this.MdfyQty;

		}
	}

	public partial class XQCFOAT00200OutBlock1 : XingBlock
	{
		/// <summary>
		/// CFOAT00200OutBlock1
		/// </summary>
		public const string _blockName = "CFOAT00200OutBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		public const string _blockDesc = "In(*EMPTY*)";
		...
		/// 펀드원주문번호
		/// </summary>
		[XAQueryFieldAttribute("FundOrgOrdNo", "펀드원주문번호", "long", "10")]
		...
		public static XQCFOAT00200OutBlock1 FromQuery(XQCFOAT00200 query)
		{
			XQCFOAT00200OutBlock1 block = new XQCFOAT00200OutBlock1();
			...
			try
			{
				...
				block.MdfyQty = query.GetFieldData(block.GetBlockName(), "MdfyQty", 0).ParseLong("MdfyQty"); // long 16
		...
		public void CopyTo(XQCFOAT00200OutBlock1 block)
		{
			...
			block.FundOrgOrdNo = this.FundOrgOrdNo;
			block.FundOrdNo = this.FundOrdNo;

		}
	}

	public partial class XQCFOAT00200OutBlock2 : XingBlock
	{
		/// <summary>
		/// CFOAT00200OutBlock2
		/// </summary>
		public const string _blockName = "CFOAT00200OutBlock2";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
		...
		/// 현금주문증거금액
		/// </summary>
		[XAQueryFieldAttribute("MnyOrdMgn", "현금주문증거금액", "long", "16")]
		...
		public static XQCFOAT00200OutBlock2 FromQuery(XQCFOAT00200 query)
		{
			XQCFOAT00200OutBlock2 block = new XQCFOAT00200OutBlock2();
			block.IsValidData = true;
			block.InvalidReason = "";
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
		...
		public void CopyTo(XQCFOAT00200OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
	...
	/// 선물옵션 정정주문
	/// </summary>
	public partial class XQCFOAT00200 : XingQuery
	{
		/// <summary>
		/// CFOAT00200
		/// </summary>
		public const string _typeName = "CFOAT00200";
		/// <summary>
		/// 선물옵션 정정주문
		/// </summary>
		public const string _typeDesc = "선물옵션 정정주문";
		/// <summary>
		/// CFOAT00200
		/// </summary>
		public const string _service = "CFOAT00200";
		/// <summary>
		/// B
		/// </summary>
		...
		/// 2012/03/12 13:31:21
		/// </summary>
		public const string _createdDate = "2012/03/12 13:31:21";
		/// <summary>
		/// false
		/// </summary>
		...
		/// 선물옵션 정정주문
		/// </summary>
		public XQCFOAT00200() : base("CFOAT00200") { }




		public bool SetBlock(XQCFOAT00200InBlock1 block)
		{
			...
			_xaQuery.SetFieldData(block.GetBlockName(), "MdfyQty", 0, block.MdfyQty.ToString("d16")); // long 16

			return true;
		}

		public XQCFOAT00200OutBlock1 GetBlock1()
		{
			XQCFOAT00200OutBlock1 instance = XQCFOAT00200OutBlock1.FromQuery(this);
			return instance;

		}

		public XQCFOAT00200OutBlock2 GetBlock2()
		{
			XQCFOAT00200OutBlock2 instance = XQCFOAT00200OutBlock2.FromQuery(this);
			return instance;
		...
		{
			typeof(XQCFOAT00200OutBlock1),
			typeof(XQCFOAT00200OutBlock2),
