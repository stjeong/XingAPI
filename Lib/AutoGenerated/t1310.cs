...
namespace XingAPINet
{
	public partial class XQt1310InBlock : XingBlock
	{
		...
		/// 당일전일구분
		/// </summary>
		[XAQueryFieldAttribute("daygb", "당일전일구분", "char", "1")]
		public char daygb;
		/// <summary>
		/// 분틱구분
		/// </summary>
		[XAQueryFieldAttribute("timegb", "분틱구분", "char", "1")]
		public char timegb;
		/// <summary>
		/// 단축코드
		/// </summary>
	...
	public partial class XQt1310 : XingQuery
	{
		...
		public static XQAllOutBlocks Get(char daygb = default,char timegb = default,string shcode = default,string endtime = default,string cts_time = default)
		{
			...
			{
				instance.SetFieldData(XQt1310InBlock.BlockName, XQt1310InBlock.F.daygb, 0, daygb.ToString()); // char 1
				instance.SetFieldData(XQt1310InBlock.BlockName, XQt1310InBlock.F.timegb, 0, timegb.ToString()); // char 1
				instance.SetFieldData(XQt1310InBlock.BlockName, XQt1310InBlock.F.shcode, 0, shcode); // char 6
				instance.SetFieldData(XQt1310InBlock.BlockName, XQt1310InBlock.F.endtime, 0, endtime); // char 4
				instance.SetFieldData(XQt1310InBlock.BlockName, XQt1310InBlock.F.cts_time, 0, cts_time); // char 10
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char daygb = default,char timegb = default,string shcode = default,string endtime = default,string cts_time = default */)
		{
			using (XQt1310 instance = new XQt1310())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1310OutBlock" : $"XQt1310OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1310OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1310OutBlock1" : $"XQt1310OutBlock1_{tableNamePostfix}";
		...
		{
			typeof(XQt1310OutBlock),
			typeof(XQt1310OutBlock1),
