...
namespace XingAPINet
{
	public partial class XQt1638InBlock : XingBlock
	{
		...
		/// 정렬
		/// </summary>
		[XAQueryFieldAttribute("gubun2", "정렬", "char", "1")]
		public char gubun2;
		...
		public void CopyTo(XQt1638InBlock block)
		{
	...
	public partial class XQt1638OutBlock : XingBlock
	{
		...
		/// 시총비중
		/// </summary>
		[XAQueryFieldAttribute("sigatotrt", "시총비중", "float", "6.2")]
		public float sigatotrt;
		/// <summary>
		/// 순매수잔량
		/// </summary>
		[XAQueryFieldAttribute("obuyvol", "순매수잔량", "long", "12")]
		public long obuyvol;
		/// <summary>
		/// 매수잔량
		/// </summary>
		[XAQueryFieldAttribute("buyrem", "매수잔량", "long", "12")]
		public long buyrem;
		/// <summary>
		/// 매수공시수량
		/// </summary>
		[XAQueryFieldAttribute("psgvolume", "매수공시수량", "long", "12")]
		public long psgvolume;
		/// <summary>
		/// 매도잔량
		/// </summary>
		[XAQueryFieldAttribute("sellrem", "매도잔량", "long", "12")]
		public long sellrem;
		/// <summary>
		/// 매도공시수량
		/// </summary>
		[XAQueryFieldAttribute("pdgvolume", "매도공시수량", "long", "12")]
		public long pdgvolume;
		/// <summary>
		/// 시가총액
		/// </summary>
		[XAQueryFieldAttribute("sigatot", "시가총액", "long", "20")]
		public long sigatot;
		/// <summary>
		/// 종목코드
		/// </summary>
		...
		public void CopyTo(XQt1638OutBlock block)
		{
			...
			block.sigatotrt = this.sigatotrt;
			block.obuyvol = this.obuyvol;
			block.buyrem = this.buyrem;
			block.psgvolume = this.psgvolume;
			block.sellrem = this.sellrem;
			block.pdgvolume = this.pdgvolume;
			block.sigatot = this.sigatot;
			block.shcode = this.shcode;
