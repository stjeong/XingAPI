...
namespace XingAPINet
{
	public partial class XQt1904InBlock : XingBlock
	{
		...
		/// ETF단축코드
		/// </summary>
		[XAQueryFieldAttribute("shcode", "ETF단축코드", "char", "6")]
		public string shcode;
		/// <summary>
		/// PDF적용일자
		/// </summary>
		[XAQueryFieldAttribute("date", "PDF적용일자", "char", "8")]
		public string date;
		/// <summary>
		/// 정렬기준(1:평가금액2:증권수)
		/// </summary>
		[XAQueryFieldAttribute("sgb", "정렬기준(1:평가금액2:증권수)", "char", "1")]
		public char sgb;
	...
	public partial class XQt1904OutBlock : XingBlock
	{
		...
		/// 당일구분
		/// </summary>
		[XAQueryFieldAttribute("chk_tday", "당일구분", "char", "1")]
		...
		/// ETF현재가
		/// </summary>
		[XAQueryFieldAttribute("price", "ETF현재가", "long", "8")]
		public long price;
		/// <summary>
		/// ETF전일대비구분
		/// </summary>
		[XAQueryFieldAttribute("sign", "ETF전일대비구분", "char", "1")]
		public char sign;
		/// <summary>
		/// ETF전일대비
		/// </summary>
		[XAQueryFieldAttribute("change", "ETF전일대비", "long", "8")]
		public long change;
		/// <summary>
		/// ETF등락율
		/// </summary>
		[XAQueryFieldAttribute("diff", "ETF등락율", "float", "6.2")]
		public float diff;
		/// <summary>
		/// ETF누적거래량
		/// </summary>
		[XAQueryFieldAttribute("volume", "ETF누적거래량", "long", "12")]
		public long volume;
		/// <summary>
		/// NAV
		/// </summary>
		...
		/// 순자산총액(단위:억)
		/// </summary>
		[XAQueryFieldAttribute("etftotcap", "순자산총액(단위:억)", "long", "12")]
		public long etftotcap;
		/// <summary>
		/// 구성종목수
		/// </summary>
		[XAQueryFieldAttribute("etfnum", "구성종목수", "long", "4")]
		public long etfnum;
		/// <summary>
		/// CU주식수
		/// </summary>
		[XAQueryFieldAttribute("etfcunum", "CU주식수", "long", "12")]
		public long etfcunum;
		/// <summary>
		/// 현금
		/// </summary>
		[XAQueryFieldAttribute("cash", "현금", "long", "12")]
		public long cash;
		/// <summary>
		/// 운용사명
		/// </summary>
		[XAQueryFieldAttribute("opcom_nmk", "운용사명", "char", "20")]
		public string opcom_nmk;
		/// <summary>
		/// 전종목평가금액합
		/// </summary>
		[XAQueryFieldAttribute("tot_pval", "전종목평가금액합", "long", "12")]
		public long tot_pval;
		/// <summary>
		/// 전종목구성시가총액합
		/// </summary>
		[XAQueryFieldAttribute("tot_sigatval", "전종목구성시가총액합", "long", "12")]
	...
	public partial class XQt1904OutBlock1 : XingBlock
	{
		...
		/// 단축코드
		/// </summary>
		[XAQueryFieldAttribute("shcode", "단축코드", "char", "12")]
		public string shcode;
		/// <summary>
		/// 한글명
		/// </summary>
		...
		/// </summary>
		[XAQueryFieldAttribute("icux", "단위증권수(계약수/원화현금/USD현금/창고증권)", "long", "12")]
		public long icux;
		/// <summary>
		/// 액면금액/설정현금액
		/// </summary>
		[XAQueryFieldAttribute("parprice", "액면금액/설정현금액", "long", "12")]
		public long parprice;
		/// <summary>
		/// 평가금액
		/// </summary>
		[XAQueryFieldAttribute("pvalue", "평가금액", "long", "12")]
		public long pvalue;
		/// <summary>
		/// 구성시가총액
		/// </summary>
		[XAQueryFieldAttribute("sigatvalue", "구성시가총액", "long", "12")]
		public long sigatvalue;
		/// <summary>
		/// PDF적용일자
		/// </summary>
		[XAQueryFieldAttribute("profitdate", "PDF적용일자", "char", "8")]
		public string profitdate;
		/// <summary>
		/// 비중(평가금액)
		/// </summary>
		[XAQueryFieldAttribute("weight", "비중(평가금액)", "float", "6.2")]
		public float weight;
		/// <summary>
		/// ETF종목과등락차
		/// </summary>
		[XAQueryFieldAttribute("diff2", "ETF종목과등락차", "float", "6.2")]
		public float diff2;
	...
	public partial class XQt1904 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,string date = default,char sgb = default */)
		{
			using (XQt1904 instance = new XQt1904())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1904OutBlock" : $"XQt1904OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1904OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1904OutBlock1" : $"XQt1904OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1904OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1904OutBlock),
			typeof(XQt1904OutBlock1),
