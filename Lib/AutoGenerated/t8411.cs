...
{
	public partial class XQt8411InBlock : XingBlock
	{
		/// <summary>
		/// t8411InBlock
		/// </summary>
		public const string _blockName = "t8411InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8411OutBlock : XingBlock
	{
		/// <summary>
		/// t8411OutBlock
		/// </summary>
		public const string _blockName = "t8411OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public static XQt8411OutBlock FromQuery(XQt8411 query)
		{
			XQt8411OutBlock block = new XQt8411OutBlock();
	...
	public partial class XQt8411OutBlock1 : XingBlock
	{
		/// <summary>
		/// t8411OutBlock1
		/// </summary>
		public const string _blockName = "t8411OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		public static XQt8411OutBlock1[] ListFromQuery(XQt8411 query)
		{
			int count = query.GetBlockCount(XQt8411OutBlock1.BlockName);
			List<XQt8411OutBlock1> list = new List<XQt8411OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt8411OutBlock1 block = new XQt8411OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
	...
	public partial class XQt8411 : XingQuery
	{
		...
		/// t8411
		/// </summary>
		public const string _typeName = "t8411";
		/// <summary>
		/// 주식챠트(틱/n틱)(t8411)
		/// </summary>
		public const string _typeDesc = "주식챠트(틱/n틱)(t8411)";
		/// <summary>
		/// 
		/// </summary>
		...
		{
			public XQt8411OutBlock OutBlock { get; internal set; }
			public XQt8411OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt8411 instance = new XQt8411())
			{
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.shcode, 0, shcode); // char 6
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.ncnt, 0, ncnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.qrycnt, 0, qrycnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.nday, 0, nday.ToString()); // char 1
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.sdate, 0, sdate); // char 8
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.stime, 0, stime); // char 6
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.edate, 0, edate); // char 8
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.etime, 0, etime); // char 6
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.cts_date, 0, cts_date); // char 8
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.cts_time, 0, cts_time); // char 10
				instance.SetFieldData(XQt8411InBlock.BlockName, XQt8411InBlock.F.comp_yn, 0, comp_yn.ToString()); // char 1
		...
		public static XQAllOutBlocks ReadFromDB(/* string shcode = default,long ncnt = default,long qrycnt = default,char nday = default,string sdate = default,string stime = default,string edate = default,string etime = default,string cts_date = default,string cts_time = default,char comp_yn = default */)
		{
			using (XQt8411 instance = new XQt8411())
			{
				...
				QueryOption qo = new QueryOption("XQt8411OutBlock");
				results.OutBlock = instance.Select<XQt8411OutBlock>(qo);

				qo = new QueryOption("XQt8411OutBlock1");
				results.OutBlock1 = instance.SelectMany<XQt8411OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt8411InBlock block)
		{
		...
		public XQt8411OutBlock GetBlock()
		{
			XQt8411OutBlock instance = XQt8411OutBlock.FromQuery(this);
			return instance;

		}

		public XQt8411OutBlock1[] GetBlock1s()
		{
			XQt8411OutBlock1[] instance = XQt8411OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt8411OutBlock),
			typeof(XQt8411OutBlock1),
