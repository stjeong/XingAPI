...
namespace XingAPINet
{
	public partial class XQt3401InBlock : XingBlock
	{
		...
		public void CopyTo(XQt3401InBlock block)
		{
	...
	public partial class XQt3401OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt3401OutBlock block)
		{
			block.cts_date = this.cts_date;
	...
	public partial class XQt3401OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQt3401OutBlock1 block)
		{
			block.shcode = this.shcode;
			block.tradno = this.tradno;
			block.date = this.date;
			block.tradname = this.tradname;
			block.bopn = this.bopn;
			block.nopn = this.nopn;
			block.boga = this.boga;
			block.noga = this.noga;
	...
	public partial class XQt3401 : XingQuery
	{
		...
		{
			public XQt3401OutBlock OutBlock { get; internal set; }
			public XQt3401OutBlock1[] OutBlock1 { get; internal set; }
		}

		public static XQAllOutBlocks Get(string shcode = default,char gubun1 = default,string tradno = default,string cts_date = default)
		{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string shcode = default,char gubun1 = default,string tradno = default,string cts_date = default */)
		{
			using (XQt3401 instance = new XQt3401())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt3401OutBlock" : $"XQt3401OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt3401OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt3401OutBlock1" : $"XQt3401OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt3401OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt3401OutBlock),
			typeof(XQt3401OutBlock1),
