...
namespace XingAPINet
{
	public partial class XQCSPAQ12200InBlock1 : XingBlock
	{
		...
		/// CSPAQ12200InBlock1
		/// </summary>
		static readonly string _blockName = "CSPAQ12200InBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
	...
	public partial class XQCSPAQ12200OutBlock1 : XingBlock
	{
		...
		/// CSPAQ12200OutBlock1
		/// </summary>
		static readonly string _blockName = "CSPAQ12200OutBlock1";
		/// <summary>
		/// In(*EMPTY*)
		/// </summary>
		static readonly string _blockDesc = "In(*EMPTY*)";
	...
	public partial class XQCSPAQ12200OutBlock2 : XingBlock
	{
		...
		/// CSPAQ12200OutBlock2
		/// </summary>
		static readonly string _blockName = "CSPAQ12200OutBlock2";
		/// <summary>
		/// Out(*EMPTY*)
		/// </summary>
		...
		/// 증거금률35%주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("증거금률35%주문가능금액")]
		public long MgnRat35ordAbleAmt;
		/// <summary>
		/// 증거금률50%주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("증거금률50%주문가능금액")]
		public long MgnRat50ordAbleAmt;
		/// <summary>
		/// 전일매도정산금액
		/// </summary>
		[XAQueryFieldAttribute("전일매도정산금액")]
		public long PrdaySellAdjstAmt;
		/// <summary>
		/// 전일매수정산금액
		/// </summary>
		[XAQueryFieldAttribute("전일매수정산금액")]
		public long PrdayBuyAdjstAmt;
		/// <summary>
		/// 금일매도정산금액
		/// </summary>
		[XAQueryFieldAttribute("금일매도정산금액")]
		public long CrdaySellAdjstAmt;
		/// <summary>
		/// 금일매수정산금액
		/// </summary>
		[XAQueryFieldAttribute("금일매수정산금액")]
		public long CrdayBuyAdjstAmt;
		/// <summary>
		/// D1연체변제소요금액
		/// </summary>
		[XAQueryFieldAttribute("D1연체변제소요금액")]
		public long D1ovdRepayRqrdAmt;
		/// <summary>
		/// D2연체변제소요금액
		/// </summary>
		[XAQueryFieldAttribute("D2연체변제소요금액")]
		public long D2ovdRepayRqrdAmt;
		/// <summary>
		/// D1추정인출가능금액
		/// </summary>
		[XAQueryFieldAttribute("D1추정인출가능금액")]
		public long D1PrsmptWthdwAbleAmt;
		/// <summary>
		/// D2추정인출가능금액
		/// </summary>
		[XAQueryFieldAttribute("D2추정인출가능금액")]
		...
		/// 신용설정보증금
		/// </summary>
		[XAQueryFieldAttribute("신용설정보증금")]
		public long Imreq;
		/// <summary>
		/// 융자금액
		/// </summary>
		[XAQueryFieldAttribute("융자금액")]
		public long MloanAmt;
		/// <summary>
		/// 변경후담보비율
		/// </summary>
		[XAQueryFieldAttribute("변경후담보비율")]
		public double ChgAfPldgRat;
		/// <summary>
		/// 원담보금액
		/// </summary>
		[XAQueryFieldAttribute("원담보금액")]
		public long OrgPldgAmt;
		/// <summary>
		/// 부담보금액
		/// </summary>
		[XAQueryFieldAttribute("부담보금액")]
		public long SubPldgAmt;
		/// <summary>
		/// 소요담보금액
		/// </summary>
		[XAQueryFieldAttribute("소요담보금액")]
		public long RqrdPldgAmt;
		/// <summary>
		/// 원담보부족금액
		/// </summary>
		[XAQueryFieldAttribute("원담보부족금액")]
		public long OrgPdlckAmt;
		/// <summary>
		/// 담보부족금액
		/// </summary>
		[XAQueryFieldAttribute("담보부족금액")]
		public long PdlckAmt;
		/// <summary>
		/// 추가담보현금
		/// </summary>
		[XAQueryFieldAttribute("추가담보현금")]
		public long AddPldgMny;
		/// <summary>
		/// D1주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("D1주문가능금액")]
		public long D1OrdAbleAmt;
		/// <summary>
		/// 신용이자미납금액
		/// </summary>
		[XAQueryFieldAttribute("신용이자미납금액")]
		...
		/// 익일추정반대매매금액
		/// </summary>
		[XAQueryFieldAttribute("익일추정반대매매금액")]
		public long NtdayPrsmptCvrgAmt;
		/// <summary>
		/// 원담보합계금액
		/// </summary>
		[XAQueryFieldAttribute("원담보합계금액")]
		public long OrgPldgSumAmt;
		/// <summary>
		/// 신용주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("신용주문가능금액")]
		public long CrdtOrdAbleAmt;
		/// <summary>
		/// 부담보합계금액
		/// </summary>
		[XAQueryFieldAttribute("부담보합계금액")]
		public long SubPldgSumAmt;
		/// <summary>
		/// 신용담보금현금
		/// </summary>
		[XAQueryFieldAttribute("신용담보금현금")]
		public long CrdtPldgAmtMny;
		/// <summary>
		/// 신용담보대용금액
		/// </summary>
		[XAQueryFieldAttribute("신용담보대용금액")]
		public long CrdtPldgSubstAmt;
		/// <summary>
		/// 추가신용담보현금
		/// </summary>
		[XAQueryFieldAttribute("추가신용담보현금")]
		...
		/// 추가신용담보대용
		/// </summary>
		[XAQueryFieldAttribute("추가신용담보대용")]
		public long AddCrdtPldgSubst;
		/// <summary>
		/// 매도대금담보대출금액
		/// </summary>
		[XAQueryFieldAttribute("매도대금담보대출금액")]
		public long CslLoanAmtdt1;
		/// <summary>
		/// 처분제한금액
		/// </summary>
		[XAQueryFieldAttribute("처분제한금액")]
	...
	public partial class XQCSPAQ12200 : XingQuery
	{
		...
		/// CSPAQ12200
		/// </summary>
		static readonly string _typeName = "CSPAQ12200";
		/// <summary>
		/// 현물계좌예수금 주문가능금액 총평가 조회
		/// </summary>
		static readonly string _typeDesc = "현물계좌예수금 주문가능금액 총평가 조회";
		/// <summary>
		/// CSPAQ12200
		/// </summary>
		static readonly string _service = "CSPAQ12200";
		/// <summary>
		/// B
		/// </summary>
		...
		/// 2015/04/13 08:41:27
		/// </summary>
		static readonly string _createdDate = "2015/04/13 08:41:27";
		/// <summary>
		/// false
		/// </summary>
