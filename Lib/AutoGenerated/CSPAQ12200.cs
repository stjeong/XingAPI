...
namespace XingAPINet
{
	public partial class XQCSPAQ12200InBlock1 : XingBlock
	{
		...
		public void CopyTo(XQCSPAQ12200InBlock1 block)
		{
	...
	public partial class XQCSPAQ12200OutBlock1 : XingBlock
	{
		...
		public void CopyTo(XQCSPAQ12200OutBlock1 block)
		{
			block.RecCnt = this.RecCnt;
			block.MgmtBrnNo = this.MgmtBrnNo;
			block.AcntNo = this.AcntNo;
	...
	public partial class XQCSPAQ12200OutBlock2 : XingBlock
	{
		...
		/// D1추정인출가능금액
		/// </summary>
		[XAQueryFieldAttribute("D1PrsmptWthdwAbleAmt", "D1추정인출가능금액", "long", "16")]
		public long D1PrsmptWthdwAbleAmt;
		/// <summary>
		/// D2추정인출가능금액
		/// </summary>
		[XAQueryFieldAttribute("D2PrsmptWthdwAbleAmt", "D2추정인출가능금액", "long", "16")]
		...
		/// 원담보금액
		/// </summary>
		[XAQueryFieldAttribute("OrgPldgAmt", "원담보금액", "long", "16")]
		public long OrgPldgAmt;
		/// <summary>
		/// 부담보금액
		/// </summary>
		[XAQueryFieldAttribute("SubPldgAmt", "부담보금액", "long", "16")]
		...
		/// 원담보부족금액
		/// </summary>
		[XAQueryFieldAttribute("OrgPdlckAmt", "원담보부족금액", "long", "16")]
		...
		/// 추가담보현금
		/// </summary>
		[XAQueryFieldAttribute("AddPldgMny", "추가담보현금", "long", "16")]
		public long AddPldgMny;
		/// <summary>
		/// D1주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("D1OrdAbleAmt", "D1주문가능금액", "long", "16")]
		public long D1OrdAbleAmt;
		/// <summary>
		/// 신용이자미납금액
		/// </summary>
		[XAQueryFieldAttribute("CrdtIntdltAmt", "신용이자미납금액", "long", "16")]
		...
		/// 익일추정반대매매금액
		/// </summary>
		[XAQueryFieldAttribute("NtdayPrsmptCvrgAmt", "익일추정반대매매금액", "long", "16")]
		...
		/// 추가신용담보현금
		/// </summary>
		[XAQueryFieldAttribute("AddCrdtPldgMny", "추가신용담보현금", "long", "16")]
		...
		/// 추가신용담보대용
		/// </summary>
		[XAQueryFieldAttribute("AddCrdtPldgSubst", "추가신용담보대용", "long", "16")]
		...
		public void CopyTo(XQCSPAQ12200OutBlock2 block)
		{
			block.RecCnt = this.RecCnt;
			...
			block.D1PrsmptWthdwAbleAmt = this.D1PrsmptWthdwAbleAmt;
			block.D2PrsmptWthdwAbleAmt = this.D2PrsmptWthdwAbleAmt;
			...
			block.OrgPldgAmt = this.OrgPldgAmt;
			block.SubPldgAmt = this.SubPldgAmt;
			block.RqrdPldgAmt = this.RqrdPldgAmt;
			block.OrgPdlckAmt = this.OrgPdlckAmt;
			block.PdlckAmt = this.PdlckAmt;
			block.AddPldgMny = this.AddPldgMny;
			block.D1OrdAbleAmt = this.D1OrdAbleAmt;
			block.CrdtIntdltAmt = this.CrdtIntdltAmt;
			block.EtclndAmt = this.EtclndAmt;
			block.NtdayPrsmptCvrgAmt = this.NtdayPrsmptCvrgAmt;
			...
			block.AddCrdtPldgMny = this.AddCrdtPldgMny;
			block.CrdtPldgRuseAmt = this.CrdtPldgRuseAmt;
			block.AddCrdtPldgSubst = this.AddCrdtPldgSubst;
