...
namespace XingAPINet
{
	public partial class XQt1422InBlock : XingBlock
	{
		...
		/// 조회구분
		/// </summary>
		[XAQueryFieldAttribute("qrygb", "조회구분", "char", "1")]
		public char qrygb;
		/// <summary>
		/// 구분
		/// </summary>
		...
		/// 상하한구분
		/// </summary>
		[XAQueryFieldAttribute("sign", "상하한구분", "char", "1")]
		public char sign;
		/// <summary>
		/// 대상제외
		/// </summary>
	...
	public partial class XQt1422OutBlock1 : XingBlock
	{
		...
		/// 최종진입
		/// </summary>
		[XAQueryFieldAttribute("last", "최종진입", "char", "6")]
		public string last;
		/// <summary>
		/// 연속
		/// </summary>
		[XAQueryFieldAttribute("lmtdaycnt", "연속", "long", "8")]
	...
	public partial class XQt1422 : XingQuery
	{
		...
		{
			public XQt1422OutBlock OutBlock { get; internal set; }
			public XQt1422OutBlock1[] OutBlock1 { get; internal set; }
		}

		public static XQAllOutBlocks Get(char qrygb = default,char gubun = default,char jnilgubun = default,char sign = default,long jc_num = default,long sprice = default,long eprice = default,long volume = default,long idx = default)
		{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char qrygb = default,char gubun = default,char jnilgubun = default,char sign = default,long jc_num = default,long sprice = default,long eprice = default,long volume = default,long idx = default */)
		{
			using (XQt1422 instance = new XQt1422())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1422OutBlock" : $"XQt1422OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1422OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1422OutBlock1" : $"XQt1422OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1422OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1422OutBlock),
			typeof(XQt1422OutBlock1),
