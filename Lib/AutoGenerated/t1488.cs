...
namespace XingAPINet
{
	public partial class XQt1488InBlock : XingBlock
	{
		...
		/// 거래소구분
		/// </summary>
		[XAQueryFieldAttribute("거래소구분", "1")]
		public char gubun;
		/// <summary>
		/// 상하락구분
		/// </summary>
		[XAQueryFieldAttribute("상하락구분", "1")]
		public char sign;
		/// <summary>
		/// 장구분
		/// </summary>
		...
		/// 거래량
		/// </summary>
		[XAQueryFieldAttribute("거래량", "1")]
		public char volume;
		/// <summary>
		/// 예상체결시작가격
		/// </summary>
		[XAQueryFieldAttribute("예상체결시작가격", "8")]
		public long yesprice;
		/// <summary>
		/// 예상체결종료가격
		/// </summary>
		[XAQueryFieldAttribute("예상체결종료가격", "8")]
	...
	public partial class XQt1488OutBlock1 : XingBlock
	{
		...
		/// 매수잔량
		/// </summary>
		[XAQueryFieldAttribute("매수잔량", "8")]
		public long bidrem;
		/// <summary>
		/// 연속일수
		/// </summary>
		[XAQueryFieldAttribute("연속일수", "4")]
		public long cnt;
		/// <summary>
		/// 종목코드
		/// </summary>
