...
namespace XingAPINet
{
	public partial class XQt1636InBlock : XingBlock
	{
		...
		/// 정렬기준
		/// </summary>
		[XAQueryFieldAttribute("gubun2", "정렬기준", "char", "1")]
		public char gubun2;
		/// <summary>
		/// 종목코드
		/// </summary>
		...
		/// IDXCTS
		/// </summary>
		[XAQueryFieldAttribute("cts_idx", "IDXCTS", "long", "4")]
		public long cts_idx;
		...
		public void CopyTo(XQt1636InBlock block)
		{
	...
	public partial class XQt1636OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1636OutBlock block)
		{
			block.cts_idx = this.cts_idx;
	...
	public partial class XQt1636OutBlock1 : XingBlock
	{
		...
		/// 순위
		/// </summary>
		[XAQueryFieldAttribute("rank", "순위", "long", "8")]
		public long rank;
		/// <summary>
		/// 종목명
		/// </summary>
		...
		/// 매수금액
		/// </summary>
		[XAQueryFieldAttribute("stksvalue", "매수금액", "long", "12")]
		public long stksvalue;
		/// <summary>
		/// 순매수수량
		/// </summary>
		[XAQueryFieldAttribute("svolume", "순매수수량", "long", "12")]
		public long svolume;
		/// <summary>
		/// 매도수량
		/// </summary>
		[XAQueryFieldAttribute("offervolume", "매도수량", "long", "12")]
		public long offervolume;
		/// <summary>
		/// 매수수량
		/// </summary>
		[XAQueryFieldAttribute("stksvolume", "매수수량", "long", "12")]
		public long stksvolume;
		/// <summary>
		/// 시가총액
		/// </summary>
		[XAQueryFieldAttribute("sgta", "시가총액", "long", "15")]
		public long sgta;
		/// <summary>
		/// 비중
		/// </summary>
		...
		public void CopyTo(XQt1636OutBlock1 block)
		{
			...
			block.stksvalue = this.stksvalue;
			block.svolume = this.svolume;
			block.offervolume = this.offervolume;
			block.stksvolume = this.stksvolume;
			block.sgta = this.sgta;
	...
	public partial class XQt1636 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,char gubun1 = default,char gubun2 = default,string shcode = default,long cts_idx = default */)
		{
			using (XQt1636 instance = new XQt1636())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1636OutBlock" : $"XQt1636OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1636OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1636OutBlock1" : $"XQt1636OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1636OutBlock1>(qo);
				return results;
			}
		}
