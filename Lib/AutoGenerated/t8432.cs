...
namespace XingAPINet
{
	public partial class XQt8432InBlock : XingBlock
	{
		...
		public void CopyTo(XQt8432InBlock block)
		{
	...
	public partial class XQt8432OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt8432OutBlock block)
		{
	...
	public partial class XQt8432 : XingQuery
	{
		...
		public static XQt8432OutBlock[] Get(char gubun = default)
		{
			using (XQt8432 instance = new XQt8432())
			{
				instance.SetFieldData(XQt8432InBlock.BlockName, XQt8432InBlock.F.gubun, 0, gubun.ToString()); // char 1
