...
namespace XingAPINet
{
	public partial class XQt8432InBlock : XingBlock
	{
		...
		/// t8432InBlock
		/// </summary>
		static readonly string _blockName = "t8432InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8432OutBlock : XingBlock
	{
		...
		/// t8432OutBlock
		/// </summary>
		static readonly string _blockName = "t8432OutBlock";
		/// <summary>
		/// 주식종목마스터
		/// </summary>
	...
	public partial class XQt8432 : XingQuery
	{
		...
		/// t8432
		/// </summary>
		static readonly string _typeName = "t8432";
		/// <summary>
		/// 지수선물마스터조회API용(t8432)
		/// </summary>
		static readonly string _typeDesc = "지수선물마스터조회API용(t8432)";
		/// <summary>
		/// 
		/// </summary>
