...
{
	public partial class XQt2804InBlock : XingBlock
	{
		/// <summary>
		/// t2804InBlock
		/// </summary>
		...
		/// 시간CTS
		/// </summary>
		[XAQueryFieldAttribute("시간CTS", "10")]
	...
	public partial class XQt2804OutBlock : XingBlock
	{
		/// <summary>
		/// t2804OutBlock
		/// </summary>
		...
		public static XQt2804OutBlock FromQuery(XQt2804 query)
		{
			XQt2804OutBlock block = new XQt2804OutBlock();
	...
	public partial class XQt2804OutBlock1 : XingBlock
	{
		/// <summary>
		/// t2804OutBlock1
		/// </summary>
		...
		/// 시간24
		/// </summary>
		[XAQueryFieldAttribute("시간24", "10")]
		public string chetime24;
		/// <summary>
		/// 현재가
		/// </summary>
		...
		/// 매도호가
		/// </summary>
		[XAQueryFieldAttribute("매도호가", "6.2")]
		public float offerho;
		/// <summary>
		/// 매수호가
		/// </summary>
		[XAQueryFieldAttribute("매수호가", "6.2")]
		public float bidho;
		/// <summary>
		/// 거래량
		/// </summary>
		[XAQueryFieldAttribute("거래량", "12.0")]
		...
		/// 미결전일증감
		/// </summary>
		[XAQueryFieldAttribute("미결전일증감", "8")]
		public long jnilopenupdn;
		/// <summary>
		/// 이론BASIS
		/// </summary>
		[XAQueryFieldAttribute("이론BASIS", "6.2")]
		public float ibasis;
		/// <summary>
		/// 시장BASIS
		/// </summary>
		[XAQueryFieldAttribute("시장BASIS", "6.2")]
		public float sbasis;
		/// <summary>
		/// 괴리율
		/// </summary>
		...
		/// 거래대금
		/// </summary>
		[XAQueryFieldAttribute("거래대금", "12.0")]
		public double value;
		/// <summary>
		/// 미결직전증감
		/// </summary>
		[XAQueryFieldAttribute("미결직전증감", "8")]
		public long j_openupdn;
		/// <summary>
		/// 누적매수체결량
		/// </summary>
		[XAQueryFieldAttribute("누적매수체결량", "12.0")]
		public double n_msvolume;
		/// <summary>
		/// 누적매도체결량
		/// </summary>
		[XAQueryFieldAttribute("누적매도체결량", "12.0")]
		public double n_mdvolume;
		/// <summary>
		/// 누적순매수체결량
		/// </summary>
		[XAQueryFieldAttribute("누적순매수체결량", "12.0")]
		public double s_msvolume;
		/// <summary>
		/// 누적매수체결건수
		/// </summary>
		[XAQueryFieldAttribute("누적매수체결건수", "8")]
		public long n_mschecnt;
		/// <summary>
		/// 누적매도체결건수
		/// </summary>
		[XAQueryFieldAttribute("누적매도체결건수", "8")]
		public long n_mdchecnt;
		/// <summary>
		/// 누적순매수체결건수
		/// </summary>
		[XAQueryFieldAttribute("누적순매수체결건수", "8")]
		...
		public static class F
		{
			...
			/// 시간24
			/// </summary>
			public const string chetime24 = "chetime24";
			/// <summary>
			/// 현재가
			/// </summary>
		...
		public override Dictionary<string, XAQueryFieldInfo> GetFieldsInfo()
		{
			...
			dict["chetime24"] = new XAQueryFieldInfo("char", chetime24, chetime24, "시간24", (decimal)10);
		...
		public override void SetFieldValue(string fieldName, XAQueryFieldInfo fieldInfo)
		{
			switch (fieldName)
			{
				...
				case "chetime24":
					this.chetime24 = fieldInfo.FieldValue.TrimEnd('?');
				break;
		...
		public static XQt2804OutBlock1[] ListFromQuery(XQt2804 query)
		{
			int count = query.GetBlockCount(XQt2804OutBlock1.BlockName);
			List<XQt2804OutBlock1> list = new List<XQt2804OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt2804OutBlock1 block = new XQt2804OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
					block.chetime = query.GetFieldData(block.GetBlockName(), "chetime", i).TrimEnd('?'); // char 10
					block.chetime24 = query.GetFieldData(block.GetBlockName(), "chetime24", i).TrimEnd('?'); // char 10
	...
	public partial class XQt2804 : XingQuery
	{
		...
		public static XQAllOutBlocks Get(string focode = default,long cvolume = default,string stime = default,string etime = default,string cts_time = default)
		{
			...
			{
				instance.SetFieldData(XQt2804InBlock.BlockName, XQt2804InBlock.F.focode, 0, focode); // char 8
				instance.SetFieldData(XQt2804InBlock.BlockName, XQt2804InBlock.F.cvolume, 0, cvolume.ToString("d12")); // long 12
				instance.SetFieldData(XQt2804InBlock.BlockName, XQt2804InBlock.F.stime, 0, stime); // char 4
				instance.SetFieldData(XQt2804InBlock.BlockName, XQt2804InBlock.F.etime, 0, etime); // char 4
				instance.SetFieldData(XQt2804InBlock.BlockName, XQt2804InBlock.F.cts_time, 0, cts_time); // char 10
		...
		public bool SetBlock(XQt2804InBlock block)
		{
		...
		public XQt2804OutBlock GetBlock()
		{
			XQt2804OutBlock instance = XQt2804OutBlock.FromQuery(this);
			return instance;

		}

		public XQt2804OutBlock1[] GetBlock1s()
		{
			XQt2804OutBlock1[] instance = XQt2804OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt2804OutBlock),
			typeof(XQt2804OutBlock1),
