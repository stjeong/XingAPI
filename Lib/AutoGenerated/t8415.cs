...
namespace XingAPINet
{
	public partial class XQt8415InBlock : XingBlock
	{
		...
		/// 조회영업일수(0:미사용1>=사용)
		/// </summary>
		[XAQueryFieldAttribute("조회영업일수(0:미사용1>=사용)", "1")]
		public char nday;
		/// <summary>
		/// 시작일자
		/// </summary>
		...
		/// 시작시간(현재미사용)
		/// </summary>
		[XAQueryFieldAttribute("시작시간(현재미사용)", "6")]
		public string stime;
		/// <summary>
		/// 종료일자
		/// </summary>
		...
		/// 종료시간(현재미사용)
		/// </summary>
		[XAQueryFieldAttribute("종료시간(현재미사용)", "6")]
		public string etime;
		/// <summary>
		/// 연속일자
		/// </summary>
	...
	public partial class XQt8415OutBlock : XingBlock
	{
		...
		/// 전일시가
		/// </summary>
		[XAQueryFieldAttribute("전일시가", "6.2")]
		public float jisiga;
		/// <summary>
		/// 전일고가
		/// </summary>
		...
		/// 당일시가
		/// </summary>
		[XAQueryFieldAttribute("당일시가", "6.2")]
		public float disiga;
		/// <summary>
		/// 당일고가
		/// </summary>
		[XAQueryFieldAttribute("당일고가", "6.2")]
		public float dihigh;
		/// <summary>
		/// 당일저가
		/// </summary>
		[XAQueryFieldAttribute("당일저가", "6.2")]
		public float dilow;
		/// <summary>
		/// 당일종가
		/// </summary>
		[XAQueryFieldAttribute("당일종가", "6.2")]
	...
	public partial class XQt8415OutBlock1 : XingBlock
	{
		...
		/// 미결제약정
		/// </summary>
		[XAQueryFieldAttribute("미결제약정", "12")]
		public long openyak;
