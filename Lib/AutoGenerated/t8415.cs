...
{
	public partial class XQt8415InBlock : XingBlock
	{
		/// <summary>
		/// t8415InBlock
		/// </summary>
		public const string _blockName = "t8415InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8415OutBlock : XingBlock
	{
		/// <summary>
		/// t8415OutBlock
		/// </summary>
		public const string _blockName = "t8415OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		public static XQt8415OutBlock FromQuery(XQt8415 query)
		{
			XQt8415OutBlock block = new XQt8415OutBlock();
	...
	public partial class XQt8415OutBlock1 : XingBlock
	{
		...
		/// t8415OutBlock1
		/// </summary>
		public const string _blockName = "t8415OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 누적거래량
		/// </summary>
		[XAQueryFieldAttribute("jdiff_vol", "누적거래량", "long", "12")]
		...
		public static XQt8415OutBlock1[] ListFromQuery(XQt8415 query)
		{
			int count = query.GetBlockCount(XQt8415OutBlock1.BlockName);
			List<XQt8415OutBlock1> list = new List<XQt8415OutBlock1>();
			if (query.QueryResult != null && query.QueryResult.IsSystemError == true)
			{
				return list.ToArray();
			}
			...
			{
				XQt8415OutBlock1 block = new XQt8415OutBlock1();
				block.IsValidData = true;
				block.InvalidReason = "";
				try
				{
	...
	public partial class XQt8415 : XingQuery
	{
		...
		/// t8415
		/// </summary>
		public const string _typeName = "t8415";
		/// <summary>
		/// 선물/옵션챠트(N분)(t8415)
		/// </summary>
		public const string _typeDesc = "선물/옵션챠트(N분)(t8415)";
		/// <summary>
		/// 
		/// </summary>
		...
		/// 선물/옵션챠트(N분)(t8415)
		/// </summary>
		public XQt8415() : base("t8415") { }


		public class XQAllOutBlocks
		{
			public XQt8415OutBlock OutBlock { get; internal set; }
			public XQt8415OutBlock1[] OutBlock1 { get; internal set; }
		}
		...
		{
			using (XQt8415 instance = new XQt8415())
			{
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.shcode, 0, shcode); // char 8
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.ncnt, 0, ncnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.qrycnt, 0, qrycnt.ToString("d4")); // long 4
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.nday, 0, nday.ToString()); // char 1
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.sdate, 0, sdate); // char 8
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.stime, 0, stime); // char 6
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.edate, 0, edate); // char 8
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.etime, 0, etime); // char 6
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.cts_date, 0, cts_date); // char 8
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.cts_time, 0, cts_time); // char 10
				instance.SetFieldData(XQt8415InBlock.BlockName, XQt8415InBlock.F.comp_yn, 0, comp_yn.ToString()); // char 1
		...
		public static XQAllOutBlocks ReadFromDB(/* string shcode = default,long ncnt = default,long qrycnt = default,char nday = default,string sdate = default,string stime = default,string edate = default,string etime = default,string cts_date = default,string cts_time = default,char comp_yn = default */)
		{
			using (XQt8415 instance = new XQt8415())
			{
				...
				QueryOption qo = new QueryOption("XQt8415OutBlock");
				results.OutBlock = instance.Select<XQt8415OutBlock>(qo);

				qo = new QueryOption("XQt8415OutBlock1");
				results.OutBlock1 = instance.SelectMany<XQt8415OutBlock1>(qo);
				return results;
			}
		}

		public bool SetBlock(XQt8415InBlock block)
		{
		...
		public XQt8415OutBlock GetBlock()
		{
			XQt8415OutBlock instance = XQt8415OutBlock.FromQuery(this);
			return instance;

		}

		public XQt8415OutBlock1[] GetBlock1s()
		{
			XQt8415OutBlock1[] instance = XQt8415OutBlock1.ListFromQuery(this);
			return instance;
		...
		{
			typeof(XQt8415OutBlock),
			typeof(XQt8415OutBlock1),
