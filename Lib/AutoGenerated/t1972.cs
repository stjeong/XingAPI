...
namespace XingAPINet
{
	public partial class XQt1972InBlock : XingBlock
	{
		...
		/// t1972InBlock
		/// </summary>
		static readonly string _blockName = "t1972InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt1972OutBlock : XingBlock
	{
		...
		/// t1972OutBlock
		/// </summary>
		static readonly string _blockName = "t1972OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
		...
		/// 외국계매도합계비율
		/// </summary>
		[XAQueryFieldAttribute("외국계매도합계비율")]
		public float fwddiff;
		/// <summary>
		/// 외국계매수합계비율
		/// </summary>
		[XAQueryFieldAttribute("외국계매수합계비율")]
	...
	public partial class XQt1972 : XingQuery
	{
		...
		/// t1972
		/// </summary>
		static readonly string _typeName = "t1972";
		/// <summary>
		/// ELW현재가(거래원)조회(t1972)
		/// </summary>
		static readonly string _typeDesc = "ELW현재가(거래원)조회(t1972)";
		/// <summary>
		/// 
		/// </summary>
