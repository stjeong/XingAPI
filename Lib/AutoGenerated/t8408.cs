...
{
	public partial class XQt8408InBlock : XingBlock
	{
		/// <summary>
		/// t8408InBlock
		/// </summary>
		public const string _blockName = "t8408InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
		...
		/// 챠트구분
		/// </summary>
		[XAQueryFieldAttribute("챠트구분", "1")]
		public char cgubun;
		/// <summary>
		/// 분구분
		/// </summary>
		[XAQueryFieldAttribute("분구분", "3")]
		public int bgubun;
		/// <summary>
		/// 조회건수
		/// </summary>
	...
	public partial class XQt8408OutBlock1 : XingBlock
	{
		/// <summary>
		/// t8408OutBlock1
		/// </summary>
		public const string _blockName = "t8408OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 매수순간체결건수
		/// </summary>
		[XAQueryFieldAttribute("매수순간체결건수", "8")]
		public long s_mschecnt;
		/// <summary>
		/// 매도순간체결건수
		/// </summary>
		[XAQueryFieldAttribute("매도순간체결건수", "8")]
		public long s_mdchecnt;
		/// <summary>
		/// 순매수순간체결건수
		/// </summary>
		[XAQueryFieldAttribute("순매수순간체결건수", "8")]
		public long ss_mschecnt;
		/// <summary>
		/// 매수순간체결량
		/// </summary>
		[XAQueryFieldAttribute("매수순간체결량", "12.0")]
		public double s_mschevol;
		/// <summary>
		/// 매도순간체결량
		/// </summary>
		[XAQueryFieldAttribute("매도순간체결량", "12.0")]
		public double s_mdchevol;
		/// <summary>
		/// 순매수순간체결량
		/// </summary>
		[XAQueryFieldAttribute("순매수순간체결량", "12.0")]
		...
		public static XQt8408OutBlock1[] ListFromQuery(XQt8408 query)
		{
			int count = query.GetBlockCount(XQt8408OutBlock1.BlockName);
			List<XQt8408OutBlock1> list = new List<XQt8408OutBlock1>();
			...
			{
				XQt8408OutBlock1 block = new XQt8408OutBlock1();
	...
	public partial class XQt8408 : XingQuery
	{
		...
		/// t8408
		/// </summary>
		public const string _typeName = "t8408";
		/// <summary>
		/// CME야간선물틱분별체결조회(API용)(t8408)
		/// </summary>
		public const string _typeDesc = "CME야간선물틱분별체결조회(API용)(t8408)";
		/// <summary>
		/// 
		/// </summary>
		...
		public static XQt8408OutBlock1[] Get(string focode = default,char cgubun = default,int bgubun = default,int cnt = default)
		{
			using (XQt8408 instance = new XQt8408())
			{
				instance.SetFieldData(XQt8408InBlock.BlockName, XQt8408InBlock.F.focode, 0, focode); // char 8
				instance.SetFieldData(XQt8408InBlock.BlockName, XQt8408InBlock.F.cgubun, 0, cgubun.ToString()); // char 1
				instance.SetFieldData(XQt8408InBlock.BlockName, XQt8408InBlock.F.bgubun, 0, bgubun.ToString("d3")); // int 3
				instance.SetFieldData(XQt8408InBlock.BlockName, XQt8408InBlock.F.cnt, 0, cnt.ToString("d3")); // int 3
		...
		public bool SetBlock(XQt8408InBlock block)
		{
		...
		public XQt8408OutBlock1[] GetBlock1s()
		{
			XQt8408OutBlock1[] instance = XQt8408OutBlock1.ListFromQuery(this);
			return instance;
