...
namespace XingAPINet
{
	...
	public partial class XQt0425OutBlock : XingBlock
	{
		...
		/// 총주문수량
		/// </summary>
		[XAQueryFieldAttribute("총주문수량", "18")]
		public long tqty;
		/// <summary>
		/// 총체결수량
		/// </summary>
		[XAQueryFieldAttribute("총체결수량", "18")]
		public long tcheqty;
		/// <summary>
		/// 총미체결수량
		/// </summary>
		[XAQueryFieldAttribute("총미체결수량", "18")]
		public long tordrem;
		/// <summary>
		/// 추정수수료
		/// </summary>
		[XAQueryFieldAttribute("추정수수료", "18")]
		public long cmss;
		/// <summary>
		/// 총주문금액
		/// </summary>
		[XAQueryFieldAttribute("총주문금액", "18")]
		public long tamt;
		/// <summary>
		/// 총매도체결금액
		/// </summary>
		[XAQueryFieldAttribute("총매도체결금액", "18")]
		public long tmdamt;
		/// <summary>
		/// 총매수체결금액
		/// </summary>
		[XAQueryFieldAttribute("총매수체결금액", "18")]
		public long tmsamt;
		/// <summary>
		/// 추정제세금
		/// </summary>
		[XAQueryFieldAttribute("추정제세금", "18")]
		public long tax;
		/// <summary>
		/// 주문번호
		/// </summary>
	...
	public partial class XQt0425OutBlock1 : XingBlock
	{
		...
		/// 신용구분
		/// </summary>
		[XAQueryFieldAttribute("신용구분", "2")]
		public string singb;
		/// <summary>
		/// 대출일자
		/// </summary>
		[XAQueryFieldAttribute("대출일자", "8")]
