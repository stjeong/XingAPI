...
namespace XingAPINet
{
	public partial class XQt0425InBlock : XingBlock
	{
		...
		/// 매매구분
		/// </summary>
		[XAQueryFieldAttribute("medosu", "매매구분", "char", "1")]
		public char medosu;
		/// <summary>
		/// 정렬순서
		/// </summary>
		...
		/// 주문번호
		/// </summary>
		[XAQueryFieldAttribute("cts_ordno", "주문번호", "char", "10")]
	...
	public partial class XQt0425OutBlock : XingBlock
	{
		...
		/// 총주문수량
		/// </summary>
		[XAQueryFieldAttribute("tqty", "총주문수량", "long", "18")]
		public long tqty;
		/// <summary>
		/// 총체결수량
		/// </summary>
		[XAQueryFieldAttribute("tcheqty", "총체결수량", "long", "18")]
		public long tcheqty;
		/// <summary>
		/// 총미체결수량
		/// </summary>
		[XAQueryFieldAttribute("tordrem", "총미체결수량", "long", "18")]
		public long tordrem;
		/// <summary>
		/// 추정수수료
		/// </summary>
		[XAQueryFieldAttribute("cmss", "추정수수료", "long", "18")]
		public long cmss;
		/// <summary>
		/// 총주문금액
		/// </summary>
		[XAQueryFieldAttribute("tamt", "총주문금액", "long", "18")]
		public long tamt;
		/// <summary>
		/// 총매도체결금액
		/// </summary>
		[XAQueryFieldAttribute("tmdamt", "총매도체결금액", "long", "18")]
		public long tmdamt;
		/// <summary>
		/// 총매수체결금액
		/// </summary>
		[XAQueryFieldAttribute("tmsamt", "총매수체결금액", "long", "18")]
		public long tmsamt;
		/// <summary>
		/// 추정제세금
		/// </summary>
		[XAQueryFieldAttribute("tax", "추정제세금", "long", "18")]
		public long tax;
		/// <summary>
		/// 주문번호
		/// </summary>
	...
	public partial class XQt0425OutBlock1 : XingBlock
	{
		...
		/// 주문가격
		/// </summary>
		[XAQueryFieldAttribute("price", "주문가격", "long", "9")]
		public long price;
		/// <summary>
		/// 체결수량
		/// </summary>
		...
		/// 체결가격
		/// </summary>
		[XAQueryFieldAttribute("cheprice", "체결가격", "long", "9")]
		...
		/// 확인수량
		/// </summary>
		[XAQueryFieldAttribute("cfmqty", "확인수량", "long", "9")]
		public long cfmqty;
		/// <summary>
		/// 상태
		/// </summary>
		...
		/// 호가유형
		/// </summary>
		[XAQueryFieldAttribute("hogagb", "호가유형", "char", "2")]
		public string hogagb;
		/// <summary>
		/// 현재가
		/// </summary>
		[XAQueryFieldAttribute("price1", "현재가", "long", "8")]
		public long price1;
		/// <summary>
		/// 주문구분
		/// </summary>
		[XAQueryFieldAttribute("orggb", "주문구분", "char", "2")]
		public string orggb;
		/// <summary>
		/// 신용구분
		/// </summary>
		[XAQueryFieldAttribute("singb", "신용구분", "char", "2")]
		public string singb;
		/// <summary>
		/// 대출일자
		/// </summary>
	...
	public partial class XQt0425 : XingQuery
	{
		...
		public static XQAllOutBlocks Get(string accno = default,string passwd = default,string expcode = default,char chegb = default,char medosu = default,char sortgb = default,string cts_ordno = default)
		{
			...
			{
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.accno, 0, accno); // char 11
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.passwd, 0, passwd); // char 8
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.expcode, 0, expcode); // char 12
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.chegb, 0, chegb.ToString()); // char 1
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.medosu, 0, medosu.ToString()); // char 1
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.sortgb, 0, sortgb.ToString()); // char 1
				instance.SetFieldData(XQt0425InBlock.BlockName, XQt0425InBlock.F.cts_ordno, 0, cts_ordno); // char 10
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, string accno = default,string passwd = default,string expcode = default,char chegb = default,char medosu = default,char sortgb = default,string cts_ordno = default */)
		{
			using (XQt0425 instance = new XQt0425())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt0425OutBlock" : $"XQt0425OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt0425OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt0425OutBlock1" : $"XQt0425OutBlock1_{tableNamePostfix}";
		...
		{
			typeof(XQt0425OutBlock),
			typeof(XQt0425OutBlock1),
