...
namespace XingAPINet
{
	public partial class XQt8407InBlock : XingBlock
	{
		...
		/// t8407InBlock
		/// </summary>
		static readonly string _blockName = "t8407InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8407OutBlock1 : XingBlock
	{
		...
		/// t8407OutBlock1
		/// </summary>
		static readonly string _blockName = "t8407OutBlock1";
		/// <summary>
		/// 출력1
		/// </summary>
		...
		/// 우선매도잔량
		/// </summary>
		[XAQueryFieldAttribute("우선매도잔량")]
		public long offerrem;
		/// <summary>
		/// 우선매수잔량
		/// </summary>
		[XAQueryFieldAttribute("우선매수잔량")]
		public long bidrem;
		/// <summary>
		/// 총매도잔량
		/// </summary>
		[XAQueryFieldAttribute("총매도잔량")]
		public long totofferrem;
		/// <summary>
		/// 총매수잔량
		/// </summary>
		[XAQueryFieldAttribute("총매수잔량")]
	...
	public partial class XQt8407 : XingQuery
	{
		...
		/// t8407
		/// </summary>
		static readonly string _typeName = "t8407";
		/// <summary>
		/// API용주식멀티현재가조회(t8407)
		/// </summary>
		static readonly string _typeDesc = "API용주식멀티현재가조회(t8407)";
		/// <summary>
		/// 
		/// </summary>
