...
namespace XingAPINet
{
	public partial class XQt1403InBlock : XingBlock
	{
		...
		/// 시작상장월
		/// </summary>
		[XAQueryFieldAttribute("시작상장월", "6")]
		public string styymm;
		/// <summary>
		/// 종료상장월
		/// </summary>
		[XAQueryFieldAttribute("종료상장월", "6")]
	...
	public partial class XQt1403OutBlock1 : XingBlock
	{
		...
		/// 공모가
		/// </summary>
		[XAQueryFieldAttribute("공모가", "8")]
		public long kmprice;
		/// <summary>
		/// 등록일
		/// </summary>
		[XAQueryFieldAttribute("등록일", "8")]
		public string date;
		/// <summary>
		/// 등록일기준가
		/// </summary>
		[XAQueryFieldAttribute("등록일기준가", "8")]
		public long recprice;
		/// <summary>
		/// 기준가등락율
		/// </summary>
		[XAQueryFieldAttribute("기준가등락율", "6.2")]
		public float kmdiff;
		/// <summary>
		/// 등록일종가
		/// </summary>
		[XAQueryFieldAttribute("등록일종가", "8")]
		public long close;
		/// <summary>
		/// 등록일등락율
		/// </summary>
		[XAQueryFieldAttribute("등록일등락율", "6.2")]
