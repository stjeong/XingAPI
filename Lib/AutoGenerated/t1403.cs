...
namespace XingAPINet
{
	public partial class XQt1403InBlock : XingBlock
	{
		...
		/// 시작상장월
		/// </summary>
		[XAQueryFieldAttribute("styymm", "시작상장월", "char", "6")]
		public string styymm;
		/// <summary>
		/// 종료상장월
		/// </summary>
		[XAQueryFieldAttribute("enyymm", "종료상장월", "char", "6")]
		...
		public void CopyTo(XQt1403InBlock block)
		{
			block.gubun = this.gubun;
			block.styymm = this.styymm;
			block.enyymm = this.enyymm;
			block.idx = this.idx;
	...
	public partial class XQt1403OutBlock : XingBlock
	{
		...
		public void CopyTo(XQt1403OutBlock block)
		{
			block.idx = this.idx;
	...
	public partial class XQt1403OutBlock1 : XingBlock
	{
		...
		/// 공모가
		/// </summary>
		[XAQueryFieldAttribute("kmprice", "공모가", "long", "8")]
		public long kmprice;
		/// <summary>
		/// 등록일
		/// </summary>
		[XAQueryFieldAttribute("date", "등록일", "char", "8")]
		public string date;
		/// <summary>
		/// 등록일기준가
		/// </summary>
		[XAQueryFieldAttribute("recprice", "등록일기준가", "long", "8")]
		public long recprice;
		/// <summary>
		/// 기준가등락율
		/// </summary>
		[XAQueryFieldAttribute("kmdiff", "기준가등락율", "float", "6.2")]
		public float kmdiff;
		/// <summary>
		/// 등록일종가
		/// </summary>
		[XAQueryFieldAttribute("close", "등록일종가", "long", "8")]
		public long close;
		/// <summary>
		/// 등록일등락율
		/// </summary>
		[XAQueryFieldAttribute("recdiff", "등록일등락율", "float", "6.2")]
		...
		public void CopyTo(XQt1403OutBlock1 block)
		{
			...
			block.kmprice = this.kmprice;
			block.date = this.date;
			block.recprice = this.recprice;
			block.kmdiff = this.kmdiff;
			block.close = this.close;
			block.recdiff = this.recdiff;
	...
	public partial class XQt1403 : XingQuery
	{
		...
		public static XQAllOutBlocks ReadFromDB(string tableNamePostfix = null /*, char gubun = default,string styymm = default,string enyymm = default,long idx = default */)
		{
			using (XQt1403 instance = new XQt1403())
			{
				...
				string tableName = (tableNamePostfix == null) ? "XQt1403OutBlock" : $"XQt1403OutBlock_{tableNamePostfix}";
				QueryOption qo = new QueryOption(tableName);
				results.OutBlock = instance.Select<XQt1403OutBlock>(qo);

				tableName = (tableNamePostfix == null) ? "XQt1403OutBlock1" : $"XQt1403OutBlock1_{tableNamePostfix}";
				qo = new QueryOption(tableName);
				results.OutBlock1 = instance.SelectMany<XQt1403OutBlock1>(qo);
				return results;
			}
		}
		...
		{
			typeof(XQt1403OutBlock),
			typeof(XQt1403OutBlock1),
