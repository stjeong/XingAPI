...
namespace XingAPINet
{
	public partial class XRSC0InBlock : XingBlock
	{
		...
		public void CopyTo(XRSC0InBlock block)
		{
	...
	public partial class XRSC0OutBlock : XingBlock
	{
		...
		/// 주문체결구분
		/// </summary>
		[XAQueryFieldAttribute("ordchegb", "주문체결구분", "char", "2")]
		public string ordchegb;
		/// <summary>
		/// 시장구분
		/// </summary>
		[XAQueryFieldAttribute("marketgb", "시장구분", "char", "2")]
		public string marketgb;
		/// <summary>
		/// 주문구분
		/// </summary>
		[XAQueryFieldAttribute("ordgb", "주문구분", "char", "2")]
		public string ordgb;
		/// <summary>
		/// 원주문번호
		/// </summary>
		...
		/// 단축종목번호
		/// </summary>
		[XAQueryFieldAttribute("shtcode", "단축종목번호", "char", "9")]
		...
		/// 주문가격
		/// </summary>
		[XAQueryFieldAttribute("ordprice", "주문가격", "long", "13")]
		public long ordprice;
		/// <summary>
		/// 주문조건
		/// </summary>
		[XAQueryFieldAttribute("hogagb", "주문조건", "char", "1")]
		public char hogagb;
		/// <summary>
		/// 호가유형코드
		/// </summary>
		[XAQueryFieldAttribute("etfhogagb", "호가유형코드", "char", "2")]
		public string etfhogagb;
		/// <summary>
		/// 프로그램호가구분
		/// </summary>
		[XAQueryFieldAttribute("pgmtype", "프로그램호가구분", "long", "2")]
		public long pgmtype;
		/// <summary>
		/// 공매도호가구분
		/// </summary>
		[XAQueryFieldAttribute("gmhogagb", "공매도호가구분", "long", "1")]
		public long gmhogagb;
		/// <summary>
		/// 공매도가능여부
		/// </summary>
		[XAQueryFieldAttribute("gmhogayn", "공매도가능여부", "long", "1")]
		public long gmhogayn;
		/// <summary>
		/// 신용구분
		/// </summary>
		[XAQueryFieldAttribute("singb", "신용구분", "char", "3")]
		public string singb;
		/// <summary>
		/// 대출일
		/// </summary>
		...
		/// 그룹ID
		/// </summary>
		[XAQueryFieldAttribute("groupid", "그룹ID", "char", "20")]
		...
		/// 포트폴리오번호
		/// </summary>
		[XAQueryFieldAttribute("prtno", "포트폴리오번호", "long", "10")]
		public long prtno;
		/// <summary>
		/// 바스켓번호
		/// </summary>
		[XAQueryFieldAttribute("basketno", "바스켓번호", "long", "10")]
		...
		/// 아아템번호
		/// </summary>
		[XAQueryFieldAttribute("itemno", "아아템번호", "long", "10")]
		public long itemno;
		/// <summary>
		/// 차입구분
		/// </summary>
		[XAQueryFieldAttribute("brwmgmyn", "차입구분", "long", "1")]
		public long brwmgmyn;
		/// <summary>
		/// 회원사번호
		/// </summary>
		[XAQueryFieldAttribute("mbrno", "회원사번호", "long", "3")]
		public long mbrno;
		/// <summary>
		/// 처리구분
		/// </summary>
		[XAQueryFieldAttribute("procgb", "처리구분", "char", "1")]
		public char procgb;
		/// <summary>
		/// 관리지점번호
		/// </summary>
		[XAQueryFieldAttribute("admbrchno", "관리지점번호", "char", "3")]
		public string admbrchno;
		/// <summary>
		/// 선물계좌번호
		/// </summary>
		[XAQueryFieldAttribute("futaccno", "선물계좌번호", "char", "20")]
		public string futaccno;
		/// <summary>
		/// 선물상품구분
		/// </summary>
		[XAQueryFieldAttribute("futmarketgb", "선물상품구분", "char", "1")]
		public char futmarketgb;
		/// <summary>
		/// 통신매체구분
		/// </summary>
		[XAQueryFieldAttribute("tongsingb", "통신매체구분", "char", "2")]
		public string tongsingb;
		/// <summary>
		/// 유동성공급자구분
		/// </summary>
		[XAQueryFieldAttribute("lpgb", "유동성공급자구분", "char", "1")]
		public char lpgb;
		/// <summary>
		/// DUMMY
		/// </summary>
		[XAQueryFieldAttribute("dummy", "DUMMY", "char", "20")]
		public string dummy;
		/// <summary>
		/// 주문번호
		/// </summary>
		...
		/// 주문시각
		/// </summary>
		[XAQueryFieldAttribute("ordtm", "주문시각", "char", "9")]
		public string ordtm;
		/// <summary>
		/// 모주문번호
		/// </summary>
		...
		/// 원주문미체결수량
		/// </summary>
		[XAQueryFieldAttribute("orgordundrqty", "원주문미체결수량", "long", "16")]
		...
		/// 원주문취소수량
		/// </summary>
		[XAQueryFieldAttribute("ordordcancelqty", "원주문취소수량", "long", "16")]
		public long ordordcancelqty;
		/// <summary>
		/// 비회원사송신번호
		/// </summary>
		[XAQueryFieldAttribute("nmcpysndno", "비회원사송신번호", "long", "10")]
		...
		/// 복수주문일련번호
		/// </summary>
		[XAQueryFieldAttribute("mtordseqno", "복수주문일련번호", "long", "10")]
		public long mtordseqno;
		/// <summary>
		/// 예비주문수량
		/// </summary>
		[XAQueryFieldAttribute("spareordqty", "예비주문수량", "long", "16")]
		public long spareordqty;
		/// <summary>
		/// 주문사원번호
		/// </summary>
		[XAQueryFieldAttribute("orduserid", "주문사원번호", "char", "16")]
		public string orduserid;
		/// <summary>
		/// 실물주문수량
		/// </summary>
		[XAQueryFieldAttribute("spotordqty", "실물주문수량", "long", "16")]
		public long spotordqty;
		/// <summary>
		/// 재사용주문수량
		/// </summary>
		[XAQueryFieldAttribute("ordruseqty", "재사용주문수량", "long", "16")]
		...
		/// 주문대용금액
		/// </summary>
		[XAQueryFieldAttribute("ordsubstamt", "주문대용금액", "long", "16")]
		...
		/// 수수료주문금액
		/// </summary>
		[XAQueryFieldAttribute("ordcmsnamt", "수수료주문금액", "long", "16")]
		public long ordcmsnamt;
		/// <summary>
		/// 사용신용담보재사용금
		/// </summary>
		[XAQueryFieldAttribute("crdtuseamt", "사용신용담보재사용금", "long", "16")]
		...
		public void CopyTo(XRSC0OutBlock block)
		{
			...
			block.shtcode = this.shtcode;
			block.hname = this.hname;
			block.ordqty = this.ordqty;
			block.ordprice = this.ordprice;
			block.hogagb = this.hogagb;
			block.etfhogagb = this.etfhogagb;
			block.pgmtype = this.pgmtype;
			block.gmhogagb = this.gmhogagb;
			block.gmhogayn = this.gmhogayn;
			...
			block.prtno = this.prtno;
			block.basketno = this.basketno;
			block.trchno = this.trchno;
			block.itemno = this.itemno;
			block.brwmgmyn = this.brwmgmyn;
			block.mbrno = this.mbrno;
			block.procgb = this.procgb;
			block.admbrchno = this.admbrchno;
			block.futaccno = this.futaccno;
			block.futmarketgb = this.futmarketgb;
			block.tongsingb = this.tongsingb;
			block.lpgb = this.lpgb;
			block.dummy = this.dummy;
			block.ordno = this.ordno;
			block.ordtm = this.ordtm;
			block.prntordno = this.prntordno;
			block.mgempno = this.mgempno;
			block.orgordundrqty = this.orgordundrqty;
			block.orgordmdfyqty = this.orgordmdfyqty;
			block.ordordcancelqty = this.ordordcancelqty;
			block.nmcpysndno = this.nmcpysndno;
			...
			block.mtordseqno = this.mtordseqno;
			block.spareordqty = this.spareordqty;
			block.orduserid = this.orduserid;
			block.spotordqty = this.spotordqty;
			block.ordruseqty = this.ordruseqty;
			block.mnyordamt = this.mnyordamt;
			block.ordsubstamt = this.ordsubstamt;
			block.ruseordamt = this.ruseordamt;
			block.ordcmsnamt = this.ordcmsnamt;
			block.crdtuseamt = this.crdtuseamt;
