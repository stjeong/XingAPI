...
namespace XingAPINet
{
	public partial class XQt8402InBlock : XingBlock
	{
		...
		/// t8402InBlock
		/// </summary>
		static readonly string _blockName = "t8402InBlock";
		/// <summary>
		/// 기본입력
		/// </summary>
	...
	public partial class XQt8402OutBlock : XingBlock
	{
		...
		/// t8402OutBlock
		/// </summary>
		static readonly string _blockName = "t8402OutBlock";
		/// <summary>
		/// 출력
		/// </summary>
	...
	public partial class XQt8402 : XingQuery
	{
		...
		/// t8402
		/// </summary>
		static readonly string _typeName = "t8402";
		/// <summary>
		/// 주식선물현재가조회(API용)(t8402)
		/// </summary>
		static readonly string _typeDesc = "주식선물현재가조회(API용)(t8402)";
		/// <summary>
		/// 
		/// </summary>
