...
namespace XingAPINet
{
	...
	public partial class XQCSPBQ00200OutBlock2 : XingBlock
	{
		...
		/// 추정예수금(D+1)
		/// </summary>
		[XAQueryFieldAttribute("PrsmptDpsD1", "추정예수금(D+1)", "long", "16")]
		public long PrsmptDpsD1;
		/// <summary>
		/// 추정예수금(D+2)
		/// </summary>
		[XAQueryFieldAttribute("PrsmptDpsD2", "추정예수금(D+2)", "long", "16")]
		...
		/// 수수료율
		/// </summary>
		[XAQueryFieldAttribute("CmsnRat", "수수료율", "double", "15.5")]
		public double CmsnRat;
		/// <summary>
		/// 추가징수금액
		/// </summary>
		[XAQueryFieldAttribute("AddLevyAmt", "추가징수금액", "long", "16")]
		public long AddLevyAmt;
		/// <summary>
		/// 재사용대상금액
		/// </summary>
		[XAQueryFieldAttribute("RuseObjAmt", "재사용대상금액", "long", "16")]
		public long RuseObjAmt;
		/// <summary>
		/// 현금재사용대상금액
		/// </summary>
		[XAQueryFieldAttribute("MnyRuseObjAmt", "현금재사용대상금액", "long", "16")]
		public long MnyRuseObjAmt;
		/// <summary>
		/// 이용사증거금률
		/// </summary>
		[XAQueryFieldAttribute("FirmMgnRat", "이용사증거금률", "double", "7.4")]
		public double FirmMgnRat;
		/// <summary>
		/// 대용재사용대상금액
		/// </summary>
		[XAQueryFieldAttribute("SubstRuseObjAmt", "대용재사용대상금액", "long", "16")]
		public long SubstRuseObjAmt;
		/// <summary>
		/// 종목증거금률
		/// </summary>
		[XAQueryFieldAttribute("IsuMgnRat", "종목증거금률", "double", "7.4")]
		public double IsuMgnRat;
		/// <summary>
		/// 계좌증거금률
		/// </summary>
		[XAQueryFieldAttribute("AcntMgnRat", "계좌증거금률", "double", "7.4")]
		public double AcntMgnRat;
		/// <summary>
		/// 거래증거금률
		/// </summary>
		[XAQueryFieldAttribute("TrdMgnrt", "거래증거금률", "double", "7.4")]
		public double TrdMgnrt;
		/// <summary>
		/// 수수료
		/// </summary>
		[XAQueryFieldAttribute("Cmsn", "수수료", "long", "16")]
		public long Cmsn;
		/// <summary>
		/// 증거금률20퍼센트주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat20pctOrdAbleAmt", "증거금률20퍼센트주문가능금액", "long", "16")]
		public long MgnRat20pctOrdAbleAmt;
		/// <summary>
		/// 증거금률100퍼센트현금주문가능수량?
		/// </summary>
		[XAQueryFieldAttribute("MgnRat20OrdAbleQty", "증거금률100퍼센트현금주문가능수량?", "long", "16")]
		public long MgnRat20OrdAbleQty;
		/// <summary>
		/// 증거금률30퍼센트주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat30pctOrdAbleAmt", "증거금률30퍼센트주문가능금액", "long", "16")]
		public long MgnRat30pctOrdAbleAmt;
		/// <summary>
		/// 증거금률30퍼센트주문가능수량??
		/// </summary>
		[XAQueryFieldAttribute("MgnRat30OrdAbleQty", "증거금률30퍼센트주문가능수량??", "long", "16")]
		public long MgnRat30OrdAbleQty;
		/// <summary>
		/// 증거금률40퍼센트주문가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat40pctOrdAbleAmt", "증거금률40퍼센트주문가능금액", "long", "16")]
		public long MgnRat40pctOrdAbleAmt;
		/// <summary>
		/// 증거금률40퍼센트주문가능수량??
		/// </summary>
		[XAQueryFieldAttribute("MgnRat40OrdAbleQty", "증거금률40퍼센트주문가능수량??", "long", "16")]
		...
		/// 증거금률100퍼센트주문가능수량??
		/// </summary>
		[XAQueryFieldAttribute("MgnRat100OrdAbleQty", "증거금률100퍼센트주문가능수량??", "long", "16")]
		public long MgnRat100OrdAbleQty;
		/// <summary>
		/// 증거금률100퍼센트현금주문가능금액?
		/// </summary>
		[XAQueryFieldAttribute("MgnRat100MnyOrdAbleAmt", "증거금률100퍼센트현금주문가능금액?", "long", "16")]
		public long MgnRat100MnyOrdAbleAmt;
		/// <summary>
		/// 증거금률100퍼센트현금주문가능수량
		/// </summary>
		[XAQueryFieldAttribute("MgnRat100MnyOrdAbleQty", "증거금률100퍼센트현금주문가능수량", "long", "16")]
		public long MgnRat100MnyOrdAbleQty;
		/// <summary>
		/// 증거금률20퍼센트재사용가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat20pctRuseAbleAmt", "증거금률20퍼센트재사용가능금액", "long", "16")]
		public long MgnRat20pctRuseAbleAmt;
		/// <summary>
		/// 증거금률30퍼센트재사용가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat30pctRuseAbleAmt", "증거금률30퍼센트재사용가능금액", "long", "16")]
		public long MgnRat30pctRuseAbleAmt;
		/// <summary>
		/// 증거금률40퍼센트재사용가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat40pctRuseAbleAmt", "증거금률40퍼센트재사용가능금액", "long", "16")]
		public long MgnRat40pctRuseAbleAmt;
		/// <summary>
		/// 증거금률100퍼센트재사용가능금액
		/// </summary>
		[XAQueryFieldAttribute("MgnRat100pctRuseAbleAmt", "증거금률100퍼센트재사용가능금액", "long", "16")]
	...
	public partial class XQCSPBQ00200 : XingQuery
	{
		...
		{
			typeof(XQCSPBQ00200OutBlock1),
			typeof(XQCSPBQ00200OutBlock2),
